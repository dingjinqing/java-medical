...
global.wxPage({
  ...
  onLoad: function (options) {
    ...
    //           })
    //         }
    //         if (fi_arr[i] == 'rebate_group' && res.content.rebate_groups) {
    //           var group_arr = [];
    //           var group_select = 0;
    //           for (var i in res.content.rebate_groups) {
    //             group_arr.push(res.content.rebate_groups[i].group_name)
    //             if (res.content.default_invite_group == res.content.rebate_groups[i].id) {
    //               group_select = i;
    //             }
    //           }
    //           // if (res.content.default_invite_group == null) {
    //           //   edu_select = 0;
    //           // } else {
    ...
    //           if (group_arr.length) {
    //             that.setData({
    //               rebate_groups: res.content.rebate_groups,
    //               group_arr: group_arr,
    //               group_select: group_select,
    //               if_rebate_group: 1
    //             })
  ...
  bind_submit: function (e) {
    var user_info = {};
    var that = this;
    user_info.remark = remarks;
    user_info.groupId = this.data.rebate_groups[this.data.group_select].id
