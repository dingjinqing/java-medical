...
global.wxComponent({
  ...
  methods: {
    ...
    getPrdInfo() {
      ...
      if(activity && (!this.data.triggerButton || this.data.triggerButton === 'right') && activity.activityType !== 3 && activity.activityType !== 8 && activity.activityType !== 4 || [6,18,22,98].includes(activity.activityType)){
