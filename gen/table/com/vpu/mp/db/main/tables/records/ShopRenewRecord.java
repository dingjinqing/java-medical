...
public class ShopRenewRecord extends UpdatableRecordImpl<ShopRenewRecord> implements Record9<Integer, Integer, Integer, String, Double, Timestamp, Timestamp, Integer, String> {

    private static final long serialVersionUID = 541699222;
     ...
     */
    public void setRenewMoney(Double value) {
        set(4, value);
    }
     ...
     */
    @Override
    public Row9<Integer, Integer, Integer, String, Double, Timestamp, Timestamp, Integer, String> fieldsRow() {
     ...
     */
    @Override
    public Row9<Integer, Integer, Integer, String, Double, Timestamp, Timestamp, Integer, String> valuesRow() {
     ...
     */
    @Override
    public ShopRenewRecord value5(Double value) {
        setRenewMoney(value);
        return this;
    }
     ...
     */
    @Override
    public ShopRenewRecord values(Integer value1, Integer value2, Integer value3, String value4, Double value5, Timestamp value6, Timestamp value7, Integer value8, String value9) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public ShopRenewRecord(Integer id, Integer shopId, Integer sysId, String mobile, Double renewMoney, Timestamp renewDate, Timestamp expireTime, Integer operator, String renewDesc) {
        super(ShopRenew.SHOP_RENEW);
