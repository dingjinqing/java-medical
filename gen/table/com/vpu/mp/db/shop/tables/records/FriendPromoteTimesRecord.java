...
public class FriendPromoteTimesRecord extends UpdatableRecordImpl<FriendPromoteTimesRecord> implements Record8<Integer, Integer, Integer, Integer, Integer, Timestamp, Timestamp, Byte> {

    private static final long serialVersionUID = 791678491;
     ...
     */
    @Override
    public FriendPromoteTimesRecord values(Integer value1, Integer value2, Integer value3, Integer value4, Integer value5, Timestamp value6, Timestamp value7, Byte value8) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public FriendPromoteTimesRecord(Integer id, Integer launchId, Integer userId, Integer shareTimes, Integer ownPromoteTimes, Timestamp inTime, Timestamp upTime, Byte isAuth) {
        super(FriendPromoteTimes.FRIEND_PROMOTE_TIMES);
