...
public class TagRecord extends UpdatableRecordImpl<TagRecord> implements Record5<Integer, String, Timestamp, Timestamp, Byte> {
     ...
     */
    @Override
    public TagRecord values(Integer value1, String value2, Timestamp value3, Timestamp value4, Byte value5) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public TagRecord(Integer tagId, String tagName, Timestamp createTime, Timestamp updateTime, Byte isDelete) {
        super(Tag.TAG);
