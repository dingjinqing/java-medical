...
public class IntegralMallProductRecord extends UpdatableRecordImpl<IntegralMallProductRecord> implements Record6<Integer, Integer, Integer, Integer, Short, BigDecimal> {

    private static final long serialVersionUID = -1214597982;
     ...
     */
    @Override
    public Row6<Integer, Integer, Integer, Integer, Short, BigDecimal> fieldsRow() {
     ...
     */
    @Override
    public Row6<Integer, Integer, Integer, Integer, Short, BigDecimal> valuesRow() {
     ...
     */
    @Override
    public IntegralMallProductRecord values(Integer value1, Integer value2, Integer value3, Integer value4, Short value5, BigDecimal value6) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public IntegralMallProductRecord(Integer id, Integer integralMallDefineId, Integer productId, Integer score, Short stock, BigDecimal money) {
        super(IntegralMallProduct.INTEGRAL_MALL_PRODUCT);
