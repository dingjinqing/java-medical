...
public class MpWeeklyVisit implements Serializable {

    private static final long serialVersionUID = 1624929189;
    ...
    public MpWeeklyVisit(MpWeeklyVisit value) {
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("MpWeeklyVisit (");
