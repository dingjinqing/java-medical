...
public class FriendPromoteLaunchRecord extends UpdatableRecordImpl<FriendPromoteLaunchRecord> implements Record9<Integer, Integer, Integer, Byte, String, Timestamp, Timestamp, Timestamp, Byte> {

    private static final long serialVersionUID = -1508399943;
     ...
     */
    @Override
    public Row9<Integer, Integer, Integer, Byte, String, Timestamp, Timestamp, Timestamp, Byte> fieldsRow() {
     ...
     */
    @Override
    public Row9<Integer, Integer, Integer, Byte, String, Timestamp, Timestamp, Timestamp, Byte> valuesRow() {
     ...
     */
    @Override
    public FriendPromoteLaunchRecord values(Integer value1, Integer value2, Integer value3, Byte value4, String value5, Timestamp value6, Timestamp value7, Timestamp value8, Byte value9) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public FriendPromoteLaunchRecord(Integer id, Integer userId, Integer promoteId, Byte promoteStatus, String orderSn, Timestamp launchTime, Timestamp updateTime, Timestamp successTime, Byte delFlag) {
        super(FriendPromoteLaunch.FRIEND_PROMOTE_LAUNCH);
