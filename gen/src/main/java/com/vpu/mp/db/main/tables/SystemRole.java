...
public class SystemRole extends TableImpl<SystemRoleRecord> {
    ...
    private static final long serialVersionUID = -564236731;
     ...
     */
    public final TableField<SystemRoleRecord, Timestamp> CREATE_TIME = createField("create_time", org.jooq.impl.SQLDataType.TIMESTAMP.defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "");
