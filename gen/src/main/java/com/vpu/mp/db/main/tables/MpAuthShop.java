...
public class MpAuthShop extends TableImpl<MpAuthShopRecord> {
    ...
    private static final long serialVersionUID = -793216906;
     ...
     */
    public final TableField<MpAuthShopRecord, UInteger> SHOP_ID = createField("shop_id", org.jooq.impl.SQLDataType.INTEGERUNSIGNED.nullable(false), this, "");
     ...
     */
    public final TableField<MpAuthShopRecord, Timestamp> CREATE_TIME = createField("create_time", org.jooq.impl.SQLDataType.TIMESTAMP.defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "");
