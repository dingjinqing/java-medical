...
public class AliMiniAuthShopRecord extends UpdatableRecordImpl<AliMiniAuthShopRecord> {
    ...
    private static final long serialVersionUID = 1157537529;
     ...
     */
    public AliMiniAuthShopRecord(String authAppId, String userId, String appAuthToken, String appRefreshToken, Timestamp expiresInTime, Timestamp reExpiresInTime, UInteger shopId, String appName, String appEnglishName, String appCategoryIds, String appSlogan, String servicePhone, String serviceEmail, String appLogo, String appDesc, Byte isAuthOk, Timestamp lastAuthTime, Timestamp lastCancelAuthTime, String appVersion, String status, String detailInfo, String experienceStatus, String tester, String expQrCodeUrl, Timestamp createTime) {
        super(AliMiniAuthShop.ALI_MINI_AUTH_SHOP);
