...
public class AliUserToken extends TableImpl<AliUserTokenRecord> {
    ...
    private static final long serialVersionUID = 693889637;
     ...
     */
    public final TableField<AliUserTokenRecord, UInteger> REC_ID = createField("rec_id", org.jooq.impl.SQLDataType.INTEGERUNSIGNED.nullable(false).identity(true), this, "");
     ...
     */
    @Override
    public Identity<AliUserTokenRecord, UInteger> getIdentity() {
