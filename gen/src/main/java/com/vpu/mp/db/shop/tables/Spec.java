...
public class Spec extends TableImpl<SpecRecord> {
    ...
    private static final long serialVersionUID = 1173241383;

    /**
     * The reference instance of <code>mini_shop_1.b2c_spec</code>
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_spec.spec_id</code>.
     */
    public final TableField<SpecRecord, UInteger> SPEC_ID = createField("spec_id", org.jooq.impl.SQLDataType.INTEGERUNSIGNED.nullable(false).identity(true), this, "");

    /**
     * The column <code>mini_shop_1.b2c_spec.spec_name</code>.
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_spec.del_flag</code>.
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_spec.shop_id</code>. 店铺ID
     */
    ...
    /**
     * Create a <code>mini_shop_1.b2c_spec</code> table reference
     */
    public Spec() {
    ...
    /**
     * Create an aliased <code>mini_shop_1.b2c_spec</code> table reference
     */
     ...
     */
    @Override
    public Identity<SpecRecord, UInteger> getIdentity() {
