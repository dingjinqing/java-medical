...
public class FriendPromoteDetail extends TableImpl<FriendPromoteDetailRecord> {
    ...
    private static final long serialVersionUID = -595274694;

    /**
     * The reference instance of <code>mini_shop_1.b2c_friend_promote_detail</code>
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_friend_promote_detail.id</code>.
     */
    public final TableField<FriendPromoteDetailRecord, UInteger> ID = createField("id", org.jooq.impl.SQLDataType.INTEGERUNSIGNED.nullable(false).identity(true), this, "");

    /**
     * The column <code>mini_shop_1.b2c_friend_promote_detail.launch_id</code>. 助力活动发起ID
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_friend_promote_detail.user_id</code>. 助力会员ID
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_friend_promote_detail.promote_id</code>. 助力活动ID
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_friend_promote_detail.promote_value</code>. 助力值
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_friend_promote_detail.promote_time</code>. 助力时间
     */
    public final TableField<FriendPromoteDetailRecord, Timestamp> PROMOTE_TIME = createField("promote_time", org.jooq.impl.SQLDataType.TIMESTAMP.defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "助力时间");

    /**
     * The column <code>mini_shop_1.b2c_friend_promote_detail.update_time</code>. 更新时间
     */
    public final TableField<FriendPromoteDetailRecord, Timestamp> UPDATE_TIME = createField("update_time", org.jooq.impl.SQLDataType.TIMESTAMP.defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "更新时间");

    /**
     * Create a <code>mini_shop_1.b2c_friend_promote_detail</code> table reference
     */
    ...
    /**
     * Create an aliased <code>mini_shop_1.b2c_friend_promote_detail</code> table reference
     */
     ...
     */
    @Override
    public Identity<FriendPromoteDetailRecord, UInteger> getIdentity() {
