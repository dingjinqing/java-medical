...
public class PageClassification extends TableImpl<PageClassificationRecord> {
    ...
    private static final long serialVersionUID = -1396881331;

    /**
     * The reference instance of <code>mini_shop_1.b2c_page_classification</code>
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_page_classification.id</code>. ID
     */
    public final TableField<PageClassificationRecord, UInteger> ID = createField("id", org.jooq.impl.SQLDataType.INTEGERUNSIGNED.nullable(false).identity(true), this, "ID");

    /**
     * The column <code>mini_shop_1.b2c_page_classification.shop_id</code>. 店铺ID
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_page_classification.name</code>. 分类名称
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_page_classification.create_time</code>.
     */
    public final TableField<PageClassificationRecord, Timestamp> CREATE_TIME = createField("create_time", org.jooq.impl.SQLDataType.TIMESTAMP.defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "");

    /**
     * Create a <code>mini_shop_1.b2c_page_classification</code> table reference
     */
    ...
    /**
     * Create an aliased <code>mini_shop_1.b2c_page_classification</code> table reference
     */
     ...
     */
    @Override
    public Identity<PageClassificationRecord, UInteger> getIdentity() {
