...
public class AliMyOrderRecord extends UpdatableRecordImpl<AliMyOrderRecord> implements Record14<UInteger, String, Timestamp, String, String, String, String, String, UInteger, BigDecimal, Timestamp, String, String, Integer> {

    private static final long serialVersionUID = -895056557;
     ...
     */
    @Override
    public AliMyOrderRecord value1(UInteger value) {
        setRecId(value);
        return this;
    }
     ...
     */
    @Override
    public AliMyOrderRecord value9(UInteger value) {
     ...
     */
    @Override
    public AliMyOrderRecord values(UInteger value1, String value2, Timestamp value3, String value4, String value5, String value6, String value7, String value8, UInteger value9, BigDecimal value10, Timestamp value11, String value12, String value13, Integer value14) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public AliMyOrderRecord(UInteger recId, String commodityOrderId, Timestamp orderTime, String title, String name, String merchantPid, String contactor, String phone, UInteger orderItemNum, BigDecimal totalPrice, Timestamp createTime, String orderTicket, String serviceCode, Integer linkShopId) {
        super(AliMyOrder.ALI_MY_ORDER);
