...
public class DistributorLevelRecord extends TableImpl<DistributorLevelRecordRecord> {
    ...
    private static final long serialVersionUID = 1487202978;

    /**
     * The reference instance of <code>mini_shop_1.b2c_distributor_level_record</code>
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_distributor_level_record.id</code>.
     */
    public final TableField<DistributorLevelRecordRecord, UInteger> ID = createField("id", org.jooq.impl.SQLDataType.INTEGERUNSIGNED.nullable(false).identity(true), this, "");

    /**
     * The column <code>mini_shop_1.b2c_distributor_level_record.user_id</code>. 用户ID
     */
    public final TableField<DistributorLevelRecordRecord, UInteger> USER_ID = createField("user_id", org.jooq.impl.SQLDataType.INTEGERUNSIGNED.nullable(false).defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.INTEGERUNSIGNED)), this, "用户ID");

    /**
     * The column <code>mini_shop_1.b2c_distributor_level_record.is_go_up</code>. 升降：0降，1升
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_distributor_level_record.old_level</code>. 旧等级
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_distributor_level_record.old_level_name</code>. 旧等级名字
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_distributor_level_record.new_level</code>. 新等级
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_distributor_level_record.new_level_name</code>. 新等级名字
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_distributor_level_record.update_note</code>. 更新备注
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_distributor_level_record.update_time</code>. 更新时间
     */
    public final TableField<DistributorLevelRecordRecord, Timestamp> UPDATE_TIME = createField("update_time", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "更新时间");

    /**
     * Create a <code>mini_shop_1.b2c_distributor_level_record</code> table reference
     */
    ...
    /**
     * Create an aliased <code>mini_shop_1.b2c_distributor_level_record</code> table reference
     */
     ...
     */
    @Override
    public Identity<DistributorLevelRecordRecord, UInteger> getIdentity() {
