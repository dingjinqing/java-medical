...
public class UserLoginRecord extends TableImpl<UserLoginRecordRecord> {
    ...
    private static final long serialVersionUID = 177366045;
     ...
     */
    public final TableField<UserLoginRecordRecord, UInteger> ID = createField("id", org.jooq.impl.SQLDataType.INTEGERUNSIGNED.nullable(false).identity(true), this, "");
     ...
     */
    @Override
    public Identity<UserLoginRecordRecord, UInteger> getIdentity() {
