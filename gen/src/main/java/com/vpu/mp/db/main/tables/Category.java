...
public class Category extends TableImpl<CategoryRecord> {
    ...
    private static final long serialVersionUID = 1316058034;
     ...
     */
    public final TableField<CategoryRecord, UShort> PARENT_ID = createField("parent_id", org.jooq.impl.SQLDataType.SMALLINTUNSIGNED.nullable(false).defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.SMALLINTUNSIGNED)), this, "父ID");
     ...
     */
    public final TableField<CategoryRecord, Timestamp> CREATE_TIME = createField("create_time", org.jooq.impl.SQLDataType.TIMESTAMP.defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "添加时间");
