...
public class ReturnStatusChange extends TableImpl<ReturnStatusChangeRecord> {
    ...
    private static final long serialVersionUID = -267651529;

    /**
     * The reference instance of <code>mini_shop_1.b2c_return_status_change</code>
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_return_status_change.id</code>.
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_return_status_change.ret_id</code>. 退货申请id
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_return_status_change.user_id</code>. 用户id
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_return_status_change.type</code>. 0 商家触发   1是用户触发  2系统自动处理
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_return_status_change.status</code>. 更改状态
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_return_status_change.order_sn</code>. 订单号
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_return_status_change.add_time</code>. 变化时间
     */
    public final TableField<ReturnStatusChangeRecord, Timestamp> ADD_TIME = createField("add_time", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false), this, "变化时间");

    /**
     * The column <code>mini_shop_1.b2c_return_status_change.desc</code>. 备注
     */
    public final TableField<ReturnStatusChangeRecord, String> DESC = createField("desc", org.jooq.impl.SQLDataType.CLOB, this, "备注");

    /**
     * Create a <code>mini_shop_1.b2c_return_status_change</code> table reference
     */
    ...
    /**
     * Create an aliased <code>mini_shop_1.b2c_return_status_change</code> table reference
     */
