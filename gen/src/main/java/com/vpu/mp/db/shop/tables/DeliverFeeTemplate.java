...
public class DeliverFeeTemplate extends TableImpl<DeliverFeeTemplateRecord> {
    ...
    private static final long serialVersionUID = 1318678410;

    /**
     * The reference instance of <code>mini_shop_1.b2c_deliver_fee_template</code>
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_deliver_fee_template.deliver_template_id</code>.
     */
    public final TableField<DeliverFeeTemplateRecord, UInteger> DELIVER_TEMPLATE_ID = createField("deliver_template_id", org.jooq.impl.SQLDataType.INTEGERUNSIGNED.nullable(false).identity(true), this, "");

    /**
     * The column <code>mini_shop_1.b2c_deliver_fee_template.template_name</code>. 模板名称
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_deliver_fee_template.template_content</code>. 模板内容，json存储
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_deliver_fee_template.update_time</code>.
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_deliver_fee_template.created</code>.
     */
    public final TableField<DeliverFeeTemplateRecord, Timestamp> CREATED = createField("created", org.jooq.impl.SQLDataType.TIMESTAMP.defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "");

    /**
     * The column <code>mini_shop_1.b2c_deliver_fee_template.shop_id</code>. 店铺ID
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_deliver_fee_template.flag</code>. 0运费模板,1重量运费模板
     */
    ...
    /**
     * Create a <code>mini_shop_1.b2c_deliver_fee_template</code> table reference
     */
    ...
    /**
     * Create an aliased <code>mini_shop_1.b2c_deliver_fee_template</code> table reference
     */
     ...
     */
    @Override
    public Identity<DeliverFeeTemplateRecord, UInteger> getIdentity() {
