...
public class ServiceTechnicianGroup extends TableImpl<ServiceTechnicianGroupRecord> {
    ...
    private static final long serialVersionUID = -55331023;

    /**
     * The reference instance of <code>mini_shop_1.b2c_service_technician_group</code>
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_service_technician_group.group_id</code>. 分组id
     */
    public final TableField<ServiceTechnicianGroupRecord, UShort> GROUP_ID = createField("group_id", org.jooq.impl.SQLDataType.SMALLINTUNSIGNED.nullable(false).identity(true), this, "分组id");

    /**
     * The column <code>mini_shop_1.b2c_service_technician_group.group_name</code>. 分组名称
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_service_technician_group.store_id</code>. 门店id
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_service_technician_group.add_time</code>. 添加时间
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_service_technician_group.del_flag</code>. 0使用，1删除
     */
    ...
    /**
     * Create a <code>mini_shop_1.b2c_service_technician_group</code> table reference
     */
    ...
    /**
     * Create an aliased <code>mini_shop_1.b2c_service_technician_group</code> table reference
     */
     ...
     */
    @Override
    public Identity<ServiceTechnicianGroupRecord, UShort> getIdentity() {
