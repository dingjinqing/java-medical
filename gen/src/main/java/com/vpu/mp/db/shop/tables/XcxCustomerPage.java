...
public class XcxCustomerPage extends TableImpl<XcxCustomerPageRecord> {
    ...
    private static final long serialVersionUID = 1492926353;

    /**
     * The reference instance of <code>mini_shop_1.b2c_xcx_customer_page</code>
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_xcx_customer_page.page_id</code>.
     */
    public final TableField<XcxCustomerPageRecord, UInteger> PAGE_ID = createField("page_id", org.jooq.impl.SQLDataType.INTEGERUNSIGNED.nullable(false).identity(true), this, "");

    /**
     * The column <code>mini_shop_1.b2c_xcx_customer_page.shop_id</code>. 店铺ID
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_xcx_customer_page.page_name</code>.
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_xcx_customer_page.page_type</code>. 是否为首页1为首页，0非首页
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_xcx_customer_page.page_enabled</code>. 是否可用
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_xcx_customer_page.page_tpl_type</code>. 模板类型:0自定义模板，1默认模板，2美女模板，3自定义首页
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_xcx_customer_page.page_content</code>. 页面内容，json格式存储
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_xcx_customer_page.page_publish_content</code>. 正式页面内容，json格式存储
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_xcx_customer_page.page_state</code>. 状态：0未发布，1已发布
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_xcx_customer_page.create_time</code>.
     */
    public final TableField<XcxCustomerPageRecord, Timestamp> CREATE_TIME = createField("create_time", org.jooq.impl.SQLDataType.TIMESTAMP.defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "");

    /**
     * The column <code>mini_shop_1.b2c_xcx_customer_page.cat_id</code>. 页面分类id
     */
    ...
    /**
     * Create a <code>mini_shop_1.b2c_xcx_customer_page</code> table reference
     */
    ...
    /**
     * Create an aliased <code>mini_shop_1.b2c_xcx_customer_page</code> table reference
     */
     ...
     */
    @Override
    public Identity<XcxCustomerPageRecord, UInteger> getIdentity() {
