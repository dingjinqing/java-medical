...
public class MpOfficialAccountUser extends TableImpl<MpOfficialAccountUserRecord> {
    ...
    private static final long serialVersionUID = 1699474911;
     ...
     */
    public final TableField<MpOfficialAccountUserRecord, UInteger> REC_ID = createField("rec_id", org.jooq.impl.SQLDataType.INTEGERUNSIGNED.nullable(false).identity(true), this, "");
     ...
     */
    @Override
    public Identity<MpOfficialAccountUserRecord, UInteger> getIdentity() {
