...
public class FreeShipping extends TableImpl<FreeShippingRecord> {
    ...
    private static final long serialVersionUID = -1853924464;

    /**
     * The reference instance of <code>mini_shop_1.b2c_free_shipping</code>
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_free_shipping.id</code>.
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_free_shipping.name</code>. 活动名称
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_free_shipping.expire_type</code>. 0:固定日期 1：永久有效
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_free_shipping.start_time</code>. 开始时间
     */
    public final TableField<FreeShippingRecord, Timestamp> START_TIME = createField("start_time", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false), this, "开始时间");

    /**
     * The column <code>mini_shop_1.b2c_free_shipping.end_time</code>. 结束时间
     */
    public final TableField<FreeShippingRecord, Timestamp> END_TIME = createField("end_time", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false), this, "结束时间");

    /**
     * The column <code>mini_shop_1.b2c_free_shipping.type</code>. 条件 0全部 1部分
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_free_shipping.recommend_goods_id</code>. 指定商品可用
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_free_shipping.recommend_cat_id</code>. 指定分类可用
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_free_shipping.recommend_sort_id</code>. 指定商家分类可用
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_free_shipping.status</code>. 1停用
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_free_shipping.add_time</code>.
     */
    public final TableField<FreeShippingRecord, Timestamp> ADD_TIME = createField("add_time", org.jooq.impl.SQLDataType.TIMESTAMP, this, "");

    /**
     * The column <code>mini_shop_1.b2c_free_shipping.update_time</code>.
     */
    public final TableField<FreeShippingRecord, Timestamp> UPDATE_TIME = createField("update_time", org.jooq.impl.SQLDataType.TIMESTAMP, this, "");

    /**
     * The column <code>mini_shop_1.b2c_free_shipping.del_flag</code>. 1删除
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_free_shipping.del_time</code>.
     */
    ...
    /**
     * Create a <code>mini_shop_1.b2c_free_shipping</code> table reference
     */
    public FreeShipping() {
    ...
    /**
     * Create an aliased <code>mini_shop_1.b2c_free_shipping</code> table reference
     */
