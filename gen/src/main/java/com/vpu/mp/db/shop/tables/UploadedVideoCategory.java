...
public class UploadedVideoCategory extends TableImpl<UploadedVideoCategoryRecord> {
    ...
    private static final long serialVersionUID = -964426481;

    /**
     * The reference instance of <code>mini_shop_1.b2c_uploaded_video_category</code>
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_uploaded_video_category.video_cat_id</code>.
     */
    public final TableField<UploadedVideoCategoryRecord, UInteger> VIDEO_CAT_ID = createField("video_cat_id", org.jooq.impl.SQLDataType.INTEGERUNSIGNED.nullable(false).identity(true), this, "");

    /**
     * The column <code>mini_shop_1.b2c_uploaded_video_category.shop_id</code>. 店铺ID
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_uploaded_video_category.video_cat_name</code>.
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_uploaded_video_category.video_cat_parent_id</code>.
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_uploaded_video_category.create_time</code>.
     */
    public final TableField<UploadedVideoCategoryRecord, Timestamp> CREATE_TIME = createField("create_time", org.jooq.impl.SQLDataType.TIMESTAMP.defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "");

    /**
     * The column <code>mini_shop_1.b2c_uploaded_video_category.cat_ids</code>. 层级ID串,逗号分隔
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_uploaded_video_category.level</code>. 层级，0开始
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_uploaded_video_category.sort</code>. 排序优先级
     */
    ...
    /**
     * Create a <code>mini_shop_1.b2c_uploaded_video_category</code> table reference
     */
    ...
    /**
     * Create an aliased <code>mini_shop_1.b2c_uploaded_video_category</code> table reference
     */
     ...
     */
    @Override
    public Identity<UploadedVideoCategoryRecord, UInteger> getIdentity() {
