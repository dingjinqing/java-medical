...
public class FailedJobs extends TableImpl<FailedJobsRecord> {
    ...
    private static final long serialVersionUID = -1081729212;
     ...
     */
    public final TableField<FailedJobsRecord, ULong> ID = createField("id", org.jooq.impl.SQLDataType.BIGINTUNSIGNED.nullable(false).identity(true), this, "");
