...
public class ChannelStatistical extends TableImpl<ChannelStatisticalRecord> {
    ...
    private static final long serialVersionUID = 1795181396;

    /**
     * The reference instance of <code>mini_shop_1.b2c_channel_statistical</code>
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_channel_statistical.id</code>.
     */
    public final TableField<ChannelStatisticalRecord, UInteger> ID = createField("id", org.jooq.impl.SQLDataType.INTEGERUNSIGNED.nullable(false).identity(true), this, "");

    /**
     * The column <code>mini_shop_1.b2c_channel_statistical.page_id</code>.
     */
    public final TableField<ChannelStatisticalRecord, UInteger> PAGE_ID = createField("page_id", org.jooq.impl.SQLDataType.INTEGERUNSIGNED.defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.INTEGERUNSIGNED)), this, "");

    /**
     * The column <code>mini_shop_1.b2c_channel_statistical.goods_id</code>.
     */
    public final TableField<ChannelStatisticalRecord, UInteger> GOODS_ID = createField("goods_id", org.jooq.impl.SQLDataType.INTEGERUNSIGNED.defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.INTEGERUNSIGNED)), this, "");

    /**
     * The column <code>mini_shop_1.b2c_channel_statistical.channel_id</code>. 渠道ID
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_channel_statistical.channel_all_pv</code>.
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_channel_statistical.channel_all_uv</code>.
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_channel_statistical.channel_new_pv</code>.
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_channel_statistical.channel_new_uv</code>.
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_channel_statistical.channel_old_pv</code>.
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_channel_statistical.channel_old_uv</code>.
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_channel_statistical.ref_type</code>. 1昨天 7天 30天
     */
    ...
    /**
     * Create a <code>mini_shop_1.b2c_channel_statistical</code> table reference
     */
    ...
    /**
     * Create an aliased <code>mini_shop_1.b2c_channel_statistical</code> table reference
     */
     ...
     */
    @Override
    public Identity<ChannelStatisticalRecord, UInteger> getIdentity() {
