...
public class ShopUploadedImageCategoryRecord extends UpdatableRecordImpl<ShopUploadedImageCategoryRecord> implements Record9<UInteger, Integer, String, Integer, Timestamp, String, Byte, Integer, Integer> {

    private static final long serialVersionUID = 351001130;
     ...
     */
    @Override
    public ShopUploadedImageCategoryRecord value1(UInteger value) {
        setImgCatId(value);
        return this;
    }
     ...
     */
    @Override
    public ShopUploadedImageCategoryRecord values(UInteger value1, Integer value2, String value3, Integer value4, Timestamp value5, String value6, Byte value7, Integer value8, Integer value9) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public ShopUploadedImageCategoryRecord(UInteger imgCatId, Integer shopId, String imgCatName, Integer imgCatParentId, Timestamp createTime, String catIds, Byte level, Integer sort, Integer sysId) {
        super(ShopUploadedImageCategory.SHOP_UPLOADED_IMAGE_CATEGORY);
