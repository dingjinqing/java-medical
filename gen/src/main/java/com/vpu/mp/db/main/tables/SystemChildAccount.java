...
public class SystemChildAccount extends TableImpl<SystemChildAccountRecord> {
    ...
    private static final long serialVersionUID = 1189548522;
     ...
     */
    public final TableField<SystemChildAccountRecord, Timestamp> CREATE_TIME = createField("create_time", org.jooq.impl.SQLDataType.TIMESTAMP.defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "");
