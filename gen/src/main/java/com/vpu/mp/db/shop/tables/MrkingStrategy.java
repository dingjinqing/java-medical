...
public class MrkingStrategy extends TableImpl<MrkingStrategyRecord> {
    ...
    private static final long serialVersionUID = 2001645746;

    /**
     * The reference instance of <code>mini_shop_1.b2c_mrking_strategy</code>
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_mrking_strategy.id</code>.
     */
    public final TableField<MrkingStrategyRecord, UInteger> ID = createField("id", org.jooq.impl.SQLDataType.INTEGERUNSIGNED.nullable(false).identity(true), this, "");

    /**
     * The column <code>mini_shop_1.b2c_mrking_strategy.shop_id</code>. 店铺ID
     */
    public final TableField<MrkingStrategyRecord, Integer> SHOP_ID = createField("shop_id", org.jooq.impl.SQLDataType.INTEGER.defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.INTEGER)), this, "店铺ID");

    /**
     * The column <code>mini_shop_1.b2c_mrking_strategy.act_name</code>.
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_mrking_strategy.type</code>. 类型,1每满减 2满件 3满折 4满赠
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_mrking_strategy.start_time</code>.
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_mrking_strategy.end_time</code>.
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_mrking_strategy.created</code>.
     */
    public final TableField<MrkingStrategyRecord, Timestamp> CREATED = createField("created", org.jooq.impl.SQLDataType.TIMESTAMP.defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "");

    /**
     * The column <code>mini_shop_1.b2c_mrking_strategy.recommend_goods_id</code>. 指定商品可用
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_mrking_strategy.recommend_cat_id</code>. 指定分类可用
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_mrking_strategy.recommend_brand_id</code>. 指定品牌可用
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_mrking_strategy.act_type</code>. 活动类型，0-选中项参与活动；1-选中项不参与活动
     */
    public final TableField<MrkingStrategyRecord, Byte> ACT_TYPE = createField("act_type", org.jooq.impl.SQLDataType.TINYINT.defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.TINYINT)), this, "活动类型，0-选中项参与活动；1-选中项不参与活动");

    /**
     * The column <code>mini_shop_1.b2c_mrking_strategy.del_flag</code>.
     */
    public final TableField<MrkingStrategyRecord, Integer> DEL_FLAG = createField("del_flag", org.jooq.impl.SQLDataType.INTEGER.defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.INTEGER)), this, "");

    /**
     * The column <code>mini_shop_1.b2c_mrking_strategy.strategy_priority</code>. 促销活动优先级
     */
    public final TableField<MrkingStrategyRecord, Integer> STRATEGY_PRIORITY = createField("strategy_priority", org.jooq.impl.SQLDataType.INTEGER.defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.INTEGER)), this, "促销活动优先级");

    /**
     * The column <code>mini_shop_1.b2c_mrking_strategy.card_id</code>. 专属会员卡
     */
    ...
    /**
     * Create a <code>mini_shop_1.b2c_mrking_strategy</code> table reference
     */
    ...
    /**
     * Create an aliased <code>mini_shop_1.b2c_mrking_strategy</code> table reference
     */
     ...
     */
    @Override
    public Identity<MrkingStrategyRecord, UInteger> getIdentity() {
