...
public class Code extends TableImpl<CodeRecord> {
    ...
    private static final long serialVersionUID = -1483166572;

    /**
     * The reference instance of <code>mini_shop_1.b2c_code</code>
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_code.code_id</code>. 二维码id
     */
    public final TableField<CodeRecord, UInteger> CODE_ID = createField("code_id", org.jooq.impl.SQLDataType.INTEGERUNSIGNED.nullable(false).identity(true), this, "二维码id");

    /**
     * The column <code>mini_shop_1.b2c_code.type</code>. 分类：1店铺，2商品，3服务，4会员卡，5优惠券
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_code.param_id</code>. 对应的参数ID
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_code.type_url</code>. type对应的APP页面地址
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_code.qrcode_img</code>. 二维码位置
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_code.flag</code>. 标记位
     */
    public final TableField<CodeRecord, Byte> FLAG = createField("flag", org.jooq.impl.SQLDataType.TINYINT.defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.TINYINT)), this, "标记位");

    /**
     * The column <code>mini_shop_1.b2c_code.add_time</code>. 添加时间
     */
    public final TableField<CodeRecord, Timestamp> ADD_TIME = createField("add_time", org.jooq.impl.SQLDataType.TIMESTAMP, this, "添加时间");

    /**
     * The column <code>mini_shop_1.b2c_code.channel</code>. 渠道分享码
     */
    public final TableField<CodeRecord, String> CHANNEL = createField("channel", org.jooq.impl.SQLDataType.VARCHAR(20).defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.VARCHAR)), this, "渠道分享码");

    /**
     * Create a <code>mini_shop_1.b2c_code</code> table reference
     */
    public Code() {
    ...
    /**
     * Create an aliased <code>mini_shop_1.b2c_code</code> table reference
     */
     ...
     */
    @Override
    public Identity<CodeRecord, UInteger> getIdentity() {
