...
public class ReturnOrder extends TableImpl<ReturnOrderRecord> {
    ...
    private static final long serialVersionUID = 649449409;

    /**
     * The reference instance of <code>mini_shop_1.b2c_return_order</code>
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_return_order.ret_id</code>.
     */
    public final TableField<ReturnOrderRecord, UInteger> RET_ID = createField("ret_id", org.jooq.impl.SQLDataType.INTEGERUNSIGNED.nullable(false).identity(true), this, "");

    /**
     * The column <code>mini_shop_1.b2c_return_order.order_id</code>.
     */
    public final TableField<ReturnOrderRecord, UInteger> ORDER_ID = createField("order_id", org.jooq.impl.SQLDataType.INTEGERUNSIGNED.nullable(false).defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.INTEGERUNSIGNED)), this, "");

    /**
     * The column <code>mini_shop_1.b2c_return_order.order_sn</code>.
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_return_order.return_order_sn</code>. 退款单号
     */
    public final TableField<ReturnOrderRecord, String> RETURN_ORDER_SN = createField("return_order_sn", org.jooq.impl.SQLDataType.VARCHAR(30).nullable(false).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.VARCHAR)), this, "退款单号");

    /**
     * The column <code>mini_shop_1.b2c_return_order.shop_id</code>. 店铺ID
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_return_order.user_id</code>.
     */
    public final TableField<ReturnOrderRecord, UInteger> USER_ID = createField("user_id", org.jooq.impl.SQLDataType.INTEGERUNSIGNED.nullable(false).defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.INTEGERUNSIGNED)), this, "");

    /**
     * The column <code>mini_shop_1.b2c_return_order.goods_id</code>.
     */
    public final TableField<ReturnOrderRecord, UInteger> GOODS_ID = createField("goods_id", org.jooq.impl.SQLDataType.INTEGERUNSIGNED.nullable(false).defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.INTEGERUNSIGNED)), this, "");

    /**
     * The column <code>mini_shop_1.b2c_return_order.refund_status</code>. 1是审核中，2是通过审核，3退货没通过审核，4买家提交物流 或 仅退款申请，5：退款退货成功，6是拒绝退款退货
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_return_order.money</code>. 退款商品金额
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_return_order.shipping_fee</code>. 退运费金额
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_return_order.return_type</code>. 退款类型,0:只退款，1:退货又退款
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_return_order.reason</code>. 退款理由
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_return_order.return_desc</code>. 退款说明
     */
    public final TableField<ReturnOrderRecord, String> RETURN_DESC = createField("return_desc", org.jooq.impl.SQLDataType.CLOB.nullable(false), this, "退款说明");

    /**
     * The column <code>mini_shop_1.b2c_return_order.shipping_type</code>. 快递类型
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_return_order.shipping_no</code>. 快递单号
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_return_order.goods_images</code>. 商品图片
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_return_order.voucher_images</code>. 凭证图片
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_return_order.phone</code>. 电话号码
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_return_order.apply_time</code>. 退货且退货提交审核时间，对应refund_status=1
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_return_order.apply_pass_time</code>. 审核通过时间，对应refund_status=2
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_return_order.apply_not_pass_time</code>. 审核未通过时间，对应refund_status=3
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_return_order.shipping_or_refund_time</code>. 只退款时为退款申请时间，退货又退款时为提交物流信息时间，对应refund_status=4
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_return_order.refund_success_time</code>. 退款成功时间，对应refund_status=5
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_return_order.refund_refuse_time</code>. 退款拒绝时间，对应refund_status=6
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_return_order.refund_cancel_time</code>. 退款撤销时间，对应refund_status=7
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_return_order.apply_not_pass_reason</code>. 审核未通过原因
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_return_order.refund_refuse_reason</code>. 退款拒绝原因
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_return_order.return_address</code>. 退货地址
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_return_order.merchant_telephone</code>. 商家电话
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_return_order.consignee</code>. 收货人
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_return_order.zip_code</code>. 邮编
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_return_order.add_time</code>. 创建退款单时间
     */
    public final TableField<ReturnOrderRecord, Timestamp> ADD_TIME = createField("add_time", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "创建退款单时间");

    /**
     * Create a <code>mini_shop_1.b2c_return_order</code> table reference
     */
    public ReturnOrder() {
    ...
    /**
     * Create an aliased <code>mini_shop_1.b2c_return_order</code> table reference
     */
     ...
     */
    @Override
    public Identity<ReturnOrderRecord, UInteger> getIdentity() {
