...
<script>
    ...
    var dataAnalysis = {
        ...
        getTrendData: function (startDate = '', endDate = '', grading = 0) {
            ...
            util.ajax_json('/system/analysis/second/visit', function (response) {
                if (response.error == 0) {
            ...
            }, { start_date : startDate, end_date : endDate, action: $('select[name="visit_trend"]').val(), grading: grading, shop_id:'${_GET['shop_id']!}'})
        },
        // 访问分布
        getVisitDisTribution: function(startDate = '', endDate = '') {
            util.ajax_json('/system/analysis/visit/distribution', function (response) {
                if (response.error == 0) {
            ...
            }, { start_date : startDate, end_date : endDate, shop_id:'${_GET['shop_id']!}'})
        },
        // 访问留存
        getVisitRetain: function(startDate = '', endDate = '', grading = 0, userAction = 0) {
            ...
            util.ajax_json('/system/analysis/visit/retain', function (response) {
                if (response.error == 0) {
            ...
            }, { start_date : startDate, end_date : endDate, grading: grading, action: userAction, shop_id:'${_GET['shop_id']!}'})
        },
        ...
        getVisitPage: function (startDate = '', endDate = '', action = 1, asc = 2) {
            ...
            util.ajax_json('/system/analysis/basic/visitPage', function (response) {
                if (response.error == 0) {
            ...
            }, { start_date : startDate, end_date : endDate, action : action, asc : asc, shop_id:'${_GET['shop_id']!}'})
        },
