                        ...
                        <#list ($data_list->items as $item)
                            <tr id="shop_${item->shop_id!}" >
                                ...
                                <td width="20%" style="text-align: center;">
                                    <a href="/system/user/list?shop_id=${shop_id!}&start_time=${item->add_time!}&end_time=${item->add_time!}" class="btn_opera btn_detail">{{ trans("admin/user_list.look_detail")!}</a>
                                </td>
                            </tr>
                            </#list>
