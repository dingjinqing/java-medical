...
<link rel="stylesheet" href="/css/system/participate_user_list.css" type="text/css" />
<style type="text/css">
	.anniu2{
		display: flex;
                    ...
                    <table class="tb-decorate-list">
						...
						<#list ($data_list as $item)
                            <tr>
                            	...
                            	<td><a href="/system/orders/manage/info?order_sn=${item->order_sn!}&top_index=3" target="_blank">${item->order_sn!}</a></td>
