        ...
        <div class="panel-body">
            <table class="tab_body show table">
                ...
                <tr>
                    ...
                    <td>
                        <select name="shop_type">
                            {{--<option value="0" <#if ($shop->shop_type==0) selected </#if>>通用版</option>--!}
                            {{--<option value="1" <#if ($shop->shop_type==1) selected </#if>>试用版</option>--!}
                            <option value="" selected >请选择店铺类型</option>
                            <#list ($version_list as $item)
                            <option value="${item->level!}" <#if ($shop->shop_type==$item->level) selected </#if>>${item->version_name!}</option>
                            </#list>
                        </select>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <input type="checkbox" name="is_enabled"  <#if ($shop->is_enabled == 1) checked </#if> style="vertical-align: middle;margin-top: -1px">禁用
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <select name="shop_flag">
                            ...
                            <option value="1" <#if ($shop->shop_flag==1) selected </#if>>欧派</option>
                            <option value="2" <#if ($shop->shop_flag==2) selected </#if>>寺库</option>
                        </select>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <input type="checkbox" name="hid_bottom"  <#if ($shop->hid_bottom == 1) checked </#if> style="vertical-align: middle;margin-top: -1px">隐藏
                    </td>
                </tr>
                <tr>
                    <td>
