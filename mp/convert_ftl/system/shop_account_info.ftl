        ...
        <div class="panel-body">
            <table class="tab_body show table">
                ...
                {{--<tr>--!}
                    ...
                    {{--</td>--!}
                    {{--<td>--!}
                        {{--<input type="checkbox" name="business_state" value="1" <#if ($shop_account->business_state == 1) checked </#if>>营业--!}
                    {{--</td>--!}
                {{--</tr>--!}
                <tr hidden>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="max_sku_num" value="${shop_account->max_sku_num or 10000!}">
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <input type="text" name="max_shop_num" value="${shop_account->max_shop_num or 100!}">
                    </td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        <input type="checkbox" class="switch" id="checkbox2" name="add_comment_switch" <#if ($shop_account->add_comment_switch) checked </#if> >
