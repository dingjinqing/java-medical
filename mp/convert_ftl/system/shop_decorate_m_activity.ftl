                ...
                <div class="integral_default_info">
                    ...
                    <div class="integral_info_head clearfix">
                        <div class="goods_prices">
                            <div class="integral_price"><span class="money_price"><em>￥200.00</em> +</span> <span style="font-size: 14px;" class="score">400000</span>积分</div>
                            <div class="goods_prices_bottom">
                                <div class="orignakl_orice">￥1000.00</div>
                                <a href="##" class="btn_convert">去兑换</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <li class="single_acts clearfix">
                ...
                <div class="integral_default_info">
                    ...
                    <div class="integral_info_head">
                        <span class="integral_price"><span class="money_price"><em>￥200.00</em> + </span><span style="font-size: 14px;" class="score">40000</span>兑换</span>
        ...
        <ul class="integral_template hide">
            <li class="single_acts clearfix">
                ...
                <div class="integral_default_info">
                    <div class="goods_namess">单列积分</div>
                    <div class="integral_info_head">
                        <span class="integral_price"><span class="money_price"><em>￥200.00</em> + </span><span style="font-size: 14px;" class="score">40000</span>积分</span>
                        <span class="orignakl_orice"><span>￥100</span></span>
                        <a href="##"  class="btn_convert">去兑换</a>
                    </div>
                </div>
