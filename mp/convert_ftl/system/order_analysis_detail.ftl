                        ...
                        <#list ($data_list->items as $item)
                            <tr id="shop_${item->shop_id!}" >
                                ...
                                <td style="text-align: center;">
                                    <a href="/system/order/list?shop_id=${shop_id!}&add_time=${item->time!}&add_time_end=${item->time!}&&order_status=" target="_blank"  class="btn_opera btn_detail">{{ trans("admin/user_list.look_detail")!}</a>
                                </td>
                            </tr>
                            </#list>
