...
<div class="title">
    ...
    <span><#if ($role->role_name)${role->role_name!}：</#if> ${user['user_name']!}</span>
...
<div class="main-container">
    <div class="ov_head">
                ...
                <div class="ov_head_con1">
                    ...
                    <div style="border: none;">
                        <a href="/system/mp/auth/list?open_pay=0">
                            <p><#if ($no_shop_pay_number) ${no_shop_pay_number!} <#else> 0 </#if></p>
                            <span>未开通支付</span>
                        </a>
                    </div>
                </div>
        ...
        <div class="search">
            <ul>
                {{--<li hidden>--!}
                    {{--颗粒度：<select name="type">--!}
                        {{--<option value="1" selected>天</option>--!}
                        {{--<option value="7">周</option>--!}
                        {{--<option value="30" <#if ($request['type']==30)selected </#if>>月</option>--!}
                    {{--</select>--!}
                {{--</li>--!}
