                        ...
                        <#list ($data_list as $item)
                            <tr id="user_${item->shop_id!}" >
                                ...
                                <td width="20%" style="text-align: center;">
                                    <a href="/system/shop/shop_view?shop_id=${item->shop_id!}&nick_name=${item->nick_name!}" class="btn_opera btn_detail">店铺概览</a> |
                                    <a href="/system/analysis/basic/yesterday?shop_id=${item->shop_id!}&nick_name=${item->nick_name!}" class="btn_opera btn_detail">访问趋势</a> |
                                    <a href="/system/user/analysis/detail?shop_id=${item->shop_id!}&nick_name=${item->nick_name!}" class="btn_opera btn_detail">{{ trans("admin/user_list.look_detail")!}</a>
                                </td>
                            </tr>
                            </#list>
