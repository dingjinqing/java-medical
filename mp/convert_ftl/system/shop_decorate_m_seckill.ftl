            ...
            <li>
                ...
                <div class="seckill_default_info">
                    ...
                    <div class="seckill_info_head">
                        <span class="seckill_icon">秒杀</span>
                        <span class="seckill_price">￥<span class="sec_price" style="font-size: 18px;">0</span></span>
        ...
        <ul class="seckill_ul_clone hide">
            ...
            <li class="single_act clearfix">
                ...
                <div class="seckill_single_info">
                    ...
                    <span class="seckill_icon" style="line-height: 30px;font-size: 12px;">秒杀</span>
                    <div class="seckill_bottom">
                        <div class="seckill_single_bottom clearfix">
                            <div class="seckill_info_head">
                                <span class="seckill_price">￥<span class="sec_price" style="font-size: 18px;">0</span></span>
                            </div>
                            <span class="seckill_free_btn">去抢购</span>
                        </div>
