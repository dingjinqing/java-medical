...
<link rel="stylesheet" href="/css/system/reduce_price.css?v=1.1.8" type="text/css" />
<link rel="stylesheet" href="/css/system/common_share.css?v=1.2.1" type="text/css" />
<style type="text/css">
    .goods-btn-modify{
    ...
    <div class="main-container fix_every_footer">
        <div class="nav-role">
            <ul id="tab" class="nav-child-tabs">
                <li>
                    <a href="/system/market/reduce/list?nav=0&top_index=4">全部限时降价活动</a>
                </li>
                <li>
                    <a href="/system/market/reduce/list?nav=1&top_index=4">进行中</a>
                </li>
                <li>
                    <a href="/system/market/reduce/list?nav=2&top_index=4">未开始</a>
                </li>
                <li>
                    <a href="/system/market/reduce/list?nav=3&top_index=4">已过期</a>
                </li>
                <li>
                    <a href="/system/market/reduce/list?nav=4&top_index=4">已停用</a>
                </li>
                <#if ($shop_flag == 2)
                <li>
                    <a href="/system/market/reduce/price/list">批量降价</a>
                </li>
                <li>
                    <a href="/system/market/reduce/profit/list">批量加价率</a>
                </li>
                </#if>
                <li class="active">
                    <#if ($id)
                        <a href="/system/market/reduce/list?top_index=4&id=${id!}">编辑限时降价活动</a>
                    <#else>
                        <a href="/system/market/reduce/list?top_index=4">添加限时降价活动</a>
                    </#if>
                </li>
            </ul>
        </div>
        <div class="return-reduce-price-box" style="padding-top: 20px;">
            <form name="formData" id="form1" method="post" action="/system/market/reduce/add?top_index=4">
                {{ csrf_field()!}
                    ...
                    <div class="fl">
                        ...
                        <a href="javascript:;" class="show_eg">查看示例
                            <div class="hover_show">
                                <img src="http://${image_domain!}/image/system/share/reduce_share.jpg"/>
                            </div>
                        </a>
                        <a href="javascript:;" class="show_eg">下载海报
                            <div class="hover_show">
                                <img src="http://${image_domain!}/image/system/share/reduce_pictorial.jpg"/>
                            </div>
                        </a>
                        <div>
...
<script language="JavaScript" src="/js/system/jImageManager.js?v=1.0.2"></script>
<script language="JavaScript" src="/js/system/common_share.js?v=1.1.1"></script>
        ...
        layui.use('layer', function() {
            ...
            layer.open({
                ...
                ,yes: function (index) {
                    ...
                    util.ajax_json('/system/reduce/import/price', function (response) {
                        ...
                        if (response.error == 0) {
                            ...
                            util.ajax_json('/system/public/purchase/goods/list', function (response) {
                                ...
                                util.ajax_json("/system/reduce/select",function (res) {
                                    if(res.error == 0){
        ...
        layui.use('layer', function() {
            ...
            layer.open({
                ...
                ,yes: function (index) {
                    ...
                    util.ajax_json('/system/reduce/import/profit', function (response) {
...
<script type="text/javascript" src="/js/system/reduce_price.js?v=1.2.7"></script>
<script>
