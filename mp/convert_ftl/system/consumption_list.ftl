...
<div style="min-width: 1090px;">
    ...
    <div class="order-container">
        <div class="order-info">
            <div class="list_info">
                <a href="/system/user/charge/list?shop_id=${data->shop_id!}&card_no=${request["card_no"]!}&card_type=${request["card_type"]!}">充值明细</a>
                <a href="/system/user/consume/list?shop_id=${data->shop_id!}&card_no=${request["card_no"]!}&card_type=${request["card_type"]!}" style="border-bottom: 2px solid #5E88FC;">消费明细</a>
            </div>
            <form action="/system/user/consume/list" method="post" id="form1">
                {{ csrf_field()!}
