...
{{--<header id="header">--!}
    {{--<div id="logo-group">--!}
        {{--<span id="logo"> <img src="/image/admin/logo.png" style="padding:0" /> </span>--!}
    {{--</div>--!}
{{--</header>--!}
...
{{--<div id="content" class="row" style="margin: 0px;padding-left: 0px;padding-right: 0px;">--!}
    {{--<div class="col-xs-12 col-sm-12 col-md-7 col-lg-8">--!}
        {{--<div id="pictureslide" class="center-block" style="height: 400px;max-width: 800px;">--!}
            {{--<img src="/image/admin/slide.jpg" alt="">--!}
        {{--</div>--!}
    {{--</div>--!}
    {{--<div class="col-xs-12 col-sm-12 col-md-5 col-lg-4 ">--!}
        {{--<div class="well no-padding">--!}
            {{--<form name="loginForm" method="post" id="loginForm" class="smart-form client-form">--!}
                ...
                {{--<header>{{ trans("admin/login.form.title")!}--!}

                {{--</header>--!}
                {{--<fieldset>--!}

                    {{--<section>--!}
                        {{--<label class="label">{{ trans("admin/login.form.username")!}</label>--!}
                        {{--<label class="input"> <i class="icon-append fa fa-user"></i>--!}
                            {{--<input type="text" name="username" id="username"/>--!}
                            {{--<b class="tooltip tooltip-top-right"><i class="fa fa-user txt-color-teal"></i>--!}
                                {{--<span id="username_msg">{{ trans("admin/login.form.username_hint")!}</span>--!}
                            {{--</b>--!}
                        {{--</label>--!}
                    {{--</section>--!}

                    {{--<section class="sub-user-section" style="display: none">--!}
                        {{--<label class="label">{{ trans("admin/login.form.sub_username")!}</label>--!}
                        {{--<label class="input"> <i class="icon-append fa fa-user"></i>--!}
                            {{--<input type="text" name="sub_username" id="sub_username"/>--!}
                            {{--<b class="tooltip tooltip-top-right"><i class="fa fa-user txt-color-teal"></i>--!}
                                {{--<span id="username_msg">{{ trans("admin/login.form.sub_username_hint")!}</span>--!}
                            {{--</b>--!}
                        {{--</label>--!}
                    {{--</section>--!}

                    {{--<section>--!}
                        {{--<label class="label">{{ trans("admin/login.form.password")!}</label>--!}
                        {{--<label class="input"> <i class="icon-append fa fa-lock"></i>--!}
                            {{--<input type="password" id="password" name="password"/>--!}
                            {{--<b class="tooltip tooltip-top-right"><i class="fa fa-lock txt-color-teal"></i>--!}
                                {{--<span id="passwd_msg">{{ trans("admin/login.form.password_hint")!}</span>--!}
                            {{--</b>--!}
                        {{--</label>--!}
                    {{--</section>--!}

                    {{--<section>--!}
                        {{--<label class="label"><input type="checkbox" value="1" name="is_sub_login" />{{ trans("admin/login.form.sub_login")!}</label>--!}
                    {{--</section>--!}
                {{--</fieldset>--!}
                {{--<footer>--!}
                    {{--<input type="button" id="btn-login" value="{{ trans("admin/login.form.submit")!}"--!}
