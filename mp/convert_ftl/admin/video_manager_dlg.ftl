...
<link rel="stylesheet" href="/css/admin/video_manager.css?v=1.1.21" type="text/css"/>
...
<div class="manager-container1">
    ...
    <form action="/admin/frame/video/dialog" name="form1" id="form1" method="post">
                ...
                <tr>
                    <td colspan="2" style="padding: 0;">
                        <div class="box btn_chppse_bendi clearfix">
                            ...
                            <div class="text-warning" style="width: 96%;margin: 0px 0 0 10px;">
                                <img src="/image/admin/notice_img.png" alt="">
                                {{ trans("admin/video.upload_video_tip")!}
                            </div>
                        </div>
                        <div class="system_info_content" style="top: 52px;left: 134px;">
...
<script language="JavaScript" src="/js/admin/video_manager_dlg.js?v=1.0.2"></script>
