                ...
                <li class="order-info-li clearfix">
                    <div class="fl">
                        ...
                        <select name="return_type" id="order_status" style="width: 175px;">
                            ...
                            <#if  (is_array($returnTypeName))
                                <#list ($returnTypeName as $key => $name)
                                    <option value="${key!}" <#if (!is_null($request['return_type']) && $request['return_type'] == $key) selected </#if>>${name!}</option>
                                </#list>
                            </#if>
                            ...
                            {{--<option value="2" <#if ($request['return_type'] == 2) selected </#if>>仅退运费</option>--!}
                        </select>
                    </div>
                    ...
                    <table style="width:100%;" class="return-order-th">
                        ...
                        <#list ($data_list as $returnOrder)
                            ...
                            <#if  (count($returnOrder->return_order_goods) > 0)
                                <#list ($returnOrder->return_order_goods as $i => $return_order_good)
                                    <tr class="order-tb-body">
                                        ...
                                        <td>${returnTypeName[$returnOrder->return_type]!} </td>
                            ...
                            <#else>
                                <tr class="order-tb-body">
                                    <td>无</td>
                                    <td>${returnOrder->return_type==0 ? "仅退款" :($returnOrder->return_type == 2?'仅退运费':"退货退款")!} </td>
                                    <td width="100px">无</td>
                                    <td width="100px">无</td>
