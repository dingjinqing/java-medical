...
<link rel="stylesheet" href="/css/admin/open_group_detail.css" type="text/css" />
<style>
    .anniu2{
        display: flex;
                ...
                <div class="goods-edit-basic">
                    <table class="tb-decorate-list">
						...
						<#list ($data_list as $item)
                            <tr>
                            	<td>${item->group_id!}</td>
                            	<td><a href="/admin/market/groupdraw/user?group_id=${item->group_id!}&top_index=4&id=${item->group_draw_id!}" target="_blank">${item->group_num!}</a></td>
                            	<td>
