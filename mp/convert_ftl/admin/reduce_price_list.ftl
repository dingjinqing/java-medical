    ...
    <div class="main-container">
        ...
        <div class="normal_coupon">
            ...
            <ul class="add-child-ul">
                <li>
                    <a href="/admin/market/reduce/add?type=1&top_index=4" class="add-child-btn" target="_blank">
                        添加限时降价活动
                    </a>
                </li>
            </ul>
                            ...
                            <table class="tb-decorate-list">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>${item->money!}</td>
                                        <td>
                                            <a href="/admin/market/reduce/add?top_index=4&id=${item->id!}"
...
{{--                                            <#if ($item->status == 1 || $item->end_time < date("Y-m-d H:i:s",time()))--!}
                                            ...
                                            <#if ($item->start_time < date("Y-m-d H:i:s",time()))
                                                <a href="/admin/orders/activity/order/list?top_index=4&act_id=${item->id!}&goods_type=6" target="_blank">订单明细</a>
                                            </#if>
                                            <#if ($item->nav != 2)
    ...
    $('.abort').click(function(){
        ...
        layui.use('layer', function () {
            ...
            layer.alert('<div style="text-align: center;">' + '确认要停用吗？' + '</div>', {
                ...
                // $("#form1").submit();
                util.ajax_json("/admin/market/reduce/list",function (res) {
                    if(res.error == 0){
