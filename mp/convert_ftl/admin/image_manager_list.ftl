                                ...
                                <div class="system_info" style="display: inline-block;float: none;margin-top: 0px;">
                                    <p class="system_info_prompt">
                                        ...
                                        <#else>
                                            ...
                                            <span class="${version['self']['use']!}">${version['self']['num']-$version['self']['use'] >0 ? $version['self']['num']-$version['self']['use'] : 0!}</span>
                                            M内存空间
                                        </#if>
                        ...
                        <div class="box yigehezi">
                            ...
                            <#if  ($need_img_width > 0 || $need_img_height > 0)
                                <label style="font-size: 12px"
                                       title="{{ trans("admin/image.need_image_condition")!}： <#if  ($need_img_width > 0){{ trans("admin/image.width")!}=${need_img_width!}px </#if> <#if  ($need_img_height > 0) {{ trans("admin/image.height")!}=${need_img_height!}px </#if>">
                        ...
                        <div class="box" style="margin-top: 15px">
                            <table width="100%" border="0" class="tb_paging" style="float:none;">
                                <tr>
                                    ...
                                    <td align="right" style="padding-right: 50px">{{ trans("admin/common.page.page_info",['perPage'=>$data_list->perPage(),'currentPage'=>$data_list->currentPage(),'count'=>$data_list->count,'total'=>$data_list->total(),])!}
                                        <a href="#"
