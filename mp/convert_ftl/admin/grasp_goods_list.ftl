                    ...
                    <#list ($data_list as $item)
                        <tr>
                            ...
                            <td align="center" width="9%">
                                <span>
                                    <input type="text" value="${item->shop_price!}" name="shop_price" goods_id="${item->goods_id!}"  class="change-input" disabled" />
                                </span>
                            </td>
                            ...
                            <td align="center" width="8%"><#if ($item->is_on_sale == 1) 上架 <#else> 下架 </#if></td>
                            <td align="center" width="9%">
                                <span>
                                        ${item->goods_number!}
                                </span>
                            </td>
                            <td align="center" width="45%" class="share_td">
                                <div>
...
<script src="/js/admin/goods_list.js?v=1.1.2" type="text/javascript"></script>
