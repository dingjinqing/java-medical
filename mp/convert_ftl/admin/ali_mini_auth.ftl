        ...
        <div class="wx_auth clearfix">
            <div class="auth_list">
                ...
                <div class="auth_footer">
                    <a href="/ali_mini/start/authorization"><button>我已有小程序，一键授权</button></a>
                </div>
            </div>
            <div class="auth_list">
                ...
                <div class="auth_list_content">
                    <div class="content_text">
                        <p>我还没有小程序</p>
                        <p>去支付宝平台申请小程序</p>
                        <a href="https://docs.alipay.com/mini/introduce" target="_blank">查看教程</a>
                    </div>
                </div>
                <div class="auth_footer">
                    <a href="https://open.alipay.com/channel/miniIndex.htm"
                       target="_blank" ><button>去支付宝平台申请小程序，立即申请</button></a>
                </div>
            </div>
        </div>
    </div>
