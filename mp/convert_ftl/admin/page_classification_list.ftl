...
<div style="min-width: 1090px;">
    <div class="title">
        ...
        <span style="color: #666;">{{ trans("admin/shop_decorate.page_classification")!}</span>
    </div>
                ...
                <li style="margin-left: 20px">
                     <span style="display: inline-block;">
                        ...
                        <span class="search-bl">
                            <input type="text" name="keywords" value="${request['keywords']!}" placeholder="请输入页面分类名称" class="primary">
