...
<link rel="stylesheet" href="/css/admin/pin_integration.css?v=1.0.2" type="text/css" />
    ...
    <div class="main-container fix_every_footer">
        <div class="nav-role">
            <ul id="tab" class="nav-child-tabs">
                <li>
                    <a href="/admin/market/integration/list?nav=0&top_index=4">全部瓜分积分活动</a>
                </li>
                <li>
                    <a href="/admin/market/integration/list?nav=1&top_index=4">进行中</a>
                </li>
                <li>
                    <a href="/admin/market/integration/list?nav=2&top_index=4">未开始</a>
                </li>
                <li>
                    <a href="/admin/market/integration/list?nav=3&top_index=4">已过期</a>
                </li>
                <li>
                    <a href="/admin/market/integration/list?nav=4&top_index=4">已停用</a>
                </li>
                <li class="active">
                    <#if ($id)
                        <a href="/admin/market/integration/list?top_index=4&id=${id!}">编辑瓜分积分活动</a>
                    <#else>
                        <a href="/admin/market/integration/list?top_index=4">添加瓜分积分活动</a>
                    </#if>
                </li>
            </ul>
        </div>
        <div class="return-pin-integration-box" style="padding-top: 20px;">
            <form name="formData" id="form1" method="post" action="/admin/market/integration/add?top_index=4">
                {{ csrf_field()!}
                        ...
                        <td style="position: relative">
                            ...
                            <a href="javascript:;" class="show_eg">查看示例
                                <div class="hover_show">
                                    <img src="http://${image_domain!}/image/admin/new_preview_image/pin_integration.jpg" alt="" style="height: 500px">
                                </div>
                            </a>
...
<script>
    ...
    function save() {
        ...
        util.ajax_json('/admin/market/integration/add', function (response) {
            if (response.error == 0) {
                hasSaved = true;
                layer.ready(function () {
                    layer.msg('保存成功', {time: 1000},function () {
                        window.location = '/admin/market/integration/list?nav=0';
                    });
                });
            } else {
