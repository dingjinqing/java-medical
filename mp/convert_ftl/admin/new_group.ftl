...
<link rel="stylesheet" href="/css/admin/new_group.css?v=1.0.5" type="text/css" />
<style>
	.hover_show:before{
		top: 253px !important;
	}
		...
		<div class="nav-role">
            <ul id="tab" class="nav-child-tabs">
                <li <#if (empty($nav))class="active"</#if>>
                    <a href="/admin/market/groupdraw/list">全部拼团抽奖活动</a>
                </li>
                <li <#if ($nav == 1)class="active"</#if>>
                    <a href="/admin/market/groupdraw/list?nav=1" >进行中</a>
                </li>
                <li <#if ($nav == 2)class="active"</#if>>
                    <a href="/admin/market/groupdraw/list?nav=2" >未开始</a>
                </li>
                <li <#if ($nav == 3)class="active"</#if>> 
                    <a href="/admin/market/groupdraw/list?nav=3" >已过期</a>
                </li>
                <li <#if ($nav == 4)class="active"</#if>>
                    <a href="/admin/market/groupdraw/list?nav=4">已停用</a>
                </li>
				<li <#if ($nav == 5)class="active"</#if>>
					<a href="/admin/market/groupdraw/add?nav=4"><#if (empty($basicData->id))添加拼团抽奖活动<#else>编辑拼团抽奖活动</#if></a>
				</li>
            </ul>
        </div>
		<div class="return-pin-group-box" style="padding-top: 20px;">
            <form name="formData" id="form1" method="post" action="/admin/market/groupdraw/add" style="margin-bottom: 80px;">
				{{csrf_field()!}
                ...
                <table class="tb-pin-group">
                    <tbody>
	                    ...
	                    <tr style="height: 50px;">
	                        ...
	                        <td>
	                            <input type="number" name="min_join_num" class="limit_amount" onkeyup="value=value.replace(/[^\d]/g,'')"  value="{{!isset($basicData->min_join_num) ? 100 : $basicData->min_join_num!}"/>
	                    ...
	                    <tr style="height: 50px;">
	                        ...
	                        <td>
	                            <input type="text" name="pay_money" class="limit_amount" oninput="this.value=this.value.replace(/[^\d.]/g,'')"  value="{{!isset($basicData->pay_money) ? 1 : $basicData->pay_money!}"/> 元
	                    ...
	                    <tr style="height: 50px;">
	                        ...
	                        <td>
	                            <input type="number" class="limit_amount" onkeyup="this.value=this.value.replace(/\D/g,'')" placeholder="" name="join_limit" value="{{!isset($basicData->join_limit) ? 5 : $basicData->join_limit!}" min="0">
	                    ...
	                    <tr style="height: 50px;">
	                        ...
	                        <td>
	                            <input type="number" class="limit_amount" placeholder="" name="open_limit" onkeyup="this.value=this.value.replace(/\D/g,'')" value="{{!isset($basicData->open_limit) ? 1 : $basicData->open_limit!}" min="0">
	                    ...
	                    <tr style="height: 50px;">
	                        ...
	                        <td>
	                            <input type="number" class="limit_amount" placeholder="" name="limit_amount" onkeyup="this.value=this.value.replace(/\D/g,'')" value="{{!isset($basicData->limit_amount) ? 5 : $basicData->limit_amount!}" min="0">
                        ...
                        <tr style="height: 50px;">
	                        ...
	                        <td style="position: relative;">
	                            <input type="number" class="limit_amount" onkeyup="value=value.replace(/[^\d]/g,'')" value="{{!isset($basicData->to_num_show) ? 100 : $basicData->to_num_show!}"  placeholder="" name="to_num_show" min="0" >
								...
								<a href="javascript:;" class="show_eg">查看示例
									<div class="hover_show" style="top: -250px">
										<img src="http://${image_domain!}/image/admin/new_preview_image/pin_lottery.jpg" alt="">
									</div>
								</a>
	                        </td>
	                    </tr>
...
<script src="/js/admin/new_group.js?v=1.1.5"></script>
