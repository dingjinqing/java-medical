            ...
            <div class="list-bottom" style="padding:10px">
                <table align="center" class="list-bottom-show">
                    ...
                    <tr id="list-bottom-top">
                        <th width="4%"></th>
                        <th width="16%">{{trans("admin/shop.list-bottom.name")!}</th>
                        <th width="9%">
                        ...
                        <th width="12%">商品标签</th>
                        <th width="9%">{{trans("admin/shop.list-bottom.operate")!}</th>
                    </tr>
                    </thead>
                    <tbody id="" class="list">
                    <#list ($goods_items as $item)
                        <tr>
                            ...
                            <td align="center"  style="padding:8px 0px;">
                                <span>
                                    <input type="text" value="${item->shop_price!}" onkeyup="value=value.replace(/[^\d.]/g,'')" name="shop_price" goods_id="${item->goods_id!}"  class="change-input" disabled onkeyup="value=value.replace(/[^\d.]/g,'')" />
                                    <#if (!$item->has_prd)
                            ...
                            <td align="center" >${item->brand_name!}</td>
                            <td align="center" style="padding:8px 0px;">
                                <span>

                                    <#if (!$item->has_prd)
                                        <input type="text" name="goods_number" onkeyup="value=value.replace(/[^\d]/g,'')"  goods_id="${item->goods_id!}" value="${item->goods_number!}" class="change-input" disabled />
                            ...
                            <td align="center"  class="share_td">
                                <div class="action_row">
                                    <div style="display: inline-block;width: 24px;">
                                        <a href="/admin/goods/manage/edit?goods_id=${item->goods_id!}&top_index=${_GET['top_index'] ?? 2!}"
                                           link="/admin/goods/manage/edit?goods_id=${item->goods_id!}&top_index=${_GET['top_index'] ?? 0!}&sub_index=${sub_index!}"
                                           target="_blank" class="goods_edition show_tip" data-tips="{{ trans("admin/shop.list-bottom-operate.li_edit")!}" data-title="商品数量" data-name="goods_num" edit="1">
                                            <img src="{{image_url('image/admin/icon_action/edit.png')!}" alt="编辑">
                                        </a>
                                    </div>
                                    <div style="display: inline-block;width: 23px;">
                                        <a href="/admin/goods/manage/add?copy_goods_id=${item->goods_id!}" style="width: 24px;"
                                           target="_blank" class="show_tip" data-tips="{{ trans("admin/shop.list-bottom-operate.copy")!}">
                                            <img src="{{image_url('image/admin/icon_action/copy.png')!}" alt="复制">
                                        </a>
                                    </div>
                                    <div style="display: inline-block;position: relative">
                                        <a href="##" class="hover_share show_tip"  type = '2' identity_id="${item->goods_id!}"
                                           data-tips="{{ trans("admin/shop.list-bottom-operate.share")!}" style="width: 22px;">
                                            <img src="{{image_url('image/admin/icon_action/share.png')!}" alt="分享">
                                        </a>
                                    </div>
                                </div>
                                <div class="action_row">
                                    <div style="display: inline-block;width: 24px;">
                                        <#if ($nav == 0)
                                            <a href="/admin/goods/manage/list?act=off_sale&goods_id=${item->goods_id!}&nav=${nav!}"
                                               class="show_tip" data-tips="{{ trans("admin/shop.list-bottom-operate.li_done")!}">
                                                <img src="{{image_url('image/admin/icon_action/down.png')!}" alt="下架">
                                            </a>
                                        <#elseif>($nav == 2)
                                            <a href="/admin/goods/manage/list?act=on_sale&goods_id=${item->goods_id!}&nav=${nav!}"
                                               class="show_tip" data-tips="{{ trans("admin/shop.list-bottom-operate.li_on")!}">
                                                <img src="{{image_url('image/admin/icon_action/up.png')!}" alt="上架">
                                            </a>
                                        </#if>
                                    </div>
                                    <div style="display: inline-block;width: 23px;">
                                        <a href="#" class="del show_tip" goods_id="${item->goods_id!}" data-tips="{{ trans("admin/shop.list-bottom-operate.li_del")!}">
                                            <img src="{{image_url('image/admin/icon_action/delete.png')!}" alt="删除">
                                        </a>
                                    </div>
                                </div>
                        ...
                        <table cellspacing='1' cellpadding='3' width="100%" class="bottom-table" border="0">
                            <tr >
                                ...
                                <span style="position:relative;">&nbsp;&nbsp;
                                    ...
                                    {{--<a href="##" class="all_to_set tb-btm-left">批量设置</a>--!}
                                </td>
                                <td align="right">
...
<script>
    ...
    $(".btn-excel").click(function () {
        ...
        layer.open({
            ...
            content:'<div style="text-align: left;padding: 15px 15px">' + '商品导出中' + '</div>',
            area: "300px",
            btn: ['知道了'],
            yes: function (index) {
                layer.close(index);
    ...
    $('.share_td').on("mouseenter",'a.show_tip img',function(){
        $(this).parent().css({
            "display":"inline-block",
            "position" : "relative"
        })
