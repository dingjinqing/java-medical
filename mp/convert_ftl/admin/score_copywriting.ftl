...
<div class="title">
    <span><a href="/admin/market/view?top_index=4">积分设置</a> / </span><span><a href="/admin/market/distribution/config">积分说明</a> </span>
</div>
...
<script type="text/javascript">
    ...
    $(".btn_to_saves").click(function () {
        ...
        util.ajax_json('/admin/user/score/copywriting/save',function (res) {
            if (res.error == 0) {
