...
<link href="/css/admin/deliver_fee.css?v=0.1.9" rel="stylesheet" type="text/css"/>
<link href="/css/admin/deliver_fee_list.css?v=0.1.10" rel="stylesheet" type="text/css"/>
<style type="text/css">
    .btn-save:hover{
        ...
        <div class="box panel">
            <div class="panel-body" style="padding: 0;">
                <table class="tab_body show table">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <div class="alert alert-block alert-warning" id="except-area">
                                <label>
                                    <input type="checkbox" name="limit_deliver_area" value="1"
                                           style="width:15px;height:15px;"
                                           class="limit_deliver_area" id="limit-deliver-area"
                                           <#if ($data_list->content['data_list'][0]['limit_deliver_area']==1) checked </#if> >除可配送区域外，其他不可配送
                                </label>
                            </div>
                            ...
                            <div class="template-container">
                                ...
                                <table id="deliver_template_tbl" class="table table-bordered" style="width: 1000px;">
                                    <tr>
                                        ...
                                        <th class="add-th">首重（公斤）</th>
                                        <th class="add-th">运费（元）</th>
                                        <th class="add-th">续重（公斤）</th>
                            ...
                            <div class="checkbox">
                                <label><input type="checkbox" name="fee_0_cbk" style="height:15px;width:15px;"
                    ...
                    {{--<td valign="top">&nbsp;</td>--!}
                    {{--<td>--!}
                    {{--<button class="btn btn-primary btn-save" style="float: left;">--!}
                            ...
                            <div class="city-list">
                                <#list  ($item->city_list as $item2)
                                    <div class="city-item">
                                        ...
                                        <img class="expand" src="/image/admin/expand.png">
...
<script language="JavaScript" src="/js/admin/deliver_fee.js?v=1.0.5"></script>
<script>
