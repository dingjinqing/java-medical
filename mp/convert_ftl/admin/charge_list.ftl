...
<div style="min-width: 1090px;">
    ...
    <div class="order-container">
        <div class="order-info">
            <div class="list_info">
                <a href="/admin/user/manage/charge/list?card_no=${request["card_no"]!}&card_type=${request["card_type"]!}" style="border-bottom: 2px solid #5E88FC;">充值明细</a>
                <a href="/admin/user/manage/consume/list?card_no=${request["card_no"]!}&card_type=${request["card_type"]!}">消费明细</a>
            </div>
            <form action="/admin/user/manage/charge/list" method="post" id="form1">
                {{ csrf_field()!}
                <ul>
