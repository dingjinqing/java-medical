...
public class PledgeRecord extends UpdatableRecordImpl<PledgeRecord> implements Record8<Integer, String, String, String, Timestamp, Timestamp, Byte, Byte> {
     ...
     */
    @Override
    public Row8<Integer, String, String, String, Timestamp, Timestamp, Byte, Byte> fieldsRow() {
     ...
     */
    @Override
    public Row8<Integer, String, String, String, Timestamp, Timestamp, Byte, Byte> valuesRow() {
     ...
     */
    @Override
    public PledgeRecord values(Integer value1, String value2, String value3, String value4, Timestamp value5, Timestamp value6, Byte value7, Byte value8) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public PledgeRecord(Integer id, String pledgeName, String pledgeLogo, String pledgeContent, Timestamp createTime, Timestamp updateTime, Byte state, Byte delFlag) {
        super(Pledge.PLEDGE);
