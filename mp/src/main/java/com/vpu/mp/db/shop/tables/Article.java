...
public class Article extends TableImpl<ArticleRecord> {
    ...
    private static final long serialVersionUID = 1917636952;

    /**
     * The reference instance of <code>mini_shop_1.b2c_article</code>
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_article.article_id</code>.
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_article.category_id</code>. 文章分类
     */
    public final TableField<ArticleRecord, Integer> CATEGORY_ID = createField("category_id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.inline("1", org.jooq.impl.SQLDataType.INTEGER)), this, "文章分类");

    /**
     * The column <code>mini_shop_1.b2c_article.title</code>.
     */
    public final TableField<ArticleRecord, String> TITLE = createField("title", org.jooq.impl.SQLDataType.VARCHAR(256), this, "");

    /**
     * The column <code>mini_shop_1.b2c_article.author</code>.
     */
    public final TableField<ArticleRecord, String> AUTHOR = createField("author", org.jooq.impl.SQLDataType.VARCHAR(50), this, "");

    /**
     * The column <code>mini_shop_1.b2c_article.keyword</code>. 标签
     */
    public final TableField<ArticleRecord, String> KEYWORD = createField("keyword", org.jooq.impl.SQLDataType.VARCHAR(256), this, "标签");

    /**
     * The column <code>mini_shop_1.b2c_article.desc</code>. 文章描述
     */
    public final TableField<ArticleRecord, String> DESC = createField("desc", org.jooq.impl.SQLDataType.VARCHAR(1024), this, "文章描述");

    /**
     * The column <code>mini_shop_1.b2c_article.content</code>.
     */
    public final TableField<ArticleRecord, String> CONTENT = createField("content", org.jooq.impl.SQLDataType.CLOB, this, "");

    /**
     * The column <code>mini_shop_1.b2c_article.is_recommend</code>. 1:推荐
     */
    public final TableField<ArticleRecord, Byte> IS_RECOMMEND = createField("is_recommend", org.jooq.impl.SQLDataType.TINYINT.defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.TINYINT)), this, "1:推荐");

    /**
     * The column <code>mini_shop_1.b2c_article.is_top</code>. 1:置顶
     */
    public final TableField<ArticleRecord, Byte> IS_TOP = createField("is_top", org.jooq.impl.SQLDataType.TINYINT.defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.TINYINT)), this, "1:置顶");

    /**
     * The column <code>mini_shop_1.b2c_article.status</code>. 0未发布,1已发布
     */
    public final TableField<ArticleRecord, Byte> STATUS = createField("status", org.jooq.impl.SQLDataType.TINYINT.defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.TINYINT)), this, "0未发布,1已发布");

    /**
     * The column <code>mini_shop_1.b2c_article.pub_time</code>. 发布时间
     */
    public final TableField<ArticleRecord, Timestamp> PUB_TIME = createField("pub_time", org.jooq.impl.SQLDataType.TIMESTAMP.defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "发布时间");

    /**
     * The column <code>mini_shop_1.b2c_article.update_time</code>. 更新时间
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_article.create_time</code>.
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_article.last_visit_time</code>.
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_article.pv</code>.
     */
    public final TableField<ArticleRecord, Integer> PV = createField("pv", org.jooq.impl.SQLDataType.INTEGER, this, "");

    /**
     * The column <code>mini_shop_1.b2c_article.show_footer</code>. 0:不在footer显示，1：显示
     */
    ...
    /**
     * Create a <code>mini_shop_1.b2c_article</code> table reference
     */
    public Article() {
    ...
    /**
     * Create an aliased <code>mini_shop_1.b2c_article</code> table reference
     */
