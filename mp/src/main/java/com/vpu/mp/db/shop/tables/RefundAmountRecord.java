...
public class RefundAmountRecord extends TableImpl<RefundAmountRecordRecord> {
    ...
    private static final long serialVersionUID = 1129524960;

    /**
     * The reference instance of <code>mini_shop_1.b2c_refund_amount_record</code>
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_refund_amount_record.rec_id</code>.
     */
    public final TableField<RefundAmountRecordRecord, UInteger> REC_ID = createField("rec_id", org.jooq.impl.SQLDataType.INTEGERUNSIGNED.nullable(false).identity(true), this, "");

    /**
     * The column <code>mini_shop_1.b2c_refund_amount_record.order_sn</code>.
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_refund_amount_record.user_id</code>.
     */
    public final TableField<RefundAmountRecordRecord, UInteger> USER_ID = createField("user_id", org.jooq.impl.SQLDataType.INTEGERUNSIGNED.nullable(false).defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.INTEGERUNSIGNED)), this, "");

    /**
     * The column <code>mini_shop_1.b2c_refund_amount_record.refund_field</code>. 订单退款字段：member_card_balance,score_discount,money_paid,use_account
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_refund_amount_record.refund_money</code>. 退款金额
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_refund_amount_record.refund_time</code>. 订单退款时间
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_refund_amount_record.ret_id</code>. b2c_return_order的ret_id
     */
    public final TableField<RefundAmountRecordRecord, UInteger> RET_ID = createField("ret_id", org.jooq.impl.SQLDataType.INTEGERUNSIGNED.nullable(false), this, "b2c_return_order的ret_id");

    /**
     * Create a <code>mini_shop_1.b2c_refund_amount_record</code> table reference
     */
    ...
    /**
     * Create an aliased <code>mini_shop_1.b2c_refund_amount_record</code> table reference
     */
     ...
     */
    @Override
    public Identity<RefundAmountRecordRecord, UInteger> getIdentity() {
