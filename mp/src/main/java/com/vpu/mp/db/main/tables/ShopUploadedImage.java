...
public class ShopUploadedImage extends TableImpl<ShopUploadedImageRecord> {
    ...
    private static final long serialVersionUID = -1063110819;
     ...
     */
    public final TableField<ShopUploadedImageRecord, UInteger> IMG_ID = createField("img_id", org.jooq.impl.SQLDataType.INTEGERUNSIGNED.nullable(false).identity(true), this, "");
     ...
     */
    public final TableField<ShopUploadedImageRecord, UInteger> IMG_SIZE = createField("img_size", org.jooq.impl.SQLDataType.INTEGERUNSIGNED.nullable(false).defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.INTEGERUNSIGNED)), this, "");
     ...
     */
    @Override
    public Identity<ShopUploadedImageRecord, UInteger> getIdentity() {
