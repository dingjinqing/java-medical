...
public class B2cShopChildAccount extends TableImpl<B2cShopChildAccountRecord> {
    ...
    private static final long serialVersionUID = -215166042;
     ...
     */
    public final TableField<B2cShopChildAccountRecord, Integer> SYS_ID = createField("sys_id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.INTEGER)), this, "主账户ID");
     ...
     */
    public final TableField<B2cShopChildAccountRecord, String> BACKLOG = createField("backlog", org.jooq.impl.SQLDataType.CLOB, this, "待办事项列表");
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.B2C_SHOP_CHILD_ACCOUNT_PRIMARY, Indexes.B2C_SHOP_CHILD_ACCOUNT_SYS_ID, Indexes.B2C_SHOP_CHILD_ACCOUNT_SYS_ID_2);
    }
    ...
    public List<UniqueKey<B2cShopChildAccountRecord>> getKeys() {
        return Arrays.<UniqueKey<B2cShopChildAccountRecord>>asList(Keys.KEY_B2C_SHOP_CHILD_ACCOUNT_PRIMARY, Keys.KEY_B2C_SHOP_CHILD_ACCOUNT_SYS_ID);
    }
