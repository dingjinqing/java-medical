...
public class SystemUser extends TableImpl<SystemUserRecord> {
    ...
    private static final long serialVersionUID = -180865488;
     ...
     */
    public final TableField<SystemUserRecord, UInteger> SYSTEM_USER_ID = createField("system_user_id", org.jooq.impl.SQLDataType.INTEGERUNSIGNED.nullable(false).identity(true), this, "");
     ...
     */
    @Override
    public Identity<SystemUserRecord, UInteger> getIdentity() {
