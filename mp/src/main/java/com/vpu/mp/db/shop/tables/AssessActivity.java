...
public class AssessActivity extends TableImpl<AssessActivityRecord> {
    ...
    private static final long serialVersionUID = 747784857;

    /**
     * The reference instance of <code>mini_shop_1.b2c_assess_activity</code>
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_assess_activity.id</code>.
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_assess_activity.shop_id</code>. 店铺ID
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_assess_activity.act_code</code>. 活动编码
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_assess_activity.act_name</code>. 活动名称
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_assess_activity.start_time</code>. 活动起始时间
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_assess_activity.end_time</code>. 活动截止时间
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_assess_activity.due_time_type</code>. 是否永久有效：0否，1是
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_assess_activity.part_times_type</code>. 单用户参与次数类型：0不限制，1限制次数
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_assess_activity.part_times_day</code>. 每天最多参与次数：默认为1,0表示不限制
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_assess_activity.part_times_total</code>. 累计最多参与次数：默认为1,0表示不限制
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_assess_activity.feedback_total</code>. 活动总反馈数量：默认为0,0表示不限制
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_assess_activity.assess_judge_type</code>. 测评结果判断条件：0根据选项判断，1根据得分判断
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_assess_activity.cover_style_type</code>. 封面样式类型：0默认样式，1自定义
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_assess_activity.cover_style</code>. 封面样式内容，json串
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_assess_activity.assess_desc</code>. 测评介绍
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_assess_activity.in_time</code>. 添加时间
     */
    public final TableField<AssessActivityRecord, Timestamp> IN_TIME = createField("in_time", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false), this, "添加时间");

    /**
     * The column <code>mini_shop_1.b2c_assess_activity.up_time</code>. 更新时间
     */
    public final TableField<AssessActivityRecord, Timestamp> UP_TIME = createField("up_time", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false), this, "更新时间");

    /**
     * The column <code>mini_shop_1.b2c_assess_activity.is_block</code>. 活动状态：0未停用，1已停用
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_assess_activity.del_flag</code>. 删除标识：0未删除，1已删除
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_assess_activity.pub_flag</code>. 发布标识：0未发布，1已发布
     */
    ...
    /**
     * Create a <code>mini_shop_1.b2c_assess_activity</code> table reference
     */
    ...
    /**
     * Create an aliased <code>mini_shop_1.b2c_assess_activity</code> table reference
     */
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.ASSESS_ACTIVITY_ACT_CODE, Indexes.ASSESS_ACTIVITY_ACT_NAME, Indexes.ASSESS_ACTIVITY_PRIMARY, Indexes.ASSESS_ACTIVITY_SHOP_ID);
    }
    ...
    public List<UniqueKey<AssessActivityRecord>> getKeys() {
        return Arrays.<UniqueKey<AssessActivityRecord>>asList(Keys.KEY_B2C_ASSESS_ACTIVITY_PRIMARY, Keys.KEY_B2C_ASSESS_ACTIVITY_ACT_CODE);
    }
