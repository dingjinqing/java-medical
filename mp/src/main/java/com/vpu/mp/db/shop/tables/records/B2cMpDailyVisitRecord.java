...
public class B2cMpDailyVisitRecord extends TableRecordImpl<B2cMpDailyVisitRecord> implements Record9<String, Integer, Integer, Integer, Integer, Double, Double, Double, Timestamp> {

    private static final long serialVersionUID = 1051707137;
    ...
    /**
     * Setter for <code>mini_shop_471752.b2c_mp_daily_visit.add_time</code>. 添加时间
     */
    ...
    /**
     * Getter for <code>mini_shop_471752.b2c_mp_daily_visit.add_time</code>. 添加时间
     */
     ...
     */
    @Override
    public B2cMpDailyVisitRecord values(String value1, Integer value2, Integer value3, Integer value4, Integer value5, Double value6, Double value7, Double value8, Timestamp value9) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public B2cMpDailyVisitRecord(String refDate, Integer sessionCnt, Integer visitPv, Integer visitUv, Integer visitUvNew, Double stayTimeUv, Double stayTimeSession, Double visitDepth, Timestamp addTime) {
        super(B2cMpDailyVisit.B2C_MP_DAILY_VISIT);
