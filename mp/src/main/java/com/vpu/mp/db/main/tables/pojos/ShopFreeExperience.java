...
public class ShopFreeExperience implements Serializable {
    ...
    public ShopFreeExperience(ShopFreeExperience value) {
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("ShopFreeExperience (");
