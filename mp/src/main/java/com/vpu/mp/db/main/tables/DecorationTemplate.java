...
public class DecorationTemplate extends TableImpl<DecorationTemplateRecord> {
    ...
    private static final long serialVersionUID = -1622695685;
     ...
     */
    public final TableField<DecorationTemplateRecord, UInteger> PAGE_ID = createField("page_id", org.jooq.impl.SQLDataType.INTEGERUNSIGNED.nullable(false).identity(true), this, "");
     ...
     */
    public final TableField<DecorationTemplateRecord, Timestamp> CREATE_TIME = createField("create_time", org.jooq.impl.SQLDataType.TIMESTAMP.defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "");
     ...
     */
    @Override
    public Identity<DecorationTemplateRecord, UInteger> getIdentity() {
