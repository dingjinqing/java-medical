...
public class B2cAliMiniAuthShopRecord extends UpdatableRecordImpl<B2cAliMiniAuthShopRecord> {

    private static final long serialVersionUID = 779909576;
    ...
    /**
     * Create a detached B2cAliMiniAuthShopRecord
     */
    public B2cAliMiniAuthShopRecord() {
        super(B2cAliMiniAuthShop.B2C_ALI_MINI_AUTH_SHOP);
    }

    /**
     * Create a detached, initialised B2cAliMiniAuthShopRecord
     */
    public B2cAliMiniAuthShopRecord(String authAppId, String userId, String appAuthToken, String appRefreshToken, Timestamp expiresInTime, Timestamp reExpiresInTime, UInteger shopId, String appName, String appEnglishName, String appCategoryIds, String appSlogan, String servicePhone, String serviceEmail, String appLogo, String appDesc, Byte isAuthOk, Timestamp lastAuthTime, Timestamp lastCancelAuthTime, String appVersion, String status, String detailInfo, String experienceStatus, String tester, String expQrCodeUrl, Timestamp createTime) {
        super(B2cAliMiniAuthShop.B2C_ALI_MINI_AUTH_SHOP);
