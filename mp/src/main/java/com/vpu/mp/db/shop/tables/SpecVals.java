...
public class SpecVals extends TableImpl<SpecValsRecord> {
    ...
    private static final long serialVersionUID = -1147194135;

    /**
     * The reference instance of <code>mini_shop_1.b2c_spec_vals</code>
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_spec_vals.specvalid</code>.
     */
    public final TableField<SpecValsRecord, UInteger> SPECVALID = createField("specvalid", org.jooq.impl.SQLDataType.INTEGERUNSIGNED.nullable(false).identity(true), this, "");

    /**
     * The column <code>mini_shop_1.b2c_spec_vals.spec_id</code>.
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_spec_vals.specvalname</code>.
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_spec_vals.del_flag</code>.
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_spec_vals.shop_id</code>. 店铺ID
     */
    ...
    /**
     * Create a <code>mini_shop_1.b2c_spec_vals</code> table reference
     */
    public SpecVals() {
    ...
    /**
     * Create an aliased <code>mini_shop_1.b2c_spec_vals</code> table reference
     */
     ...
     */
    @Override
    public Identity<SpecValsRecord, UInteger> getIdentity() {
