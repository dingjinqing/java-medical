...
public class GoodsSpecProductBak extends TableImpl<GoodsSpecProductBakRecord> {
    ...
    private static final long serialVersionUID = 61116508;

    /**
     * The reference instance of <code>mini_shop_1.b2c_goods_spec_product_bak</code>
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_goods_spec_product_bak.id</code>.
     */
    public final TableField<GoodsSpecProductBakRecord, UInteger> ID = createField("id", org.jooq.impl.SQLDataType.INTEGERUNSIGNED.nullable(false).identity(true), this, "");

    /**
     * The column <code>mini_shop_1.b2c_goods_spec_product_bak.bak_date</code>. 备份日期：例2018-09-05
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_goods_spec_product_bak.prd_id</code>.
     */
    public final TableField<GoodsSpecProductBakRecord, UInteger> PRD_ID = createField("prd_id", org.jooq.impl.SQLDataType.INTEGERUNSIGNED.nullable(false), this, "");

    /**
     * The column <code>mini_shop_1.b2c_goods_spec_product_bak.shop_id</code>.
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_goods_spec_product_bak.goods_id</code>.
     */
    public final TableField<GoodsSpecProductBakRecord, UInteger> GOODS_ID = createField("goods_id", org.jooq.impl.SQLDataType.INTEGERUNSIGNED.nullable(false).defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.INTEGERUNSIGNED)), this, "");

    /**
     * The column <code>mini_shop_1.b2c_goods_spec_product_bak.prd_price</code>.
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_goods_spec_product_bak.prd_market_price</code>. 市场价
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_goods_spec_product_bak.prd_number</code>. 当前规格组合产品库存
     */
    ...
    /**
     * Create a <code>mini_shop_1.b2c_goods_spec_product_bak</code> table reference
     */
    ...
    /**
     * Create an aliased <code>mini_shop_1.b2c_goods_spec_product_bak</code> table reference
     */
     ...
     */
    @Override
    public Identity<GoodsSpecProductBakRecord, UInteger> getIdentity() {
