...
public class CardConsumer extends TableImpl<CardConsumerRecord> {
    ...
    private static final long serialVersionUID = 1150234435;

    /**
     * The reference instance of <code>mini_shop_1.b2c_card_consumer</code>
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_card_consumer.id</code>.
     */
    public final TableField<CardConsumerRecord, UInteger> ID = createField("id", org.jooq.impl.SQLDataType.INTEGERUNSIGNED.nullable(false).identity(true), this, "");

    /**
     * The column <code>mini_shop_1.b2c_card_consumer.user_id</code>. 用户id
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_card_consumer.card_id</code>. 会员卡id
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_card_consumer.add_time</code>. 充值时间
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_card_consumer.money</code>. 消费的卡余额
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_card_consumer.count</code>. 消费次数
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_card_consumer.type</code>. 消费类型 0是普通卡 1限次卡
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_card_consumer.reason</code>. 消费原因
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_card_consumer.message</code>. 备注
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_card_consumer.card_no</code>. 会员卡号
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_card_consumer.exchang_count</code>. 兑换次数
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_card_consumer.order_sn</code>. 订单号
     */
    ...
    /**
     * Create a <code>mini_shop_1.b2c_card_consumer</code> table reference
     */
    public CardConsumer() {
    ...
    /**
     * Create an aliased <code>mini_shop_1.b2c_card_consumer</code> table reference
     */
     ...
     */
    @Override
    public Identity<CardConsumerRecord, UInteger> getIdentity() {
