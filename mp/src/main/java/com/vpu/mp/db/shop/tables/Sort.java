...
public class Sort extends TableImpl<SortRecord> {
    ...
    private static final long serialVersionUID = -1499761641;

    /**
     * The reference instance of <code>mini_shop_1.b2c_sort</code>
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_sort.sort_id</code>.
     */
    public final TableField<SortRecord, UInteger> SORT_ID = createField("sort_id", org.jooq.impl.SQLDataType.INTEGERUNSIGNED.nullable(false).identity(true), this, "");

    /**
     * The column <code>mini_shop_1.b2c_sort.sort_name</code>.
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_sort.parent_id</code>.
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_sort.level</code>.
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_sort.has_child</code>.
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_sort.create_time</code>.
     */
    public final TableField<SortRecord, Timestamp> CREATE_TIME = createField("create_time", org.jooq.impl.SQLDataType.TIMESTAMP.defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "");

    /**
     * The column <code>mini_shop_1.b2c_sort.sort_img</code>. 一级分类是头图 其他为分类图标
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_sort.img_link</code>. 图标或者头图链接
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_sort.first</code>. 优先级
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_sort.type</code>. 0普通商家分类 1推荐分类
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_sort.sort_desc</code>.
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_sort.keywords</code>.
     */
    ...
    /**
     * Create a <code>mini_shop_1.b2c_sort</code> table reference
     */
    public Sort() {
    ...
    /**
     * Create an aliased <code>mini_shop_1.b2c_sort</code> table reference
     */
     ...
     */
    @Override
    public Identity<SortRecord, UInteger> getIdentity() {
