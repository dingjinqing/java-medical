...
public class B2cShopAccountRecord extends UpdatableRecordImpl<B2cShopAccountRecord> {

    private static final long serialVersionUID = -1151080411;
    ...
    /**
     * Create a detached B2cShopAccountRecord
     */
    public B2cShopAccountRecord() {
        super(B2cShopAccount.B2C_SHOP_ACCOUNT);
    }

    /**
     * Create a detached, initialised B2cShopAccountRecord
     */
    public B2cShopAccountRecord(Integer sysId, String userName, String password, Byte state, Byte businessState, Byte shopGrade, Integer maxSkuNum, Integer maxShopNum, Timestamp addTime, Timestamp buyTime, Timestamp endTime, Integer lastLoginShopId, String mobile, String accountName, String shopAvatar, String company, String salesperson, String provinceCode, String cityCode, String districtCode, String address, Byte baseSale, String backlog) {
        super(B2cShopAccount.B2C_SHOP_ACCOUNT);
