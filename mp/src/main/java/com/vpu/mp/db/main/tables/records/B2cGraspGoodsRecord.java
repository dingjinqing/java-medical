...
public class B2cGraspGoodsRecord extends TableRecordImpl<B2cGraspGoodsRecord> {

    private static final long serialVersionUID = 582921455;
    ...
    /**
     * Create a detached B2cGraspGoodsRecord
     */
    public B2cGraspGoodsRecord() {
        super(B2cGraspGoods.B2C_GRASP_GOODS);
    }

    /**
     * Create a detached, initialised B2cGraspGoodsRecord
     */
    public B2cGraspGoodsRecord(Integer goodsId, Integer shopId, UInteger catId, String goodsSn, String goodsName, Integer brandId, String goodsAd, Integer goodsNumber, BigDecimal goodsWeight, BigDecimal marketPrice, BigDecimal shopPrice, BigDecimal costPrice, String goodsDesc, String goodsImg, UByte isOnSale, UByte isDelete, UByte goodsType, UInteger deliverTemplateId, UInteger goodsSaleNum, UInteger goodsCollectNum, Timestamp addTime, Timestamp updateTime, Byte state, String reason, Integer subAccountId, Timestamp saleTime, Integer limitBuyNum, String unit, Integer addSaleNum, Integer limitMaxNum, Byte saleType, Integer sortId, String goodsVideo, String goodsVideoImg, Integer goodsVideoSize, Integer goodsVideoId, Integer goodsPageId, Byte isPageUp, Byte isCardExclusive, UInteger baseSale, String onSaleShopId, Byte source, Byte isControlPrice, Byte goodsFlag) {
        super(B2cGraspGoods.B2C_GRASP_GOODS);
