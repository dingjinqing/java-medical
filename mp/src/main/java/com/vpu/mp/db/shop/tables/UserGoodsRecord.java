...
public class UserGoodsRecord extends TableImpl<UserGoodsRecordRecord> {
    ...
    private static final long serialVersionUID = 569334833;

    /**
     * The reference instance of <code>mini_shop_1.b2c_user_goods_record</code>
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_user_goods_record.id</code>.
     */
    public final TableField<UserGoodsRecordRecord, ULong> ID = createField("id", org.jooq.impl.SQLDataType.BIGINTUNSIGNED.nullable(false).identity(true), this, "");

    /**
     * The column <code>mini_shop_1.b2c_user_goods_record.user_id</code>. 用户id
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_user_goods_record.goods_id</code>. 商品id
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_user_goods_record.active_id</code>. 活动id
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_user_goods_record.active_type</code>. 活动类型
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_user_goods_record.add_time</code>. 时间
     */
    public final TableField<UserGoodsRecordRecord, Timestamp> ADD_TIME = createField("add_time", org.jooq.impl.SQLDataType.TIMESTAMP, this, "时间");

    /**
     * The column <code>mini_shop_1.b2c_user_goods_record.user_ip</code>. 用户ip
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_user_goods_record.province_code</code>. 省
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_user_goods_record.province</code>. 省
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_user_goods_record.city_code</code>. 市
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_user_goods_record.city</code>. 市
     */
    public final TableField<UserGoodsRecordRecord, String> CITY = createField("city", org.jooq.impl.SQLDataType.VARCHAR(20), this, "市");

    /**
     * The column <code>mini_shop_1.b2c_user_goods_record.district_code</code>. 区
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_user_goods_record.district</code>. 区
     */
    ...
    /**
     * Create a <code>mini_shop_1.b2c_user_goods_record</code> table reference
     */
    ...
    /**
     * Create an aliased <code>mini_shop_1.b2c_user_goods_record</code> table reference
     */
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.USER_GOODS_RECORD_ADD_TIME, Indexes.USER_GOODS_RECORD_PRIMARY);
    }
     ...
     */
    @Override
    public Identity<UserGoodsRecordRecord, ULong> getIdentity() {
