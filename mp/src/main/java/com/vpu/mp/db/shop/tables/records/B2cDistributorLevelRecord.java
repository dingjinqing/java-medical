...
public class B2cDistributorLevelRecord extends UpdatableRecordImpl<B2cDistributorLevelRecord> implements Record9<UInteger, Byte, String, Byte, Integer, BigDecimal, BigDecimal, String, Byte> {

    private static final long serialVersionUID = 1440693802;
    ...
    public Field<UInteger> field1() {
        return B2cDistributorLevel.B2C_DISTRIBUTOR_LEVEL.ID;
    }
    ...
    public Field<Byte> field2() {
        return B2cDistributorLevel.B2C_DISTRIBUTOR_LEVEL.LEVEL_ID;
    }
    ...
    public Field<String> field3() {
        return B2cDistributorLevel.B2C_DISTRIBUTOR_LEVEL.LEVEL_NAME;
    }
    ...
    public Field<Byte> field4() {
        return B2cDistributorLevel.B2C_DISTRIBUTOR_LEVEL.LEVEL_UP_ROUTE;
    }
    ...
    public Field<Integer> field5() {
        return B2cDistributorLevel.B2C_DISTRIBUTOR_LEVEL.INVITE_NUMBER;
    }
    ...
    public Field<BigDecimal> field6() {
        return B2cDistributorLevel.B2C_DISTRIBUTOR_LEVEL.TOTAL_DISTRIBUTION_MONEY;
    }
    ...
    public Field<BigDecimal> field7() {
        return B2cDistributorLevel.B2C_DISTRIBUTOR_LEVEL.TOTAL_BUY_MONEY;
    }
    ...
    public Field<String> field8() {
        return B2cDistributorLevel.B2C_DISTRIBUTOR_LEVEL.LEVEL_USER_IDS;
    }
    ...
    public Field<Byte> field9() {
        return B2cDistributorLevel.B2C_DISTRIBUTOR_LEVEL.LEVEL_STATUS;
    }
     ...
     */
    @Override
    public B2cDistributorLevelRecord value1(UInteger value) {
        setId(value);
        return this;
    }
     ...
     */
    @Override
    public B2cDistributorLevelRecord value2(Byte value) {
        setLevelId(value);
        return this;
    }
     ...
     */
    @Override
    public B2cDistributorLevelRecord value3(String value) {
        setLevelName(value);
        return this;
    }
     ...
     */
    @Override
    public B2cDistributorLevelRecord value4(Byte value) {
     ...
     */
    @Override
    public B2cDistributorLevelRecord value5(Integer value) {
     ...
     */
    @Override
    public B2cDistributorLevelRecord value6(BigDecimal value) {
     ...
     */
    @Override
    public B2cDistributorLevelRecord value7(BigDecimal value) {
     ...
     */
    @Override
    public B2cDistributorLevelRecord value8(String value) {
     ...
     */
    @Override
    public B2cDistributorLevelRecord value9(Byte value) {
     ...
     */
    @Override
    public B2cDistributorLevelRecord values(UInteger value1, Byte value2, String value3, Byte value4, Integer value5, BigDecimal value6, BigDecimal value7, String value8, Byte value9) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
    ...
    /**
     * Create a detached B2cDistributorLevelRecord
     */
    public B2cDistributorLevelRecord() {
        super(B2cDistributorLevel.B2C_DISTRIBUTOR_LEVEL);
    }

    /**
     * Create a detached, initialised B2cDistributorLevelRecord
     */
    public B2cDistributorLevelRecord(UInteger id, Byte levelId, String levelName, Byte levelUpRoute, Integer inviteNumber, BigDecimal totalDistributionMoney, BigDecimal totalBuyMoney, String levelUserIds, Byte levelStatus) {
        super(B2cDistributorLevel.B2C_DISTRIBUTOR_LEVEL);
