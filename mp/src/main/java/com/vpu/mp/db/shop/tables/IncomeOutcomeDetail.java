...
public class IncomeOutcomeDetail extends TableImpl<IncomeOutcomeDetailRecord> {
    ...
    private static final long serialVersionUID = 284275153;

    /**
     * The reference instance of <code>mini_shop_1.b2c_income_outcome_detail</code>
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_income_outcome_detail.id</code>.
     */
    public final TableField<IncomeOutcomeDetailRecord, UInteger> ID = createField("id", org.jooq.impl.SQLDataType.INTEGERUNSIGNED.nullable(false).identity(true), this, "");

    /**
     * The column <code>mini_shop_1.b2c_income_outcome_detail.req_id</code>.
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_income_outcome_detail.shop_id</code>. 店铺ID
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_income_outcome_detail.pay_sn</code>. 支付流水号
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_income_outcome_detail.pay_code</code>. 支付宝:alipay,微信：？，...
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_income_outcome_detail.pay_code_alias</code>. 支付宝:alipay,微信：？，...
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_income_outcome_detail.pay_act_name</code>. 支付说明
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_income_outcome_detail.pay_act_time</code>. 交易付款时间
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_income_outcome_detail.income_amount</code>. 收入金额
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_income_outcome_detail.outcome_amount</code>. 支出金额
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_income_outcome_detail.pay_fee</code>. 手续费
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_income_outcome_detail.total_surplus_amount</code>. 余额
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_income_outcome_detail.trade_no</code>. 各平台交易号
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_income_outcome_detail.order_sn</code>. 网站订单号
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_income_outcome_detail.order_comp_status</code>. 订单完成状态1：已完成，2:未完成
     */
    public final TableField<IncomeOutcomeDetailRecord, UByte> ORDER_COMP_STATUS = createField("order_comp_status", org.jooq.impl.SQLDataType.TINYINTUNSIGNED.nullable(false).defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.TINYINTUNSIGNED)), this, "订单完成状态1：已完成，2:未完成");

    /**
     * The column <code>mini_shop_1.b2c_income_outcome_detail.update_order_status_time</code>. 更新订单状态时间
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_income_outcome_detail.pay_type</code>. 支付类型 1:收入，2：支出
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_income_outcome_detail.pay_type_name</code>. 支付类型名称
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_income_outcome_detail.remark</code>. 自定义备注
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_income_outcome_detail.created</code>. 创建时间
     */
    public final TableField<IncomeOutcomeDetailRecord, Timestamp> CREATED = createField("created", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "创建时间");

    /**
     * The column <code>mini_shop_1.b2c_income_outcome_detail.no_settle_flag</code>. 是否参与结算 0:参入，1：不参与
     */
    ...
    /**
     * Create a <code>mini_shop_1.b2c_income_outcome_detail</code> table reference
     */
    ...
    /**
     * Create an aliased <code>mini_shop_1.b2c_income_outcome_detail</code> table reference
     */
     ...
     */
    @Override
    public Identity<IncomeOutcomeDetailRecord, UInteger> getIdentity() {
