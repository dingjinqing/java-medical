...
public class DistributionOrder extends TableImpl<DistributionOrderRecord> {
    ...
    private static final long serialVersionUID = 356205191;

    /**
     * The reference instance of <code>mini_shop_1.b2c_distribution_order</code>
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_distribution_order.ref_date</code>. 2018-07
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_distribution_order.province</code>. 省
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_distribution_order.city</code>. 市
     */
    public final TableField<DistributionOrderRecord, String> CITY = createField("city", org.jooq.impl.SQLDataType.VARCHAR(20), this, "市");

    /**
     * The column <code>mini_shop_1.b2c_distribution_order.district</code>. 区
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_distribution_order.province_code</code>. 省份编号
     */
    public final TableField<DistributionOrderRecord, UInteger> PROVINCE_CODE = createField("province_code", org.jooq.impl.SQLDataType.INTEGERUNSIGNED.nullable(false).defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.INTEGERUNSIGNED)), this, "省份编号");

    /**
     * The column <code>mini_shop_1.b2c_distribution_order.city_code</code>. 城市编号
     */
    public final TableField<DistributionOrderRecord, UInteger> CITY_CODE = createField("city_code", org.jooq.impl.SQLDataType.INTEGERUNSIGNED.nullable(false).defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.INTEGERUNSIGNED)), this, "城市编号");

    /**
     * The column <code>mini_shop_1.b2c_distribution_order.district_code</code>. 区县编号
     */
    public final TableField<DistributionOrderRecord, UInteger> DISTRICT_CODE = createField("district_code", org.jooq.impl.SQLDataType.INTEGERUNSIGNED.nullable(false).defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.INTEGERUNSIGNED)), this, "区县编号");

    /**
     * The column <code>mini_shop_1.b2c_distribution_order.pay_order_money</code>. 付款金额
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_distribution_order.pay_user_num</code>. 付款人数
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_distribution_order.uv</code>. 访客数
     */
    public final TableField<DistributionOrderRecord, Integer> UV = createField("uv", org.jooq.impl.SQLDataType.INTEGER, this, "访客数");

    /**
     * The column <code>mini_shop_1.b2c_distribution_order.uv_pay_ratio</code>. 转化率
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_distribution_order.order_num</code>. 订单数
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_distribution_order.add_time</code>. 添加时间
     */
    public final TableField<DistributionOrderRecord, Timestamp> ADD_TIME = createField("add_time", org.jooq.impl.SQLDataType.TIMESTAMP, this, "添加时间");

    /**
     * Create a <code>mini_shop_1.b2c_distribution_order</code> table reference
     */
    ...
    /**
     * Create an aliased <code>mini_shop_1.b2c_distribution_order</code> table reference
     */
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.DISTRIBUTION_ORDER_PAY_ORDER_MONEY, Indexes.DISTRIBUTION_ORDER_REF_DATE);
    }
