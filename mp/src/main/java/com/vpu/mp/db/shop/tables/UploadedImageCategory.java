...
public class UploadedImageCategory extends TableImpl<UploadedImageCategoryRecord> {
    ...
    private static final long serialVersionUID = -1358399609;

    /**
     * The reference instance of <code>mini_shop_1.b2c_uploaded_image_category</code>
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_uploaded_image_category.img_cat_id</code>.
     */
    public final TableField<UploadedImageCategoryRecord, UInteger> IMG_CAT_ID = createField("img_cat_id", org.jooq.impl.SQLDataType.INTEGERUNSIGNED.nullable(false).identity(true), this, "");

    /**
     * The column <code>mini_shop_1.b2c_uploaded_image_category.shop_id</code>. 店铺ID
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_uploaded_image_category.img_cat_name</code>.
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_uploaded_image_category.img_cat_parent_id</code>.
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_uploaded_image_category.create_time</code>.
     */
    public final TableField<UploadedImageCategoryRecord, Timestamp> CREATE_TIME = createField("create_time", org.jooq.impl.SQLDataType.TIMESTAMP.defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "");

    /**
     * The column <code>mini_shop_1.b2c_uploaded_image_category.cat_ids</code>. 层级ID串,逗号分隔
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_uploaded_image_category.level</code>. 层级，0开始
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_uploaded_image_category.sort</code>. 排序优先级
     */
    ...
    /**
     * Create a <code>mini_shop_1.b2c_uploaded_image_category</code> table reference
     */
    ...
    /**
     * Create an aliased <code>mini_shop_1.b2c_uploaded_image_category</code> table reference
     */
     ...
     */
    @Override
    public Identity<UploadedImageCategoryRecord, UInteger> getIdentity() {
