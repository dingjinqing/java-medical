...
public class CardExamine extends TableImpl<CardExamineRecord> {
    ...
    private static final long serialVersionUID = 917926701;

    /**
     * The reference instance of <code>mini_shop_1.b2c_card_examine</code>
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_card_examine.id</code>. 订单id
     */
    public final TableField<CardExamineRecord, UInteger> ID = createField("id", org.jooq.impl.SQLDataType.INTEGERUNSIGNED.nullable(false).identity(true), this, "订单id");

    /**
     * The column <code>mini_shop_1.b2c_card_examine.card_id</code>. 会云卡id
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_card_examine.card_no</code>. 会员卡NO
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_card_examine.user_id</code>. 用户id
     */
    public final TableField<CardExamineRecord, UInteger> USER_ID = createField("user_id", org.jooq.impl.SQLDataType.INTEGERUNSIGNED.nullable(false).defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.INTEGERUNSIGNED)), this, "用户id");

    /**
     * The column <code>mini_shop_1.b2c_card_examine.status</code>. 审核状态 1审核中 2通过 3拒绝
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_card_examine.desc</code>. 备注
     */
    public final TableField<CardExamineRecord, String> DESC = createField("desc", org.jooq.impl.SQLDataType.VARCHAR(512), this, "备注");

    /**
     * The column <code>mini_shop_1.b2c_card_examine.real_name</code>. 真是姓名
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_card_examine.cid</code>. 身份证号
     */
    public final TableField<CardExamineRecord, String> CID = createField("cid", org.jooq.impl.SQLDataType.VARCHAR(18), this, "身份证号");

    /**
     * The column <code>mini_shop_1.b2c_card_examine.province_code</code>. 所在地
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_card_examine.city_code</code>. 所在地
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_card_examine.district_code</code>. 所在地
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_card_examine.sex</code>. 性别
     */
    public final TableField<CardExamineRecord, String> SEX = createField("sex", org.jooq.impl.SQLDataType.CHAR(5), this, "性别");

    /**
     * The column <code>mini_shop_1.b2c_card_examine.birthday_year</code>. 生日
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_card_examine.birthday_month</code>. 生日
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_card_examine.birthday_day</code>. 生日
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_card_examine.marital_status</code>. 婚姻状况
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_card_examine.education</code>. 教育程度
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_card_examine.industry_info</code>. 所在行业
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_card_examine.add_time</code>. 提交时间
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_card_examine.pass_time</code>. 通过时间
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_card_examine.refuse_time</code>. 拒绝时间
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_card_examine.refuse_desc</code>. 拒绝理由
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_card_examine.del_flag</code>. 删除
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_card_examine.def_time</code>. 删除时间
     */
    ...
    /**
     * Create a <code>mini_shop_1.b2c_card_examine</code> table reference
     */
    public CardExamine() {
    ...
    /**
     * Create an aliased <code>mini_shop_1.b2c_card_examine</code> table reference
     */
     ...
     */
    @Override
    public Identity<CardExamineRecord, UInteger> getIdentity() {
