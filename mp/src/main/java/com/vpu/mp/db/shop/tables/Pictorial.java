...
public class Pictorial extends TableImpl<PictorialRecord> {
    ...
    private static final long serialVersionUID = -203477236;

    /**
     * The reference instance of <code>mini_shop_1.b2c_pictorial</code>
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_pictorial.id</code>.
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_pictorial.action</code>. 海报类型： 1：普通 2 ：拼团 3：砍价 4：表单 5:拼团分享
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_pictorial.path</code>. 海报路径
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_pictorial.rule</code>. 生成触发规则
     */
    public final TableField<PictorialRecord, String> RULE = createField("rule", org.jooq.impl.SQLDataType.CLOB, this, "生成触发规则");

    /**
     * The column <code>mini_shop_1.b2c_pictorial.user_id</code>.
     */
    public final TableField<PictorialRecord, Integer> USER_ID = createField("user_id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.INTEGER)), this, "");

    /**
     * The column <code>mini_shop_1.b2c_pictorial.identity_id</code>. 关联ID： 例如：goods_id, page_id
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_pictorial.add_time</code>. 生成时间
     */
    public final TableField<PictorialRecord, Timestamp> ADD_TIME = createField("add_time", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false), this, "生成时间");

    /**
     * The column <code>mini_shop_1.b2c_pictorial.update_time</code>. 更新时间
     */
    public final TableField<PictorialRecord, Timestamp> UPDATE_TIME = createField("update_time", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "更新时间");

    /**
     * The column <code>mini_shop_1.b2c_pictorial.del_flag</code>. 删除标记： 1：删除
     */
    public final TableField<PictorialRecord, Byte> DEL_FLAG = createField("del_flag", org.jooq.impl.SQLDataType.TINYINT.nullable(false).defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.TINYINT)), this, "删除标记： 1：删除");

    /**
     * The column <code>mini_shop_1.b2c_pictorial.del_time</code>.
     */
    public final TableField<PictorialRecord, Integer> DEL_TIME = createField("del_time", org.jooq.impl.SQLDataType.INTEGER.defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.INTEGER)), this, "");

    /**
     * Create a <code>mini_shop_1.b2c_pictorial</code> table reference
     */
    public Pictorial() {
    ...
    /**
     * Create an aliased <code>mini_shop_1.b2c_pictorial</code> table reference
     */
