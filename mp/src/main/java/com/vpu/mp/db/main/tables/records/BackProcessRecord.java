...
public class BackProcessRecord extends UpdatableRecordImpl<BackProcessRecord> implements Record17<UInteger, Integer, Integer, String, String, String, Byte, String, Byte, Short, String, Timestamp, Integer, String, String, String, Timestamp> {

    private static final long serialVersionUID = 1152977328;
     ...
     */
    @Override
    public BackProcessRecord value1(UInteger value) {
        setRecId(value);
        return this;
    }
     ...
     */
    @Override
    public BackProcessRecord values(UInteger value1, Integer value2, Integer value3, String value4, String value5, String value6, Byte value7, String value8, Byte value9, Short value10, String value11, Timestamp value12, Integer value13, String value14, String value15, String value16, Timestamp value17) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public BackProcessRecord(UInteger recId, Integer shopId, Integer processId, String jobName, String className, String parameters, Byte state, String failReason, Byte onlyRunOne, Short progress, String progressInfo, Timestamp endTime, Integer jobCode, String jobMessage, String jobResult, String memo, Timestamp created) {
        super(BackProcess.BACK_PROCESS);
