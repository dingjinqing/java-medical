...
public class B2cUserSummaryTrendRecord extends UpdatableRecordImpl<B2cUserSummaryTrendRecord> {
    ...
    private static final long serialVersionUID = 1273628064;
     ...
     */
    public B2cUserSummaryTrendRecord(Integer id, Integer shopId, Date refDate, Byte type, Integer loginData, Integer userData, Integer couponData, Integer cartData, Integer regUserData, Integer upgradeUserData, Integer chargeUserData, Integer orderUserData, Integer newOrderUserData, Integer oldOrderUserData, Integer totalPaidMoney, BigDecimal newPaidMoney, Long oldPaidMoney, Integer payGoodsNumber, Integer newPayGoodsNumber, Integer oldPayGoodsNumber, Integer payOrderNum, Integer loginPv, Integer orderNum, Integer orderUserNum, Timestamp addTime) {
        super(B2cUserSummaryTrend.B2C_USER_SUMMARY_TREND);
