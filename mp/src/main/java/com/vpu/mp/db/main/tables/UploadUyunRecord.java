...
public class UploadUyunRecord extends TableImpl<UploadUyunRecordRecord> {
    ...
    private static final long serialVersionUID = -2114153739;
     ...
     */
    public final TableField<UploadUyunRecordRecord, Timestamp> UPLOAD_TIME = createField("upload_time", org.jooq.impl.SQLDataType.TIMESTAMP.defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "文件上传时间");
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.UPLOAD_UYUN_RECORD_FILE_URL, Indexes.UPLOAD_UYUN_RECORD_PRIMARY);
    }
