...
public class MrkingStrategyCondition extends TableImpl<MrkingStrategyConditionRecord> {
    ...
    private static final long serialVersionUID = 707343895;

    /**
     * The reference instance of <code>mini_shop_1.b2c_mrking_strategy_condition</code>
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_mrking_strategy_condition.id</code>.
     */
    public final TableField<MrkingStrategyConditionRecord, UInteger> ID = createField("id", org.jooq.impl.SQLDataType.INTEGERUNSIGNED.nullable(false).identity(true), this, "");

    /**
     * The column <code>mini_shop_1.b2c_mrking_strategy_condition.shop_id</code>. 店铺ID
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_mrking_strategy_condition.strategy_id</code>.
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_mrking_strategy_condition.full_money</code>. 满多少金额
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_mrking_strategy_condition.reduce_money</code>. 减多少钱
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_mrking_strategy_condition.amount</code>. 满几件
     */
    public final TableField<MrkingStrategyConditionRecord, UInteger> AMOUNT = createField("amount", org.jooq.impl.SQLDataType.INTEGERUNSIGNED.defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.INTEGERUNSIGNED)), this, "满几件");

    /**
     * The column <code>mini_shop_1.b2c_mrking_strategy_condition.discount</code>. 打几折
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_mrking_strategy_condition.gift</code>. 赠品
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_mrking_strategy_condition.gift_left</code>. 赠品剩余数量
     */
    ...
    /**
     * Create a <code>mini_shop_1.b2c_mrking_strategy_condition</code> table reference
     */
    ...
    /**
     * Create an aliased <code>mini_shop_1.b2c_mrking_strategy_condition</code> table reference
     */
     ...
     */
    @Override
    public Identity<MrkingStrategyConditionRecord, UInteger> getIdentity() {
