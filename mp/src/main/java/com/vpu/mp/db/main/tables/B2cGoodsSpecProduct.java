...
public class B2cGoodsSpecProduct extends TableImpl<B2cGoodsSpecProductRecord> {
    ...
    private static final long serialVersionUID = 803635936;
     ...
     */
    public final TableField<B2cGoodsSpecProductRecord, Integer> PRD_NUMBER = createField("prd_number", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.inline("1", org.jooq.impl.SQLDataType.INTEGER)), this, "当前规格组合产品库存");
