...
public class TradesRecordSummary extends TableImpl<TradesRecordSummaryRecord> {
    ...
    private static final long serialVersionUID = 1768184196;

    /**
     * The reference instance of <code>mini_shop_1.b2c_trades_record_summary</code>
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_trades_record_summary.id</code>.
     */
    public final TableField<TradesRecordSummaryRecord, UInteger> ID = createField("id", org.jooq.impl.SQLDataType.INTEGERUNSIGNED.nullable(false).identity(true), this, "");

    /**
     * The column <code>mini_shop_1.b2c_trades_record_summary.type</code>. 统计类型：1,7,30
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_trades_record_summary.income_total_money</code>. 总现金收入
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_trades_record_summary.outgo_money</code>. 现金支出
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_trades_record_summary.income_real_money</code>. 净现金收入
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_trades_record_summary.income_total_score</code>. 总积分收入
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_trades_record_summary.outgo_score</code>. 积分支出
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_trades_record_summary.income_real_score</code>. 净积分收入
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_trades_record_summary.add_time</code>. 统计时间
     */
    public final TableField<TradesRecordSummaryRecord, Timestamp> ADD_TIME = createField("add_time", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false), this, "统计时间");

    /**
     * The column <code>mini_shop_1.b2c_trades_record_summary.ref_date</code>. 2018-09-04
     */
    ...
    /**
     * Create a <code>mini_shop_1.b2c_trades_record_summary</code> table reference
     */
    ...
    /**
     * Create an aliased <code>mini_shop_1.b2c_trades_record_summary</code> table reference
     */
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.TRADES_RECORD_SUMMARY_PRIMARY);
    }
     ...
     */
    @Override
    public Identity<TradesRecordSummaryRecord, UInteger> getIdentity() {
    ...
    public List<UniqueKey<TradesRecordSummaryRecord>> getKeys() {
        return Arrays.<UniqueKey<TradesRecordSummaryRecord>>asList(Keys.KEY_B2C_TRADES_RECORD_SUMMARY_PRIMARY);
    }
