...
public class BargainUserList extends TableImpl<BargainUserListRecord> {
    ...
    private static final long serialVersionUID = -1261454659;

    /**
     * The reference instance of <code>mini_shop_1.b2c_bargain_user_list</code>
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_bargain_user_list.id</code>.
     */
    public final TableField<BargainUserListRecord, UInteger> ID = createField("id", org.jooq.impl.SQLDataType.INTEGERUNSIGNED.nullable(false).identity(true), this, "");

    /**
     * The column <code>mini_shop_1.b2c_bargain_user_list.record_id</code>. 对应b2c_bargain_record表id
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_bargain_user_list.user_id</code>.
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_bargain_user_list.bargain_money</code>.
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_bargain_user_list.add_time</code>.
     */
    ...
    /**
     * Create a <code>mini_shop_1.b2c_bargain_user_list</code> table reference
     */
    ...
    /**
     * Create an aliased <code>mini_shop_1.b2c_bargain_user_list</code> table reference
     */
     ...
     */
    @Override
    public Identity<BargainUserListRecord, UInteger> getIdentity() {
