...
public class B2cUser extends TableImpl<B2cUserRecord> {
    ...
    private static final long serialVersionUID = -163471530;
     ...
     */
    public final TableField<B2cUserRecord, Long> ID = createField("id", org.jooq.impl.SQLDataType.BIGINT.nullable(false).identity(true), this, "");
     ...
     */
    public final TableField<B2cUserRecord, Long> USER_ID = createField("user_id", org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");
     ...
     */
    public final TableField<B2cUserRecord, Integer> INVITE = createField("invite", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.INTEGER)), this, "");

    /**
     * The column <code>mini_main.b2c_user.invite_source</code>. 邀请来源
     */
    public final TableField<B2cUserRecord, String> INVITE_SOURCE = createField("invite_source", org.jooq.impl.SQLDataType.VARCHAR(32), this, "邀请来源");
     ...
     */
    public final TableField<B2cUserRecord, Date> INVITE_EXPIRY_DATE = createField("invite_expiry_date", org.jooq.impl.SQLDataType.DATE.defaultValue(org.jooq.impl.DSL.inline("0000-00-00", org.jooq.impl.SQLDataType.DATE)), this, "邀请失效时间");

    /**
     * The column <code>mini_main.b2c_user.wx_union_id</code>. 小程序union_id
     */
    public final TableField<B2cUserRecord, String> WX_UNION_ID = createField("wx_union_id", org.jooq.impl.SQLDataType.VARCHAR(191).nullable(false).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.VARCHAR)), this, "小程序union_id");
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.B2C_USER_PRIMARY, Indexes.B2C_USER_UN_USER_ID, Indexes.B2C_USER_USER_ID, Indexes.B2C_USER_WX_OPENID);
    }
     ...
     */
    @Override
    public Identity<B2cUserRecord, Long> getIdentity() {
    ...
    public List<UniqueKey<B2cUserRecord>> getKeys() {
        return Arrays.<UniqueKey<B2cUserRecord>>asList(Keys.KEY_B2C_USER_PRIMARY, Keys.KEY_B2C_USER_UN_USER_ID);
    }
