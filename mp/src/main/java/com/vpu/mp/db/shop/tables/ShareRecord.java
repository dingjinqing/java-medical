...
public class ShareRecord extends TableImpl<ShareRecordRecord> {
    ...
    private static final long serialVersionUID = -1410880489;

    /**
     * The reference instance of <code>mini_shop_1.b2c_share_record</code>
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_share_record.id</code>.
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_share_record.activity_id</code>. 活动id或商品id
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_share_record.user_id</code>.
     */
    public final TableField<ShareRecordRecord, Integer> USER_ID = createField("user_id", org.jooq.impl.SQLDataType.INTEGER, this, "");

    /**
     * The column <code>mini_shop_1.b2c_share_record.activity_type</code>. 活动类型
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_share_record.add_time</code>. 浏览时间
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_share_record.count</code>. 次数
     */
    public final TableField<ShareRecordRecord, Integer> COUNT = createField("count", org.jooq.impl.SQLDataType.INTEGER, this, "次数");

    /**
     * Create a <code>mini_shop_1.b2c_share_record</code> table reference
     */
    public ShareRecord() {
    ...
    /**
     * Create an aliased <code>mini_shop_1.b2c_share_record</code> table reference
     */
