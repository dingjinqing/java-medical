...
<div class="double_goods_module">
    <table>
        <tr>
            <td class="p_goods_item1" width="50%">
                <div class="item-picture">
                    <div class="photo-two" style="overflow: hidden;position: relative">
                        ...
                        <img class="item_img"
                            src="http://${image_domain!}/image/admin/shop_beautify/decorate_model.png"
            ...
            <td class="p_goods_item2" width="50%">
                <div class="item-picture">
                    <div class="photo-two" style="overflow: hidden;position: relative">
                        <div class="label-control ">
                            <span>热卖推</span>
...
<div class="three_goods_module">
    <table style="width: 100%;">
        <tr>
            <td class="t_goods_item1" width="33.3%">
                <div class="item-picture">
            ...
            <td class="t_goods_item2" width="33.3%">
                <div class="item-picture">
                    <div class="photo-three" style="position: relative">
                        <div class=" label-control ">
                            <span>热卖推荐</span>
            ...
            <td class="t_goods_item3" width="33.3%">
                <div class="item-picture">
                    <div class="photo-three" style="position: relative">
                        <div class="label-control ">
                            <span>热卖推荐</span>
...
<div class="data_item d_m_goods edit_goods_module">
    ...
    <div class="goods_edit_module" style="position:relative;">
        ...
        <table cellspacing='1' cellpadding='3' class="base_message">
            <tr>
                <td style="vertical-align: top !important;">选择商品模板：</td>
                <td class="img_list">
            ...
            <tr class="display_show" style="display: none;">
                <td style="padding: 0">单列图片展示模式：</td>
                <td>
                    <label for="paved">
            ...
            <tr>
                ...
                <td>
                    ...
                    <div class="shopping_btn">
                        ...
                        <input type="checkbox" value="0" id="show_market_price">划线价(市场价)
                        <div class="btn_cart">
            ...
            <tr>
                <td>推荐类型：</td>
                <td><select name="recommend_type" style="width: 40%;padding-left: 12px;height:30px">
                        <option value="0">自动推荐</option>
                        <option value="1">手动推荐</option>
                    </select>
                </td>
            </tr>
        </table>
