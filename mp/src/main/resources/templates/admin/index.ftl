            ...
            <span>
                @if (!$user['is_sub_account'])<span>
                    <img @if($user['shop_avatar'] != '') src="${user['shop_avatar']!}"
                         @else src="http://{{$image_domain}}/image/admin/head_icon.png" @endif class="head-img"
                        ...
                        <dl class="item-menu"
                            ...
                            @if (isset($item['sub']))
                                <div class="sub-menu" style="display:none">
                                    @foreach ((array)$item['sub']  as $sub_item)
