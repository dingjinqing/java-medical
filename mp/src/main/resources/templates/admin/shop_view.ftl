...
<div class="order-container" style="padding-bottom: 80px">
    <div class="setting-head fix_every_footer">
        <ul class="setting-head-ul clearfix">
            <li @if($act == 'pay')class="head-active"@endif><a href="##">支付配置</a></li>
            <li @if($act == 'draw')class="head-active"@endif><a href="##">退换货配置</a></li>
            <li @if($act == 'deliver')class="head-active"@endif><a href="##">配送方式配置</a></li>
            <li @if($act == 'other')class="head-active"@endif><a href="##">其他配置</a></li>
        </ul>
        <div class="setting-content">
            <div class="_content content1"  @if($act == 'pay')style="display: block" @endif>
                    ...
                    <div class="content1-pay">
                        <ul>
                            <li class="con1-pay-list clearfix">
                                ...
                                <div class="fl pay_fl" img_id="{{ $pay->wxpay == 1 ? 1 : 0 }}"  @if($pay->wxpay == 1)style='background: url("http://{{$image_domain
}}/image/admin/on_1.png") left top / 100% 100% no-repeat;'@endif>
                                    <label>
                                        <input type="checkbox" name="wxpay" aid="" @if($pay->wxpay == 1) checked @endif />
                                        <img src="http://{{$image_domain}}/image/admin/circle.png" class="draggable" @if($pay->wxpay == 1)style="right:0px;"@endif/>
                                    </label>
                                </div>
                                <span></span>
                                <span class="pay-text">
                            ...
                            <li class="con1-pay-list clearfix">
                                ...
                                <div class="fl pay_fl" img_id="{{ $pay->score == 1 ? 1 : 0 }}" @if($pay->score == 1)style='background: url("/image/admin/on_1.png") left top / 100% 100% no-repeat;'@endif>
                                    <label>
                                        <input type="checkbox" name="score" aid="" @if($pay->score == 1) checked @endif />
                                        <img src="http://{{$image_domain}}/image/admin/circle.png" class="draggable" @if($pay->score == 1)style="right:0px;"@endif/>
                                    </label>
                                </div>
                                <span></span>
                                <span class="pay-text">
                            ...
                            <li class="con1-pay-list clearfix">
                                ...
                                <div class="fl pay_fl" img_id="{{ $pay->balance == 1 ? 1 : 0 }}" @if($pay->balance == 1)style='background: url("/image/admin/on_1.png") left top / 100% 100% no-repeat;'@endif>
                                    <label>
                                        <input type="checkbox" name="balance" aid="" @if($pay->balance == 1) checked @endif />
                                        <img src="http://{{$image_domain}}/image/admin/circle.png" class="draggable" @if($pay->balance == 1)style="right:0px;"@endif />
                                    </label>
                                </div>
                                <span></span>
                                <span class="pay-text">
                            ...
                            <li class="con1-pay-list clearfix" >
                                ...
                                <div class="fl pay_fl" img_id="{{ $pay->cod == 1 ? 1 : 0 }}" @if($pay->cod == 1)style='background: url("/image/admin/on_1.png") left top / 100% 100% no-repeat;'@endif>
                                    <label>
                                        <input type="checkbox" name="cod" aid="" @if($pay->cod == 1) checked @endif  />
                                        <img src="http://{{$image_domain}}/image/admin/circle.png" class="draggable" @if($pay->cod == 1)style="right:0px;"@endif/>
                                    </label>
                                </div>
                                <span></span>
                                <span class="pay-text">
            ...
            <div class="_content content2" @if($act == 'draw')style="display: block" @endif>
                    ...
                    <div class="con2-head clearfix">
                        ...
                        <div class="fl">
                            <label for="yes-re">
                                ...
                                @endif
                                <input type="radio" name="drawback_type"  value='1' id="yes-re" @if($drawback_type ==1) checked @endif />
                                &nbsp;&nbsp;支持退换货
                            </label>
                            <label for="no-re">
                                @if($drawback_type ==0)
                                ...
                                @else
                                    <img src="http://{{$image_domain}}/image/admin/check_no.png" alt="no" class="re-radio" />
                                @endif
                                <input type="radio" name="drawback_type"  value='0' id="no-re" @if($drawback_type ==0) checked @endif />
                                &nbsp;&nbsp;不支持退换货
                            </label>
                        </div>
                    </div>
                    ...
                    <div style="padding:15px 0">
                        ...
                        <div class="text-set" style="height: auto; line-height: 40px;">
                            <div class="radio_input">
                                <input type="radio" name="auto_return"   value="1" @if($auto_return == 1) checked @endif>开启
                                <input type="radio" name="auto_return"  value="0" @if($auto_return == 0) checked @endif>关闭
                            </div>
                            <div @if($auto_return != 0) style="display: none" @endif class="auto_return_close">
                                <div>商家同意退款退货，买家在7日内未提交物流信息，且商家未确认收货并退款，退款申请将自动完成。</div>
                            </div>
                            <div @if($auto_return != 1) style="display: none" @endif class="auto_return_open">
                        ...
                        <div class="text-set" style="height: 170px;" hidden>
                            <div class="radio_input">
                                <input type="radio" name="return_pass"   value="1" @if($return_pass == 1) checked @endif>开启
                                <input type="radio" name="return_pass"  value="0" @if($return_pass == 0) checked @endif>关闭
                            </div>
                        ...
                        <div class="text-prompt"><span class="blue_border"></span>客服设置 <span>买家发起退款申请后，是否可以联系客服（请确认已在微信公众平台创建客服）</span></div>
                        <div class="text-set">
                            <div class="radio_input">
                                <input type="radio" name="return_service"  id="act_no" value="1" @if($return_service == 1) checked @endif>开启
                                <input type="radio" name="return_service" id="act_yes" value="0" @if($return_service == 0) checked @endif>关闭
                            </div>
                        </div>
            ...
            <div class="_content content3" @if($act == 'deliver')style="display: block" @endif>
                <form action="/admin/config/trade?act=deliver" method="post" id="form3">
                    {{ csrf_field() }}
                    <div class="content1-pay">
                        <ul>
                            <li class="con1-pay-list clearfix">
                                <span class="fl mr_10">快递</span>
                                <div class="fl pay_fl" img_id="{{ $express == 1 ? 1 : 0 }}"  @if($express == 1) style='background: url("/image/admin/on_1.png") left top / 100% 100% no-repeat;' @endif>
                                    <label>
                                        <input type="checkbox" name="express" aid=""  @if($express == 1)checked @endif/>
                                        <img src="http://{{$image_domain}}/image/admin/circle.png" class="draggable" @if($express == 1) style="right:0px" @endif/>
                                    </label>
                                </div>
                                <span></span>
                                <span class="pay-text">
                            ...
                            <li class="con1-pay-list clearfix">
                                ...
                                <div class="fl pay_fl" img_id="{{ $fetch == 1 ? 1 : 0 }}" @if($fetch == 1) style='background: url("/image/admin/on_1.png") left top / 100% 100% no-repeat;' @endif>
                                    <label>
                                        <input type="checkbox" name="fetch" aid="" @if($fetch == 1)checked @endif />
                                        <img src="http://{{$image_domain}}/image/admin/circle.png" class="draggable" @if($fetch == 1) style="right:0px" @endif/>
                                    </label>
                                </div>
                                <span></span>
                                <span class="pay-text">
            ...
            <div class="_content content4" @if($act == 'other')style="display: block" @endif>
                <form action="/admin/config/trade?act=other" method="post" id="form4">
                    ...
                    <div>
                        ...
                        <div class="text-set clearfix">
                            <div class="fl pay_fl" img_id="{{ $invoice == 0 ? 1 : 0 }}" @if($invoice == 0) style='background: url("/image/admin/on_1.png") left top / 100% 100% no-repeat;' @endif>
                                <label>
                                    <input type="checkbox" name="invoice" aid="" @if($invoice ==0) checked @endif />
                                    <img src="http://{{$image_domain}}/image/admin/circle.png" class="draggable"@if($invoice ==0) style="right:0px" @endif  />
                                </label>
                            </div>
                        ...
                        <div class="text-set clearfix">
                            <div class="fl pay_fl" img_id="{{ $bind_mobile == 1 ? 1 : 0 }}" @if($bind_mobile == 1) style='background: url("/image/admin/on_1.png") left top / 100% 100% no-repeat;' @endif>
                                <label>
                                    <input type="checkbox" name="bind_mobile" aid="" @if($bind_mobile ==1) checked @endif />
                                    <img src="http://{{$image_domain}}/image/admin/circle.png" class="draggable"@if($bind_mobile ==1) style="right:0px" @endif  />
                                </label>
                            </div>
                            <span class="con4-hide"></span>
                        ...
                        <div class="text-set clearfix">
                            <div class="fl pay_fl" img_id="{{ $sales_number == 1 ? 1 : 0 }}" @if($sales_number == 1) style='background: url("/image/admin/on_1.png") left top / 100% 100% no-repeat;' @endif>
                                <label>
                                    <input type="checkbox" name="sales_number" aid="" @if($sales_number ==1) checked @endif />
                                    <img src="http://{{$image_domain}}/image/admin/circle.png" class="draggable"@if($sales_number ==1) style="right:0px" @endif  />
                                </label>
                            </div>
                            <span class="con4-hide"></span>
                        ...
                        <div class="text-set clearfix" style="min-height: 60px !important;height: auto !important;">
                            <div class="fl pay_fl" img_id="{{ $show_cart['show_cart'] == 1 ? 1 : 0 }}" @if($show_cart['show_cart'] == 1) style='background: url("/image/admin/on_1.png") left top / 100% 100% no-repeat;' @endif>
                                <label>
                                    <input type="checkbox" name="show_cart" @if($show_cart['show_cart'] ==1) checked @endif id="cart_btn"/>
                                    <img src="http://{{$image_domain}}/image/admin/circle.png" class="draggable"@if($show_cart['show_cart'] ==1) style="right:0px" @endif  />
                                </label>
                            </div>
                            <span class="con4-hide"></span>
                            <span>开关开启，商品搜索页以及推荐商品列表中会显示购买按钮</span>
                            <div class="btn_cart @if($show_cart['show_cart'] != 1) hide @endif">
                                <label for="shop_cart_1">
                                    <input type="radio" value="0" id="shop_cart_1"  name="cart_type" @if(!in_array($show_cart['cart_type'],[1,2,3])) checked @endif>
                                    <div class="iconfont icontianjia icon_font_size new_class"></div>
                                </label>
                                <label for="shop_cart_2" style="width: 75px">
                                    <input type="radio" value="1" id="shop_cart_2" name="cart_type" @if($show_cart['cart_type'] == 1) checked @endif>
                                    <div class="iconfont icongouwuche1 icon_font_size new_class"></div>
                                </label>
                                <label for="shop_cart_3" style="width: 110px">
                                    <input type="radio" value="2" id="shop_cart_3" name="cart_type" @if($show_cart['cart_type'] == 2) checked @endif>
                                    <div class="right_buy new_back">
                                        马上抢
                                    </div>
                                </label>
                                <label for="shop_cart_4">
                                    <input type="radio" value="3" id="shop_cart_4" name="cart_type" @if($show_cart['cart_type'] == 3) checked @endif>
                        ...
                        <div class="text-set clearfix">
                            <div class="fl pay_fl" img_id="{{ $custom_service == 1 ? 1 : 0 }}" @if($custom_service == 1) style='background: url("/image/admin/on_1.png") left top / 100% 100% no-repeat;' @endif>
                                <label>
                                    <input type="checkbox" name="custom_service" aid="" @if($custom_service ==1) checked @endif />
                                    <img src="http://{{$image_domain}}/image/admin/circle.png" class="draggable"@if($custom_service ==1) style="right:0px" @endif  />
                                </label>
                            </div>
                            <span class="con4-hide"></span>
                        ...
                        <div class="text_set clearfix" style="height: auto;">
                            <div class="fl pay_fl" img_id="{{ $service_terms == 1 ? 1 : 0 }}" @if($service_terms == 1) style='background: url("/image/admin/on_1.png") left top / 100% 100% no-repeat;' @endif>
                                <label>
                                    <input type="checkbox" name="service_terms" aid="" @if($service_terms ==1) checked @endif />
                                    <img src="http://{{$image_domain}}/image/admin/circle.png" class="draggable"@if($service_terms ==1) style="right:0px" @endif  />
                                </label>
                            </div>
                            <span class="con4-hide"></span>
                            ...
                            <div class="f1 service_config">
                                ...
                                <label for="yes-re">
                                    ...
                                    @else
                                        <img src="http://{{$image_domain}}/image/admin/check_no.png" alt="no" class="re-radio" />
                                    @endif
                                    <input type="radio" name="service_choose"  value='1'  @if($service_choose ==1) checked @endif />
                                    &nbsp;&nbsp;是
                                </label>
                                <label for="no-re">
                                    @if($service_choose ==0)
                                    ...
                                    @else
                                        <img src="http://{{$image_domain}}/image/admin/check_no.png" alt="no" class="re-radio" />
                                    @endif
                                    <input type="radio" name="service_choose"  value='0'  @if($service_choose ==0) checked @endif />
                                    &nbsp;&nbsp;否
                                </label>
                            </div>
                        ...
                        <div class="text-set clearfix" style="height: 270px;line-height: 50px">
                            <ul>
                                <li>
                                    ...
                                    <div class="fl pay_fl" img_id="{{ $order_real_name == 1 ? 1 : 0 }}" @if($order_real_name == 1) style='background: url("/image/admin/on_1.png") left top / 100% 100% no-repeat;margin-top: 0px' @endif>
                                        <label>
                                            <input type="checkbox" name="order_real_name" aid="" @if($order_real_name ==1) checked @endif />
                                            <img src="http://{{$image_domain}}/image/admin/circle.png" class="draggable"@if($order_real_name ==1) style="right:0px" @endif  />
                                        </label>
                                    </div>
                                    <span class="con4-hide"></span>
                                ...
                                <li>
                                    ...
                                    <div class="fl pay_fl" img_id="{{ $order_cid == 1 ? 1 : 0 }}" @if($order_cid == 1) style='margin-top: 0px;background: url("/image/admin/on_1.png") left top / 100% 100% no-repeat;' @endif>
                                        <label>
                                            <input type="checkbox" name="order_cid" aid="" @if($order_cid ==1) checked @endif />
                                            <img src="http://{{$image_domain}}/image/admin/circle.png" class="draggable"@if($order_cid ==1) style="right:0px" @endif  />
                                        </label>
                                    </div>
                                    <span class="con4-hide"></span>
                                ...
                                <li>
                                    ...
                                    <div class="fl pay_fl" img_id="{{ $consignee_real_name == 1 ? 1 : 0 }}" @if($consignee_real_name == 1) style='margin-top: 0px;background: url("/image/admin/on_1.png") left top / 100% 100% no-repeat;' @endif>
                                        <label>
                                            <input type="checkbox" name="consignee_real_name" aid="" @if($consignee_real_name ==1) checked @endif />
                                            <img src="http://{{$image_domain}}/image/admin/circle.png" class="draggable"@if($consignee_real_name ==1) style="right:0px" @endif  />
                                        </label>
                                    </div>
                                    <span class="con4-hide"></span>
                                ...
                                <li>
                                    ...
                                    <div class="fl pay_fl" img_id="{{ $consignee_cid == 1 ? 1 : 0 }}" @if($consignee_cid == 1) style='margin-top: 0px;background: url("/image/admin/on_1.png") left top / 100% 100% no-repeat;' @endif>
                                        <label>
                                            <input type="checkbox" name="consignee_cid" aid="" @if($consignee_cid ==1) checked @endif />
                                            <img src="http://{{$image_domain}}/image/admin/circle.png" class="draggable"@if($consignee_cid ==1) style="right:0px" @endif  />
                                        </label>
                                    </div>
                                    <span class="con4-hide"></span>
                                ...
                                <li>
                                    ...
                                    <div class="fl pay_fl" img_id="{{ $custom == 1 ? 1 : 0 }}" @if($custom == 1) style='margin-top: 0px;background: url("/image/admin/on_1.png") left top / 100% 100% no-repeat;' @endif>
                                        <label>
                                            <input type="checkbox" name="custom" aid="" @if($custom ==1) checked @endif />
                                            <img src="http://{{$image_domain}}/image/admin/circle.png" class="draggable"@if($custom ==1) style="right:0px" @endif  />
                                        </label>
                                    </div>
                                    <span class="con4-hide"></span>
