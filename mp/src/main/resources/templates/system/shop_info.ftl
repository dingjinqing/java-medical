        ...
        <div class="panel-body">
            <table class="tab_body show table">
                ...
                <tr>
                    ...
                    <td>
                        <input type="checkbox" name="is_enabled"  value="1" <#if (shop.is_enabled!0 == 1)> checked </#if> style="vertical-align: middle;margin-top: -1px">禁用
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <select name="shop_flag">
                            ...
                            <option value="1" <#if (shop.shop_flag!0==1)> selected </#if>>欧派</option>
                            <option value="2" <#if (shop.shop_flag!0==2)> selected </#if>>寺库</option>
                        </select>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <input type="checkbox" name="hid_bottom"  <#if (shop.hid_bottom!0 == 1)> checked </#if> style="vertical-align: middle;margin-top: -1px">隐藏
                    </td>
                </tr>
                <tr>
                    <td>
