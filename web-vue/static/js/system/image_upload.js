(function ($) {
    ...
    function set_cat_id() {
        ...
        g_dlg = art.dialog({
            title: window.jslang.image_common.set_cat_name,
            content: cat_el[0],
            okVal: window.jslang.image_common.set_cat_name,
            ok: function () {
                $("#act").val('set_cat_id');
    ...
    $("#operate").click(function () {
        ...
        if (op == '0') {
            art.dialog.tips(window.jslang.image_common.err_select_operation);
            return;
        }
        ...
        if (show_type == 'list' && $("input[cbx_list]:checked").length == 0
            ...
            art.dialog.tips(window.jslang.image_common.err_select_image);
            return;
        }
        if (op == '3') {
            set_cat_id();
        ...
        var title = (op == '1') ? window.jslang.image_common.copy_img_url : window.jslang.image_common.copy_img_url_code;
        g_dlg = art.dialog({
            padding: 0,
            title: title,
            content: el[0],
