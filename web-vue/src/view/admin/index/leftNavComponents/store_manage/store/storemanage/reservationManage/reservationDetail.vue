            ...
            <el-col :span="8">
              <div class="boder_style">
                ...
                >
                  <el-col
                    :span="10"
                    style="font: 16px solid;"
                  >{{$t('reservationManage.orderInfo')}}</el-col>
                </el-row>
                <el-row
                  :gutter="20"
                  class="row_style"
                >
                  <el-col
                    :span="12"
                    class="col_style"
                  > {{$t('reservationManage.orderStatus')}}： {{this.detailData.orderStatusName}}</el-col>
                  <el-col
                    :span="8"
                    class="col_style"
                  >{{$t('reservationManage.orderAmount')}}： {{this.detailData.orderAmount}}</el-col>
                </el-row>
                <el-row
                  :gutter="20"
                  class="row_style"
                >
                  <el-col
                    :span="12"
                    class="col_style"
                  > {{$t('reservationManage.serviceDate')}}： {{this.detailData.serviceDate}} {{this.detailData.servicePeriod}}</el-col>
                  <el-col
                    :span="8"
                    class="col_style"
                  >{{$t('reservationManage.store')}}： {{this.detailData.storeName}}</el-col>
                </el-row>
                <el-row
                  :gutter="20"
                  class="row_style"
                >
                  <el-col
                    :span="12"
                    class="col_style"
                  > {{$t('reservationManage.orderSn')}}： {{this.detailData.orderSn}}</el-col>
                  <el-col
                    :span="8"
                    class="col_style"
                  >{{this.technicianConfigName}}： {{this.detailData.technicianName}}</el-col>
                </el-row>
              </div>
            </el-col>
            <el-col
              ...
              <div class="boder_style">
                ...
                >
                  <el-col
                    :span="10"
                    class="col_style"
                  > {{$t('reservationManage.subscriber')}}： {{this.detailData.subscriber}}</el-col>
                  <el-col
                    :span="10"
                    class="col_style"
                  > {{$t('reservationManage.mobile')}}： {{this.detailData.mobile}}</el-col>
                </el-row>
                <el-row
                  :gutter="20"
                  class="row_style"
                >
                  <el-col
                    :span="10"
                    class="col_style"
                  > {{$t('reservationManage.message')}}： {{this.detailData.addMessage}}</el-col>
                </el-row>
              </div>
            </el-col>
          </el-row>
          <div style="margin-top: 20px">
            <el-row :gutter="6">
              <el-col :span="2"><img
                  ...
                  alt=""
                > {{$t('reservationManage.adminMessage')}}：</el-col>
              <el-col
                :span="4"
                class="col_style"
              >{{this.detailData.adminMessage}}</el-col>
            </el-row>
          </div>
        </div>
      </div>
...
export default {
  ...
  created () {
    ...
    this.technicianConfigName = this.$route.params.technicianConfigName
    this.langDefault()
    this.getDetail()
  },
  methods: {
