    ...
    <div class="content">
      <div class="open-screen-add-page">
        <div class="page-left">
          <div
            class="left-title"
            :style="'background:url('+ $imgaeHost +'/image/admin/shop_beautify/phone_tops.png) no-repeat;'"
          ></div>
          <div class="left-content">
            <el-image :src="images.show_score"></el-image>
            <el-image :src="images.show_coupon"></el-image>
            <el-image :src="images.show_lottery"></el-image>
            <el-image :src="images.show_yue"></el-image>
            <el-image :src="images.show_custom"></el-image>
          </div>
        </div>
            ...
            <el-form>
              ...
              >
                <el-radio-group>
                  ...
                  <el-raido>余额</el-raido>
                  <el-raido>分裂优惠券</el-raido>
