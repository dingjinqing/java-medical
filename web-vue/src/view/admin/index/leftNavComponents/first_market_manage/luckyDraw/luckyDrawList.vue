            ...
            <el-tabs
                ...
                <el-tab-pane
                    ...
                    <el-button
                            type="primary"
                            @click="addActivity"
                            class="barginBtn">{{$t('luckyDraw.addActivity')}}
                    </el-button>
                </el-tab-pane>
            </el-tabs>
        </div>
                        ...
                        <div class="opt">
                            <el-tooltip
                                ...
                                <span
                                        ...
                                        @click="editActivity(scope.row.id)"></span>
                            </el-tooltip>
                            <el-tooltip
                            ...
                            <el-tooltip :content="$t('luckyDraw.enabled')"
                                        placement="top">
                                <span
                                        class="el-icon-circle-check"
                                        @click="changeStatus(scope.row.id)"
                                        v-if="scope.row.status==0"></span>
                            </el-tooltip>
                            <el-tooltip
                                ...
                                <span
                                        ...
                                        @click="deleteluckyDraw(scope.row.id)"></span>
                            </el-tooltip>
                            <el-tooltip
                                ...
                                <span
                                        ...
                                        @click="luckyDrawDetailList(scope.row.id)"></span>
                            </el-tooltip>
                        </div>
                    </template>
                </el-table-column>
