<template>
  <div>
    ...
    <el-form ref="otherInfoForm" :model="goodsProductInfo" label-width="120px">
      ...
      <el-form-item label="上下架：" prop="isOnSale">
        <el-radio-group v-model="goodsProductInfo.saleType">
          <el-radio :label="0">立即上架售卖</el-radio><br/>
          <el-radio :label="1">自定义上架时间</el-radio>
          <el-date-picker ref="saleTimeInput" v-model="goodsProductInfo.saleTime" :disabled="goodsProductInfo.saleType!==1" type="datetime" @change="saleTimeChange"
                          size="small" placeholder="选择上架售卖时间" style="margin-left: 10px;"/><br/>
