      ...
      item.goodsActivities.forEach((itemC, indeC) => {
        ...
        switch (itemC.activityType) {
          ...
          case 18:
            ...
            break
          case 20:
            this.goodsData[index]['noShowActFlag'] = 20
            break
          case 21:
