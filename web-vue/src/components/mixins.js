  ...
  methods: {
    ...
    handleToJudgeTwoDiction (name, second) {
      return new Promise((resolve, reject) => {
        // 请求功能或者菜单对应的版本名字池
        let vsNameArr = ['basic_yesterday', 'portrait_user', 'second_view', 'visit_source', 'analysis_visit_source', 'sort', 'tag', 'pin_group', 'distribution', 'pay_reward', 'activity_reward', 'lottery', 'group_draw', 'pin_integration', 'promote', 'full_cut', 'bargain', 'seckill_goods', 'coupon_grant', 'gift', 'first_special', 'message_template', 'market_act_give', 'charge_card', 'count_card', 'grade_card']
        // 二级菜单需要校验的元素池
        let enNameArr = ['analysis_basic', 'analysis_portrait', 'analysis_visit', 'analysis_visit_source', 'trades_summary', 'sort', 'user_tag', 'pin_group', 'distribution_info', 'payreward', 'market_gifted', 'lottery_activity', 'group_draw', 'pin_integration', 'promote', 'full_cut', 'kanjia', 'sec_kill', 'market_act_give', 'gift', 'first_special', 'business_template_message', 'market_act_give', 'user_card', 'user_card', 'user_card']
