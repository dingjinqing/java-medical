  ...
  methods: {
    ...
    handleToJudgeTwoDiction (name, second) {
      return new Promise((resolve, reject) => {
        // 请求功能或者菜单对应的版本名字池
        let vsNameArr = ['basic_yesterday', 'portrait_user', 'second_view', 'visit_source', 'analysis_visit_source', 'sort', 'tag', 'pin_group', 'distribution', 'pay_reward', 'activity_reward', 'lottery', 'group_draw', 'pin_integration', 'promote', 'full_cut', 'bargain', 'seckill_goods', 'coupon_grant', 'gift', 'first_special', 'message_template', 'market_act_give', 'reduce_price', 'free_ship']
        // 二级菜单需要校验的元素池
