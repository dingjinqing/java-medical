            ...
            <td class="isLeft">
              ...
              <div class="speDiv">
                ...
                <span
                  v-if="item.goodsType"
                  class="actLabel"
                >{{item.goodsType===1?$t('commodity.assemble'):item.goodsType===3?$t('commodity.bargain'):item.goodsType===5?$t('commodity.seckill'):item.goodsType===6?$t('commodity.limitedPriceReduction'):item.goodsType===10?$t('commodity.advanceSale'):''}}</span>
                <span
                  class="actLabel"
                  v-if="item.isCardExclusive"
                >会员专享</span>
