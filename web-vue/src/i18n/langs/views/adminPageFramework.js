export const cn = {
  ...
  leftNavArr: {
    ...
    nav5: ['', '砍价', '多人拼团', '分销', '拼团抽奖', '瓜分积分', '好友助力', '幸运大抽奖', '活动有礼', '支付有礼'],
...
export const en = {
  ...
  leftNavArr: {
    ...
    nav2: ['Page decoration', 'Page classification', 'Picture space', 'shop style', 'Bottom navigation', 'Personal Center', 'search for configuration', 'Small program jump'],
    nav3: ['All commodities', 'Adding goods', 'Freight template', 'Business Classification Management', 'Brand Management', 'Evaluation management', 'Merchandise Recommendation', 'Commodity label', 'Commodity import'],
