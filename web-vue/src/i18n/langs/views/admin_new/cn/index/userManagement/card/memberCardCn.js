export const cn = {
  ...
  gradeCard: '等级会员卡',
  generateCode: '领取码',
  autoGenerateCode: '自动生成领取码',
  autoGenerateMsg: '将随机生成xxx个唯一领取码，领取码由数字+字母组成',
  codePre: '领取码前缀',
  codeLimitMsg: '0-4个数字或字母',
  codeLimit: '领取码位数',
  codeNoKnowLimit: '领取码组成未知数，限制6-12位',
  codeNum: '领取数量',
  importPickCode: '导入领取码',
  needImportCode: '需导入已有领取码',
  first: '第一步',
  downLoadTemp: '下载导入模板',
  second: '第二步',
  uploadFiles: '上传文件',
  ...
  cardPrd: '卡号前缀',
  cardPrdMsg: '0-4个数字或字母',
  cardNoLimit: '卡号位数',
  cardNoLimitMsg: '卡号组成位数，限制6-12位',
  pwdNoLimit: '密码位数',
  pwdNoSum: '密码组成位数',
  receiveAmount: '领取数量',
  importCodeNoPwd: '导入卡号+密码',
  needImportCodeNoPwd: '需导入已有卡号+密码',
  errorMsg1: '请入正确的位数',
  errorMsg2: '请输入领取数量',
  errorMsg3: '请选择相应功能',
  errorMsg4: '上传文件只支持xls、xlsx格式！',
  errorMsg5: '上传成功',
  title: '导入记录',
  batchId: '批次',
  total: '合计',
