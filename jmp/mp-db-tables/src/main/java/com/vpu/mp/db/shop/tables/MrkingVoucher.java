...
public class MrkingVoucher extends TableImpl<MrkingVoucherRecord> {
    ...
    private static final long serialVersionUID = -1094174421;
    ...
    /**
     * The column <code>mini_shop_471752.b2c_mrking_voucher.expiration_date</code>. validity_type为1时的过期时间
     */
    public final TableField<MrkingVoucherRecord, Timestamp> EXPIRATION_DATE = createField("expiration_date", org.jooq.impl.SQLDataType.TIMESTAMP.defaultValue(org.jooq.impl.DSL.inline("0000-00-00 00:00:00", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "validity_type为1时的过期时间");
