...
public class MedicalHistory extends TableImpl<MedicalHistoryRecord> {
    ...
    private static final long serialVersionUID = -792368200;
    ...
    /**
     * The column <code>jmini_shop_224462.b2c_medical_history.id</code>. id
     */
    public final TableField<MedicalHistoryRecord, Integer> ID = createField("id", org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "id");

    /**
     * The column <code>jmini_shop_224462.b2c_medical_history.case_history_code</code>. 确定一个病历的编号
     */
    public final TableField<MedicalHistoryRecord, String> CASE_HISTORY_CODE = createField("case_history_code", org.jooq.impl.SQLDataType.VARCHAR(128).nullable(false), this, "确定一个病历的编号");

    /**
     * The column <code>jmini_shop_224462.b2c_medical_history.pos_code</code>. 确定一个医嘱的编号
     */
    public final TableField<MedicalHistoryRecord, String> POS_CODE = createField("pos_code", org.jooq.impl.SQLDataType.VARCHAR(128).nullable(false), this, "确定一个医嘱的编号");
     ...
     */
    public final TableField<MedicalHistoryRecord, String> PATIENT_NAME = createField("patient_name", org.jooq.impl.SQLDataType.VARCHAR(32), this, "患者名");

    /**
     * The column <code>jmini_shop_224462.b2c_medical_history.sex</code>. 性别
     */
    public final TableField<MedicalHistoryRecord, Byte> SEX = createField("sex", org.jooq.impl.SQLDataType.TINYINT, this, "性别");

    /**
     * The column <code>jmini_shop_224462.b2c_medical_history.age</code>. 年龄
     */
    public final TableField<MedicalHistoryRecord, Integer> AGE = createField("age", org.jooq.impl.SQLDataType.INTEGER, this, "年龄");
     ...
     */
    public final TableField<MedicalHistoryRecord, String> DEPARTMENT_NAME = createField("department_name", org.jooq.impl.SQLDataType.VARCHAR(32), this, "就诊科室(门诊)名称");

    /**
     * The column <code>jmini_shop_224462.b2c_medical_history.out_patient_number</code>. 门诊号
     */
    public final TableField<MedicalHistoryRecord, String> OUT_PATIENT_NUMBER = createField("out_patient_number", org.jooq.impl.SQLDataType.VARCHAR(32), this, "门诊号");

    /**
     * The column <code>jmini_shop_224462.b2c_medical_history.allergy_history</code>. 过敏史
     */
    public final TableField<MedicalHistoryRecord, String> ALLERGY_HISTORY = createField("allergy_history", org.jooq.impl.SQLDataType.VARCHAR(512), this, "过敏史");

    /**
     * The column <code>jmini_shop_224462.b2c_medical_history.patient_complain</code>. 病人主诉
     */
    public final TableField<MedicalHistoryRecord, String> PATIENT_COMPLAIN = createField("patient_complain", org.jooq.impl.SQLDataType.VARCHAR(512), this, "病人主诉");
    ...
    /**
     * The column <code>jmini_shop_224462.b2c_medical_history.diagnosis_suggession</code>. 诊疗处理意见
     */
    public final TableField<MedicalHistoryRecord, String> DIAGNOSIS_SUGGESSION = createField("diagnosis_suggession", org.jooq.impl.SQLDataType.CLOB, this, "诊疗处理意见");

    /**
     * The column <code>jmini_shop_224462.b2c_medical_history.doctor_code</code>. 医师编码
     */
    public final TableField<MedicalHistoryRecord, String> DOCTOR_CODE = createField("doctor_code", org.jooq.impl.SQLDataType.VARCHAR(128).nullable(false), this, "医师编码");

    /**
     * The column <code>jmini_shop_224462.b2c_medical_history.doctor_name</code>. 医师姓名
     */
    public final TableField<MedicalHistoryRecord, String> DOCTOR_NAME = createField("doctor_name", org.jooq.impl.SQLDataType.VARCHAR(32), this, "医师姓名");

    /**
     * The column <code>jmini_shop_224462.b2c_medical_history.is_delete</code>. 删除标记
     */
    public final TableField<MedicalHistoryRecord, Byte> IS_DELETE = createField("is_delete", org.jooq.impl.SQLDataType.TINYINT, this, "删除标记");

    /**
     * The column <code>jmini_shop_224462.b2c_medical_history.create_time</code>. 创建时间
     */
    public final TableField<MedicalHistoryRecord, Timestamp> CREATE_TIME = createField("create_time", org.jooq.impl.SQLDataType.TIMESTAMP, this, "创建时间");

    /**
     * The column <code>jmini_shop_224462.b2c_medical_history.update_time</code>. 更新时间
     */
    public final TableField<MedicalHistoryRecord, Timestamp> UPDATE_TIME = createField("update_time", org.jooq.impl.SQLDataType.TIMESTAMP, this, "更新时间");
