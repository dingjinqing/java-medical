...
public class MpUserPortrait extends TableImpl<MpUserPortraitRecord> {
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.MP_USER_PORTRAIT_PRIMARY, Indexes.MP_USER_PORTRAIT_REF_DATE, Indexes.MP_USER_PORTRAIT_TYPE);
    }
     ...
     */
    @Override
    public Identity<MpUserPortraitRecord, Integer> getIdentity() {
        return Keys.IDENTITY_MP_USER_PORTRAIT;
    }
     ...
     */
    @Override
    public UniqueKey<MpUserPortraitRecord> getPrimaryKey() {
        return Keys.KEY_B2C_MP_USER_PORTRAIT_PRIMARY;
    }
     ...
     */
    @Override
    public List<UniqueKey<MpUserPortraitRecord>> getKeys() {
        return Arrays.<UniqueKey<MpUserPortraitRecord>>asList(Keys.KEY_B2C_MP_USER_PORTRAIT_PRIMARY);
    }
