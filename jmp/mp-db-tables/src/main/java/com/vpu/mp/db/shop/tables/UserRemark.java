...
public class UserRemark extends TableImpl<UserRemarkRecord> {

    private static final long serialVersionUID = 675103979;
     ...
     */
    public final TableField<UserRemarkRecord, UInteger> ID = createField("id", org.jooq.impl.SQLDataType.INTEGERUNSIGNED.nullable(false).identity(true), this, "");

    /**
     * The column <code>jmini_shop_471752.b2c_user_remark.user_id</code>.
     */
    public final TableField<UserRemarkRecord, UInteger> USER_ID = createField("user_id", org.jooq.impl.SQLDataType.INTEGERUNSIGNED.nullable(false).defaultValue(DSL.inline("0", org.jooq.impl.SQLDataType.INTEGERUNSIGNED)), this, "");
     ...
     */
    public final TableField<UserRemarkRecord, UByte> IS_DELETE = createField("is_delete", org.jooq.impl.SQLDataType.TINYINTUNSIGNED.nullable(false).defaultValue(DSL.inline("0", org.jooq.impl.SQLDataType.TINYINTUNSIGNED)), this, "0:未删除；1删除");
     ...
     */
    @Override
    public Identity<UserRemarkRecord, UInteger> getIdentity() {
