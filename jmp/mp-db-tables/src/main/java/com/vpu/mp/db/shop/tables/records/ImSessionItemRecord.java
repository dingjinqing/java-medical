...
public class ImSessionItemRecord extends UpdatableRecordImpl<ImSessionItemRecord> implements Record7<Integer, Integer, Integer, Integer, String, Timestamp, Timestamp> {

    private static final long serialVersionUID = -522918176;
     ...
     */
    @Override
    public ImSessionItemRecord values(Integer value1, Integer value2, Integer value3, Integer value4, String value5, Timestamp value6, Timestamp value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public ImSessionItemRecord(Integer id, Integer imSessionId, Integer formId, Integer toId, String message, Timestamp sendTime, Timestamp createTime) {
        super(ImSessionItem.IM_SESSION_ITEM);
