...
public class OrderGoods extends TableImpl<OrderGoodsRecord> {
    ...
    /**
     * The column <code>mini_shop_6797286.b2c_order_goods.return_number</code>.
     */
    public final TableField<OrderGoodsRecord, Integer> RETURN_NUMBER = createField("return_number", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.INTEGER)), this, "");
