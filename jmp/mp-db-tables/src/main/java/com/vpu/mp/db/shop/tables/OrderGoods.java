...
public class OrderGoods extends TableImpl<OrderGoodsRecord> {
    ...
    private static final long serialVersionUID = -698867721;
     ...
     */
    public final TableField<OrderGoodsRecord, Integer> MAIN_REC_ID = createField("main_rec_id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.INTEGER)), this, "主订单rec_id");
     ...
     */
    public final TableField<OrderGoodsRecord, Integer> GOODS_NUMBER = createField("goods_number", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.inline("1", org.jooq.impl.SQLDataType.INTEGER)), this, "");
     ...
     */
    public final TableField<OrderGoodsRecord, Integer> SEND_NUMBER = createField("send_number", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.INTEGER)), this, "");

    /**
     * The column <code>mini_shop_471752.b2c_order_goods.return_number</code>. 退货/退款成功数量
     */
    public final TableField<OrderGoodsRecord, Integer> RETURN_NUMBER = createField("return_number", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.INTEGER)), this, "退货/退款成功数量");
     ...
     */
    public final TableField<OrderGoodsRecord, String> FANLI_STRATEGY = createField("fanli_strategy", org.jooq.impl.SQLDataType.VARCHAR(2999).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.VARCHAR)), this, "返利配置详情");
     ...
     */
    public final TableField<OrderGoodsRecord, Integer> ACTIVITY_RULE = createField("activity_rule", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.INTEGER)), this, "营销活动id");

    /**
     * The column <code>mini_shop_471752.b2c_order_goods.create_time</code>. 创建时间
     */
    public final TableField<OrderGoodsRecord, Timestamp> CREATE_TIME = createField("create_time", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "创建时间");
     ...
     */
    public final TableField<OrderGoodsRecord, String> PRESCRIPTION_OLD_CODE = createField("prescription_old_code", org.jooq.impl.SQLDataType.VARCHAR(64).nullable(false).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.VARCHAR)), this, "老处方项目明细号码（可根据此字段反查批次号）");

    /**
     * The column <code>mini_shop_471752.b2c_order_goods.prescription_code</code>. 处方项目明细号码（可根据此字段反查批次号）
     */
    public final TableField<OrderGoodsRecord, String> PRESCRIPTION_CODE = createField("prescription_code", org.jooq.impl.SQLDataType.VARCHAR(64).nullable(false).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.VARCHAR)), this, "处方项目明细号码（可根据此字段反查批次号）");

    /**
     * The column <code>mini_shop_471752.b2c_order_goods.prescription_detail_code</code>. 处方明细号
     */
    public final TableField<OrderGoodsRecord, String> PRESCRIPTION_DETAIL_CODE = createField("prescription_detail_code", org.jooq.impl.SQLDataType.VARCHAR(64).nullable(false).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.VARCHAR)), this, "处方明细号");

    /**
     * The column <code>mini_shop_471752.b2c_order_goods.medical_audit_type</code>. 药品审核类型, 0不审核,1审核,2开方,3根据处方下单
     */
    public final TableField<OrderGoodsRecord, Byte> MEDICAL_AUDIT_TYPE = createField("medical_audit_type", org.jooq.impl.SQLDataType.TINYINT.nullable(false).defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.TINYINT)), this, "药品审核类型, 0不审核,1审核,2开方,3根据处方下单");

    /**
     * The column <code>mini_shop_471752.b2c_order_goods.medical_audit_status</code>. 药品审核状态 0未审核 1审核通过 2审核不通过
     */
    public final TableField<OrderGoodsRecord, Byte> MEDICAL_AUDIT_STATUS = createField("medical_audit_status", org.jooq.impl.SQLDataType.TINYINT.nullable(false).defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.TINYINT)), this, "药品审核状态 0未审核 1审核通过 2审核不通过");

    /**
     * The column <code>mini_shop_471752.b2c_order_goods.audit_time</code>. 药品审核时间
     */
    public final TableField<OrderGoodsRecord, Timestamp> AUDIT_TIME = createField("audit_time", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.inline("0000-00-00 00:00:00", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "药品审核时间");
