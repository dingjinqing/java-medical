...
public class CardOrderRecord extends UpdatableRecordImpl<CardOrderRecord> {
    ...
    private static final long serialVersionUID = 2042168800;
    ...
    /**
     * Setter for <code>mini_shop_471752.b2c_card_order.card_no</code>. 会员卡号
     */
    ...
    /**
     * Getter for <code>mini_shop_471752.b2c_card_order.card_no</code>. 会员卡号
     */
    ...
    /**
     * Setter for <code>mini_shop_471752.b2c_card_order.virtual_goods_id</code>. 虚拟商品id
     */
    ...
    /**
     * Getter for <code>mini_shop_471752.b2c_card_order.virtual_goods_id</code>. 虚拟商品id
     */
    ...
    /**
     * Setter for <code>mini_shop_471752.b2c_card_order.still_send_flag</code>. 退款后是否继续发放优惠劵，1：继续发放，0：停止发放
     */
    ...
    /**
     * Getter for <code>mini_shop_471752.b2c_card_order.still_send_flag</code>. 退款后是否继续发放优惠劵，1：继续发放，0：停止发放
     */
     ...
     */
    public CardOrderRecord(Integer orderId, String orderSn, Integer userId, Byte orderStatus, String orderStatusName, Integer invoiceId, String invoiceDetail, String addMessage, String payCode, String payName, String prepayId, String paySn, String cardNo, BigDecimal moneyPaid, BigDecimal useAccount, BigDecimal useScore, BigDecimal memberCardBalance, BigDecimal orderAmount, Timestamp payTime, String sellerRemark, Byte starFlag, Byte delFlag, String aliTradeNo, Byte returnFlag, BigDecimal returnScore, BigDecimal returnAccount, BigDecimal returnMoney, BigDecimal returnCardBalance, Timestamp returnTime, Timestamp delTime, Timestamp createTime, Timestamp updateTime, Byte goodsType, Integer virtualGoodsId, Byte stillSendFlag) {
        super(CardOrder.CARD_ORDER);
        ...
        set(26, returnMoney);
        set(27, returnCardBalance);
        set(28, returnTime);
        set(29, delTime);
        set(30, createTime);
        set(31, updateTime);
        set(32, goodsType);
        set(33, virtualGoodsId);
