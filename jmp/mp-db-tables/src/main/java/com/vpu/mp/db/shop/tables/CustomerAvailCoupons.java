...
public class CustomerAvailCoupons extends TableImpl<CustomerAvailCouponsRecord> {
    ...
    private static final long serialVersionUID = -1725710104;
     ...
     */
    public final TableField<CustomerAvailCouponsRecord, Byte> TYPE = createField("type", org.jooq.impl.SQLDataType.TINYINT.nullable(false).defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.TINYINT)), this, "0为减价，1为打折");
     ...
     */
    public final TableField<CustomerAvailCouponsRecord, BigDecimal> LIMIT_ORDER_AMOUNT = createField("limit_order_amount", org.jooq.impl.SQLDataType.DECIMAL(10, 2).nullable(false).defaultValue(org.jooq.impl.DSL.inline("0.00", org.jooq.impl.SQLDataType.DECIMAL)), this, "满多少可用");
     ...
     */
    public final TableField<CustomerAvailCouponsRecord, Byte> ACCESS_MODE = createField("access_mode", org.jooq.impl.SQLDataType.TINYINT.nullable(false).defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.TINYINT)), this, "获取方式，0：发放，1：领取，2：优惠券礼包自动发放");
     ...
     */
    public final TableField<CustomerAvailCouponsRecord, Timestamp> CREATE_TIME = createField("create_time", org.jooq.impl.SQLDataType.TIMESTAMP.defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "");

    /**
     * The column <code>mini_shop_471752.b2c_customer_avail_coupons.update_time</code>. 最后修改时间
     */
    public final TableField<CustomerAvailCouponsRecord, Timestamp> UPDATE_TIME = createField("update_time", org.jooq.impl.SQLDataType.TIMESTAMP.defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "最后修改时间");

    /**
     * The column <code>mini_shop_471752.b2c_customer_avail_coupons.access_order_sn</code>. 发放活动的订单的订单编号
     */
    public final TableField<CustomerAvailCouponsRecord, String> ACCESS_ORDER_SN = createField("access_order_sn", org.jooq.impl.SQLDataType.VARCHAR(20).nullable(false).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.VARCHAR)), this, "发放活动的订单的订单编号");
