...
public class UserPatientCoupleRecord extends UpdatableRecordImpl<UserPatientCoupleRecord> implements Record6<Integer, Integer, Integer, Byte, Timestamp, Timestamp> {

    private static final long serialVersionUID = -1811481595;
     ...
     */
    @Override
    public UserPatientCoupleRecord value5(Timestamp value) {
        setCreateTime(value);
        return this;
    }
     ...
     */
    @Override
    public UserPatientCoupleRecord values(Integer value1, Integer value2, Integer value3, Byte value4, Timestamp value5, Timestamp value6) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public UserPatientCoupleRecord(Integer id, Integer userId, Integer patientId, Byte isDelete, Timestamp createTime, Timestamp updateTime) {
        super(UserPatientCouple.USER_PATIENT_COUPLE);
