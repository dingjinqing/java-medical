...
public class UploadedVideoRecord extends UpdatableRecordImpl<UploadedVideoRecord> implements Record21<Integer, String, Integer, String, String, String, String, String, Integer, Integer, Integer, String, Byte, Integer, Byte, Integer, Integer, Timestamp, Byte, Timestamp, Timestamp> {

    private static final long serialVersionUID = -607533697;
     ...
     */
    @Override
    public Row21<Integer, String, Integer, String, String, String, String, String, Integer, Integer, Integer, String, Byte, Integer, Byte, Integer, Integer, Timestamp, Byte, Timestamp, Timestamp> fieldsRow() {
     ...
     */
    @Override
    public Row21<Integer, String, Integer, String, String, String, String, String, Integer, Integer, Integer, String, Byte, Integer, Byte, Integer, Integer, Timestamp, Byte, Timestamp, Timestamp> valuesRow() {
     ...
     */
    public UploadedVideoRecord(Integer videoId, String videoType, Integer videoSize, String videoName, String videoOrigFname, String videoPath, String videoSnapPath, String videoUrl, Integer videoCatId, Integer videoWidth, Integer videoHeight, String videoMeta, Byte isRefer, Integer shopId, Byte delFlag, Integer duration, Integer userId, Timestamp delTime, Byte upyunDel, Timestamp createTime, Timestamp updateTime) {
        super(UploadedVideo.UPLOADED_VIDEO);
