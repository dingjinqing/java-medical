...
public class LotteryPrizeRecord extends UpdatableRecordImpl<LotteryPrizeRecord> implements Record18<Integer, Integer, Integer, Integer, Byte, String, String, String, Byte, Integer, Integer, Integer, Byte, Byte, Byte, Byte, Timestamp, Timestamp> {

    private static final long serialVersionUID = -1564599437;
    ...
    /**
     * Setter for <code>mini_shop_4748160.b2c_lottery_prize.create_time</code>.
     */
    ...
    /**
     * Getter for <code>mini_shop_4748160.b2c_lottery_prize.create_time</code>.
     */
    ...
    /**
     * Setter for <code>mini_shop_4748160.b2c_lottery_prize.update_time</code>. 最后修改时间
     */
    ...
    /**
     * Getter for <code>mini_shop_4748160.b2c_lottery_prize.update_time</code>. 最后修改时间
     */
     ...
     */
    @Override
    public Row18<Integer, Integer, Integer, Integer, Byte, String, String, String, Byte, Integer, Integer, Integer, Byte, Byte, Byte, Byte, Timestamp, Timestamp> fieldsRow() {
     ...
     */
    @Override
    public Row18<Integer, Integer, Integer, Integer, Byte, String, String, String, Byte, Integer, Integer, Integer, Byte, Byte, Byte, Byte, Timestamp, Timestamp> valuesRow() {
     ...
     */
    @Override
    public LotteryPrizeRecord value13(Byte value) {
        setCouponId(value);
        return this;
    }
     ...
     */
    @Override
    public LotteryPrizeRecord value14(Byte value) {
        setPrdId(value);
        return this;
    }
     ...
     */
    @Override
    public LotteryPrizeRecord value15(Byte value) {
     ...
     */
    @Override
    public LotteryPrizeRecord values(Integer value1, Integer value2, Integer value3, Integer value4, Byte value5, String value6, String value7, String value8, Byte value9, Integer value10, Integer value11, Integer value12, Byte value13, Byte value14, Byte value15, Byte value16, Timestamp value17, Timestamp value18) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public LotteryPrizeRecord(Integer id, Integer lotteryId, Integer chanceNumerator, Integer chanceDenominator, Byte lotteryGrade, String lotteryDetail, String iconImgsImage, String iconImgs, Byte lotteryType, Integer lotteryNumber, Integer awardTimes, Integer integralScore, Byte couponId, Byte prdId, Byte prdKeepDays, Byte delFlag, Timestamp createTime, Timestamp updateTime) {
        super(LotteryPrize.LOTTERY_PRIZE);
