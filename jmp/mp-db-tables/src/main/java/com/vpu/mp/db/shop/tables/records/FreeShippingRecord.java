...
public class FreeShippingRecord extends UpdatableRecordImpl<FreeShippingRecord> implements Record15<Integer, String, Byte, Timestamp, Timestamp, Integer, String, String, String, Byte, Timestamp, Timestamp, Byte, Timestamp, Byte> {

    private static final long serialVersionUID = -1691993051;
    ...
    /**
     * Setter for <code>mini_shop_4748160.b2c_free_shipping.type</code>. 条件 0全部 1部分
     */
    ...
    /**
     * Getter for <code>mini_shop_4748160.b2c_free_shipping.type</code>. 条件 0全部 1部分
     */
     ...
     */
    @Override
    public Row15<Integer, String, Byte, Timestamp, Timestamp, Integer, String, String, String, Byte, Timestamp, Timestamp, Byte, Timestamp, Byte> fieldsRow() {
     ...
     */
    @Override
    public Row15<Integer, String, Byte, Timestamp, Timestamp, Integer, String, String, String, Byte, Timestamp, Timestamp, Byte, Timestamp, Byte> valuesRow() {
     ...
     */
    @Override
    public FreeShippingRecord values(Integer value1, String value2, Byte value3, Timestamp value4, Timestamp value5, Integer value6, String value7, String value8, String value9, Byte value10, Timestamp value11, Timestamp value12, Byte value13, Timestamp value14, Byte value15) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public FreeShippingRecord(Integer id, String name, Byte expireType, Timestamp startTime, Timestamp endTime, Integer type, String recommendGoodsId, String recommendCatId, String recommendSortId, Byte status, Timestamp createTime, Timestamp updateTime, Byte delFlag, Timestamp delTime, Byte level) {
        super(FreeShipping.FREE_SHIPPING);
