...
public class PurchasePriceDefineRecord extends UpdatableRecordImpl<PurchasePriceDefineRecord> implements Record13<Integer, String, Short, Short, String, Timestamp, Timestamp, Byte, Byte, Timestamp, Timestamp, Timestamp, Byte> {

    private static final long serialVersionUID = 370366030;
    ...
    /**
     * Setter for <code>mini_shop_471752.b2c_purchase_price_define.status</code>. 状态 0: 启用 1:禁用
     */
    ...
    /**
     * Getter for <code>mini_shop_471752.b2c_purchase_price_define.status</code>. 状态 0: 启用 1:禁用
     */
     ...
     */
    @Override
    public Row13<Integer, String, Short, Short, String, Timestamp, Timestamp, Byte, Byte, Timestamp, Timestamp, Timestamp, Byte> fieldsRow() {
     ...
     */
    @Override
    public Row13<Integer, String, Short, Short, String, Timestamp, Timestamp, Byte, Byte, Timestamp, Timestamp, Timestamp, Byte> valuesRow() {
     ...
     */
    @Override
    public PurchasePriceDefineRecord values(Integer value1, String value2, Short value3, Short value4, String value5, Timestamp value6, Timestamp value7, Byte value8, Byte value9, Timestamp value10, Timestamp value11, Timestamp value12, Byte value13) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public PurchasePriceDefineRecord(Integer id, String name, Short level, Short maxChangePurchase, String goodsId, Timestamp startTime, Timestamp endTime, Byte status, Byte delFlag, Timestamp delTime, Timestamp createTime, Timestamp updateTime, Byte redemptionFreight) {
        super(PurchasePriceDefine.PURCHASE_PRICE_DEFINE);
