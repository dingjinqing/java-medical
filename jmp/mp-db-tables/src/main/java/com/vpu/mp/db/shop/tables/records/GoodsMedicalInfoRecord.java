...
public class GoodsMedicalInfoRecord extends UpdatableRecordImpl<GoodsMedicalInfoRecord> {
    ...
    private static final long serialVersionUID = -1503733062;
    ...
    /**
     * Setter for <code>mini_shop_471752.b2c_goods_medical_info.is_rx</code>. 是否处方药,rx处方药 otc非处方药 1是rx 0是otc
     */
    ...
    /**
     * Getter for <code>mini_shop_471752.b2c_goods_medical_info.is_rx</code>. 是否处方药,rx处方药 otc非处方药 1是rx 0是otc
     */
    public Byte getIsRx() {
        return (Byte) get(5);
    }
    ...
    public GoodsMedicalInfoRecord(Integer id, Integer goodsId, String goodsCommonName, String goodsAliasName, String goodsQualityRatio, Byte isRx, Byte insuranceFlag, String insuranceCode, String insuranceDatabaseName, String goodsBasicUnit, String goodsPackageUnit, Integer goodsUnitConvertFactor, Integer goodsEquivalentQuantity, String goodsEquivalentUnit, String goodsComposition, String goodsCharacters, String goodsFunction, String goodsUseMethod, String goodsAdverseReaction, String goodsTaboos, String goodsNoticeEvent, String goodsInteraction, String goodsStoreMethod, String goodsPackageMethod, String goodsValidTime, String goodsApprovalNumber, String goodsProductionEnterprise, Byte goodsLimitDuty, Byte goodsLimitAntibacterial, Byte isDelete, Timestamp createTime, Timestamp updateTime) {
        ...
        set(6, insuranceFlag);
        set(7, insuranceCode);
        set(8, insuranceDatabaseName);
        set(9, goodsBasicUnit);
        set(10, goodsPackageUnit);
        set(11, goodsUnitConvertFactor);
        set(12, goodsEquivalentQuantity);
        set(13, goodsEquivalentUnit);
        set(14, goodsComposition);
        set(15, goodsCharacters);
        set(16, goodsFunction);
        set(17, goodsUseMethod);
        set(18, goodsAdverseReaction);
        set(19, goodsTaboos);
        set(20, goodsNoticeEvent);
        set(21, goodsInteraction);
        set(22, goodsStoreMethod);
        set(23, goodsPackageMethod);
        set(24, goodsValidTime);
        set(25, goodsApprovalNumber);
        set(26, goodsProductionEnterprise);
        set(27, goodsLimitDuty);
        set(28, goodsLimitAntibacterial);
        set(29, isDelete);
        set(30, createTime);
        set(31, updateTime);
    }
