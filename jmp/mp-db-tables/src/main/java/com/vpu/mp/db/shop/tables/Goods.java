...
public class Goods extends TableImpl<GoodsRecord> {
     ...
     */
    public final TableField<GoodsRecord, Timestamp> CREATE_TIME = createField("create_time", org.jooq.impl.SQLDataType.TIMESTAMP.defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "");
     ...
     */
    public final TableField<GoodsRecord, Byte> PROMOTION_LANGUAGE_SWITCH = createField("promotion_language_switch", org.jooq.impl.SQLDataType.TINYINT.nullable(false).defaultValue(org.jooq.impl.DSL.inline("1", org.jooq.impl.SQLDataType.TINYINT)), this, "是否使用分销推广语0关闭，1使用");

    /**
     * The column <code>mini_shop_471752.b2c_goods.promotion_language</code>. 推广语
     */
    public final TableField<GoodsRecord, String> PROMOTION_LANGUAGE = createField("promotion_language", org.jooq.impl.SQLDataType.VARCHAR(400).nullable(false).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.VARCHAR)), this, "推广语");
