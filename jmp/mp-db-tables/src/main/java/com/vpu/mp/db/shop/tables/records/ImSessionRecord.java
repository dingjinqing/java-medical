...
public class ImSessionRecord extends UpdatableRecordImpl<ImSessionRecord> implements Record14<Integer, Integer, Integer, Integer, Integer, Byte, Integer, String, Timestamp, Byte, Byte, Byte, Timestamp, Timestamp> {

    private static final long serialVersionUID = -1565288910;
     ...
     */
    @Override
    public Row14<Integer, Integer, Integer, Integer, Integer, Byte, Integer, String, Timestamp, Byte, Byte, Byte, Timestamp, Timestamp> fieldsRow() {
     ...
     */
    @Override
    public Row14<Integer, Integer, Integer, Integer, Integer, Byte, Integer, String, Timestamp, Byte, Byte, Byte, Timestamp, Timestamp> valuesRow() {
     ...
     */
    @Override
    public ImSessionRecord value13(Timestamp value) {
        setCreateTime(value);
        return this;
    }
     ...
     */
    @Override
    public ImSessionRecord values(Integer value1, Integer value2, Integer value3, Integer value4, Integer value5, Byte value6, Integer value7, String value8, Timestamp value9, Byte value10, Byte value11, Byte value12, Timestamp value13, Timestamp value14) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public ImSessionRecord(Integer id, Integer doctorId, Integer departmentId, Integer userId, Integer patientId, Byte sessionStatus, Integer continueSessionCount, String orderSn, Timestamp limitTime, Byte weightFactor, Byte evaluateStatus, Byte isDelete, Timestamp createTime, Timestamp updateTime) {
        super(ImSession.IM_SESSION);
