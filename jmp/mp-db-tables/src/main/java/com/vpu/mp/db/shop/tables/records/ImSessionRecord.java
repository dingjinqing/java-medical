...
public class ImSessionRecord extends UpdatableRecordImpl<ImSessionRecord> implements Record15<Integer, Integer, Integer, Integer, Integer, Byte, Integer, String, Timestamp, Byte, Byte, Integer, Byte, Timestamp, Timestamp> {

    private static final long serialVersionUID = -2085091972;
     ...
     */
    @Override
    public Row15<Integer, Integer, Integer, Integer, Integer, Byte, Integer, String, Timestamp, Byte, Byte, Integer, Byte, Timestamp, Timestamp> fieldsRow() {
     ...
     */
    @Override
    public Row15<Integer, Integer, Integer, Integer, Integer, Byte, Integer, String, Timestamp, Byte, Byte, Integer, Byte, Timestamp, Timestamp> valuesRow() {
     ...
     */
    @Override
    public ImSessionRecord value10(Byte value) {
     ...
     */
    @Override
    public ImSessionRecord value12(Integer value) {
     ...
     */
    @Override
    public ImSessionRecord value13(Byte value) {
        setIsDelete(value);
        return this;
    }
     ...
     */
    @Override
    public ImSessionRecord value14(Timestamp value) {
        setCreateTime(value);
        return this;
    }
     ...
     */
    @Override
    public ImSessionRecord values(Integer value1, Integer value2, Integer value3, Integer value4, Integer value5, Byte value6, Integer value7, String value8, Timestamp value9, Byte value10, Byte value11, Integer value12, Byte value13, Timestamp value14, Timestamp value15) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public ImSessionRecord(Integer id, Integer doctorId, Integer departmentId, Integer userId, Integer patientId, Byte sessionStatus, Integer continueSessionCount, String orderSn, Timestamp limitTime, Byte weightFactor, Byte evaluateStatus, Integer readyToOnAkcTime, Byte isDelete, Timestamp createTime, Timestamp updateTime) {
        super(ImSession.IM_SESSION);
        ...
        set(8, limitTime);
        set(9, weightFactor);
        set(10, evaluateStatus);
        set(11, readyToOnAkcTime);
        set(12, isDelete);
        set(13, createTime);
        set(14, updateTime);
    }
