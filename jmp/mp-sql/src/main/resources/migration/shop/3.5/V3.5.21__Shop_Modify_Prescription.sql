...
ALTER TABLE `b2c_inquiry_order` ADD COLUMN `platform_rebate_money`  decimal(10,4) NOT NULL DEFAULT '0.0000' COMMENT '平台返利比例' AFTER `platform_rebate_proportion`;
ALTER TABLE `b2c_inquiry_order_rebate` ADD COLUMN `platform_rebate_money`  decimal(10,2) NOT NULL DEFAULT '0.0000' COMMENT '平台返利比例' AFTER `total_rebate_money`;
