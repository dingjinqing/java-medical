package com.vpu.mp.dao.shop.distribution.distributorlevel;
...
import static com.vpu.mp.common.foundation.data.DistributionConstant.LEVEL_STATUS_ON;
import static com.vpu.mp.common.foundation.data.DistributionConstant.LEVEL_UP_ROUTE_AUTO;
import static com.vpu.mp.db.shop.Tables.USER_DETAIL;
import static com.vpu.mp.db.shop.tables.DistributorLevel.DISTRIBUTOR_LEVEL;
