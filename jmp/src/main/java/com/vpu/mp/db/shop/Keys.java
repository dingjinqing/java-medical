...
public class Keys {
    ...
    public static final Identity<AdminLoginRecordRecord, Integer> IDENTITY_ADMIN_LOGIN_RECORD = Identities0.IDENTITY_ADMIN_LOGIN_RECORD;
    ...
    public static final Identity<CustomerPageTemplateRecord, Integer> IDENTITY_CUSTOMER_PAGE_TEMPLATE = Identities0.IDENTITY_CUSTOMER_PAGE_TEMPLATE;
    public static final Identity<DecorateLinkRecord, Integer> IDENTITY_DECORATE_LINK = Identities0.IDENTITY_DECORATE_LINK;
    public static final Identity<DeliveryTypeRecord, Byte> IDENTITY_DELIVERY_TYPE = Identities0.IDENTITY_DELIVERY_TYPE;
    ...
    public static final Identity<GoodsDeliverTemplateLinkRecord, Integer> IDENTITY_GOODS_DELIVER_TEMPLATE_LINK = Identities0.IDENTITY_GOODS_DELIVER_TEMPLATE_LINK;
    ...
    public static final Identity<MpUserRecord, Integer> IDENTITY_MP_USER = Identities0.IDENTITY_MP_USER;
    public static final Identity<MrkingActivityRecordRecord, Integer> IDENTITY_MRKING_ACTIVITY_RECORD = Identities0.IDENTITY_MRKING_ACTIVITY_RECORD;
    ...
    public static final Identity<StatisticsSummaryRecord, Integer> IDENTITY_STATISTICS_SUMMARY = Identities0.IDENTITY_STATISTICS_SUMMARY;
    ...
    public static final Identity<WxpKeywordsStatRecord, Integer> IDENTITY_WXP_KEYWORDS_STAT = Identities0.IDENTITY_WXP_KEYWORDS_STAT;
    public static final Identity<WxpListRecord, Integer> IDENTITY_WXP_LIST = Identities0.IDENTITY_WXP_LIST;
    public static final Identity<WxpMassSendMsgRecord, Integer> IDENTITY_WXP_MASS_SEND_MSG = Identities0.IDENTITY_WXP_MASS_SEND_MSG;
    public static final Identity<WxpMaterialRecord, Integer> IDENTITY_WXP_MATERIAL = Identities0.IDENTITY_WXP_MATERIAL;
    public static final Identity<WxpMenuCfgRecord, Integer> IDENTITY_WXP_MENU_CFG = Identities0.IDENTITY_WXP_MENU_CFG;
    public static final Identity<WxpMenuStatRecord, Integer> IDENTITY_WXP_MENU_STAT = Identities0.IDENTITY_WXP_MENU_STAT;
    public static final Identity<WxpMessageRecord, Integer> IDENTITY_WXP_MESSAGE = Identities0.IDENTITY_WXP_MESSAGE;
    public static final Identity<WxpMsgStatRecord, Integer> IDENTITY_WXP_MSG_STAT = Identities0.IDENTITY_WXP_MSG_STAT;
    public static final Identity<WxpQrCodeRecord, Integer> IDENTITY_WXP_QR_CODE = Identities0.IDENTITY_WXP_QR_CODE;
    public static final Identity<WxpResponseCfgRecord, Integer> IDENTITY_WXP_RESPONSE_CFG = Identities0.IDENTITY_WXP_RESPONSE_CFG;
    public static final Identity<WxpSubStatRecord, Integer> IDENTITY_WXP_SUB_STAT = Identities0.IDENTITY_WXP_SUB_STAT;
    ...
    public static final Identity<WxpUserRecord, Integer> IDENTITY_WXP_USER = Identities0.IDENTITY_WXP_USER;
    public static final Identity<WxpUserGroupRecord, Integer> IDENTITY_WXP_USER_GROUP = Identities0.IDENTITY_WXP_USER_GROUP;
    ...
    private static class Identities0 {
        public static Identity<AdminLoginRecordRecord, Integer> IDENTITY_ADMIN_LOGIN_RECORD = Internal.createIdentity(AdminLoginRecord.ADMIN_LOGIN_RECORD, AdminLoginRecord.ADMIN_LOGIN_RECORD.ID);
        ...
        public static Identity<CustomerPageTemplateRecord, Integer> IDENTITY_CUSTOMER_PAGE_TEMPLATE = Internal.createIdentity(CustomerPageTemplate.CUSTOMER_PAGE_TEMPLATE, CustomerPageTemplate.CUSTOMER_PAGE_TEMPLATE.PAGE_ID);
        ...
        public static Identity<DeliveryTypeRecord, Byte> IDENTITY_DELIVERY_TYPE = Internal.createIdentity(DeliveryType.DELIVERY_TYPE, DeliveryType.DELIVERY_TYPE.ID);
        ...
        public static Identity<DistributorLevelRecordRecord, Integer> IDENTITY_DISTRIBUTOR_LEVEL_RECORD = Internal.createIdentity(com.vpu.mp.db.shop.tables.DistributorLevelRecord.DISTRIBUTOR_LEVEL_RECORD, com.vpu.mp.db.shop.tables.DistributorLevelRecord.DISTRIBUTOR_LEVEL_RECORD.ID);
        ...
        public static Identity<GoodsDeliverTemplateLinkRecord, Integer> IDENTITY_GOODS_DELIVER_TEMPLATE_LINK = Internal.createIdentity(GoodsDeliverTemplateLink.GOODS_DELIVER_TEMPLATE_LINK, GoodsDeliverTemplateLink.GOODS_DELIVER_TEMPLATE_LINK.REC_ID);
        ...
        public static Identity<LotteryRecordRecord, Integer> IDENTITY_LOTTERY_RECORD = Internal.createIdentity(com.vpu.mp.db.shop.tables.LotteryRecord.LOTTERY_RECORD, com.vpu.mp.db.shop.tables.LotteryRecord.LOTTERY_RECORD.ID);
        ...
        public static Identity<MpUserRecord, Integer> IDENTITY_MP_USER = Internal.createIdentity(MpUser.MP_USER, MpUser.MP_USER.MP_USER_ID);
        public static Identity<MrkingActivityRecordRecord, Integer> IDENTITY_MRKING_ACTIVITY_RECORD = Internal.createIdentity(MrkingActivityRecord.MRKING_ACTIVITY_RECORD, MrkingActivityRecord.MRKING_ACTIVITY_RECORD.ID);
        ...
        public static Identity<PaymentRecordRecord, Integer> IDENTITY_PAYMENT_RECORD = Internal.createIdentity(com.vpu.mp.db.shop.tables.PaymentRecord.PAYMENT_RECORD, com.vpu.mp.db.shop.tables.PaymentRecord.PAYMENT_RECORD.ID);
        ...
        public static Identity<StatisticsSummaryRecord, Integer> IDENTITY_STATISTICS_SUMMARY = Internal.createIdentity(StatisticsSummary.STATISTICS_SUMMARY, StatisticsSummary.STATISTICS_SUMMARY.ID);
        ...
        public static Identity<WxpKeywordsStatRecord, Integer> IDENTITY_WXP_KEYWORDS_STAT = Internal.createIdentity(WxpKeywordsStat.WXP_KEYWORDS_STAT, WxpKeywordsStat.WXP_KEYWORDS_STAT.REC_ID);
        public static Identity<WxpListRecord, Integer> IDENTITY_WXP_LIST = Internal.createIdentity(WxpList.WXP_LIST, WxpList.WXP_LIST.MICRO_ID);
        public static Identity<WxpMassSendMsgRecord, Integer> IDENTITY_WXP_MASS_SEND_MSG = Internal.createIdentity(WxpMassSendMsg.WXP_MASS_SEND_MSG, WxpMassSendMsg.WXP_MASS_SEND_MSG.REC_ID);
        public static Identity<WxpMaterialRecord, Integer> IDENTITY_WXP_MATERIAL = Internal.createIdentity(WxpMaterial.WXP_MATERIAL, WxpMaterial.WXP_MATERIAL.REC_ID);
        public static Identity<WxpMenuCfgRecord, Integer> IDENTITY_WXP_MENU_CFG = Internal.createIdentity(WxpMenuCfg.WXP_MENU_CFG, WxpMenuCfg.WXP_MENU_CFG.MENU_ID);
        public static Identity<WxpMenuStatRecord, Integer> IDENTITY_WXP_MENU_STAT = Internal.createIdentity(WxpMenuStat.WXP_MENU_STAT, WxpMenuStat.WXP_MENU_STAT.REC_ID);
        public static Identity<WxpMessageRecord, Integer> IDENTITY_WXP_MESSAGE = Internal.createIdentity(WxpMessage.WXP_MESSAGE, WxpMessage.WXP_MESSAGE.REC_ID);
        public static Identity<WxpMsgStatRecord, Integer> IDENTITY_WXP_MSG_STAT = Internal.createIdentity(WxpMsgStat.WXP_MSG_STAT, WxpMsgStat.WXP_MSG_STAT.REC_ID);
        ...
        public static Identity<WxpResponseCfgRecord, Integer> IDENTITY_WXP_RESPONSE_CFG = Internal.createIdentity(WxpResponseCfg.WXP_RESPONSE_CFG, WxpResponseCfg.WXP_RESPONSE_CFG.REC_ID);
        public static Identity<WxpSubStatRecord, Integer> IDENTITY_WXP_SUB_STAT = Internal.createIdentity(WxpSubStat.WXP_SUB_STAT, WxpSubStat.WXP_SUB_STAT.REC_ID);
        ...
        public static Identity<WxpUserRecord, Integer> IDENTITY_WXP_USER = Internal.createIdentity(WxpUser.WXP_USER, WxpUser.WXP_USER.USER_ID);
        public static Identity<WxpUserGroupRecord, Integer> IDENTITY_WXP_USER_GROUP = Internal.createIdentity(WxpUserGroup.WXP_USER_GROUP, WxpUserGroup.WXP_USER_GROUP.GROUP_ID);
