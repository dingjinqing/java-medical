...
public class ServiceCategory extends TableImpl<ServiceCategoryRecord> {
     ...
     */
    public final TableField<ServiceCategoryRecord, Short> CAT_ID = createField("cat_id", org.jooq.impl.SQLDataType.SMALLINT.nullable(false).identity(true), this, "");
     ...
     */
    @Override
    public Identity<ServiceCategoryRecord, Short> getIdentity() {
