...
public class MpOfficialAccount extends TableImpl<MpOfficialAccountRecord> {
    ...
    private static final long serialVersionUID = 1003624498;
     ...
     */
    public final TableField<MpOfficialAccountRecord, Timestamp> CREATE_TIME = createField("create_time", org.jooq.impl.SQLDataType.TIMESTAMP.defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "");
