...
public class RebatePriceRecord extends TableImpl<RebatePriceRecordRecord> {
    ...
    private static final long serialVersionUID = 1383207433;

    /**
     * The reference instance of <code>mini_shop_1.b2c_rebate_price_record</code>
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_rebate_price_record.id</code>.
     */
    public final TableField<RebatePriceRecordRecord, UInteger> ID = createField("id", org.jooq.impl.SQLDataType.INTEGERUNSIGNED.nullable(false).identity(true), this, "");

    /**
     * The column <code>mini_shop_1.b2c_rebate_price_record.user_id</code>. 用户ID
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_rebate_price_record.data_sign</code>. md5(rebate_data)
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_rebate_price_record.rebate_data</code>. 分享内容
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_rebate_price_record.add_time</code>. 分享时间
     */
    ...
    /**
     * Create a <code>mini_shop_1.b2c_rebate_price_record</code> table reference
     */
    ...
    /**
     * Create an aliased <code>mini_shop_1.b2c_rebate_price_record</code> table reference
     */
     ...
     */
    @Override
    public Identity<RebatePriceRecordRecord, UInteger> getIdentity() {
