...
public class Payment extends TableImpl<PaymentRecord> {
    ...
    private static final long serialVersionUID = 715246866;

    /**
     * The reference instance of <code>mini_shop_1.b2c_payment</code>
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_payment.id</code>.
     */
    public final TableField<PaymentRecord, UByte> ID = createField("id", org.jooq.impl.SQLDataType.TINYINTUNSIGNED.nullable(false).identity(true), this, "");

    /**
     * The column <code>mini_shop_1.b2c_payment.shop_id</code>. 店铺ID
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_payment.pay_name</code>.
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_payment.pay_code</code>.
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_payment.pay_fee</code>.
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_payment.pay_desc</code>.
     */
    public final TableField<PaymentRecord, String> PAY_DESC = createField("pay_desc", org.jooq.impl.SQLDataType.CLOB.nullable(false), this, "");

    /**
     * The column <code>mini_shop_1.b2c_payment.enabled</code>.
     */
    public final TableField<PaymentRecord, UByte> ENABLED = createField("enabled", org.jooq.impl.SQLDataType.TINYINTUNSIGNED.nullable(false).defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.TINYINTUNSIGNED)), this, "");

    /**
     * The column <code>mini_shop_1.b2c_payment.is_cod</code>.
     */
    public final TableField<PaymentRecord, UByte> IS_COD = createField("is_cod", org.jooq.impl.SQLDataType.TINYINTUNSIGNED.nullable(false).defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.TINYINTUNSIGNED)), this, "");

    /**
     * The column <code>mini_shop_1.b2c_payment.is_online_pay</code>.
     */
    public final TableField<PaymentRecord, UByte> IS_ONLINE_PAY = createField("is_online_pay", org.jooq.impl.SQLDataType.TINYINTUNSIGNED.nullable(false).defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.TINYINTUNSIGNED)), this, "");

    /**
     * Create a <code>mini_shop_1.b2c_payment</code> table reference
     */
    public Payment() {
    ...
    /**
     * Create an aliased <code>mini_shop_1.b2c_payment</code> table reference
     */
     ...
     */
    @Override
    public Identity<PaymentRecord, UByte> getIdentity() {
