...
public class AssessTopicRecordRecord extends UpdatableRecordImpl<AssessTopicRecordRecord> implements Record8<UInteger, Integer, Integer, String, Integer, Integer, Timestamp, Timestamp> {

    private static final long serialVersionUID = 940916562;
     ...
     */
    @Override
    public Row8<UInteger, Integer, Integer, String, Integer, Integer, Timestamp, Timestamp> fieldsRow() {
     ...
     */
    @Override
    public Row8<UInteger, Integer, Integer, String, Integer, Integer, Timestamp, Timestamp> valuesRow() {
     ...
     */
    @Override
    public AssessTopicRecordRecord value1(UInteger value) {
        setId(value);
        return this;
    }
     ...
     */
    @Override
    public AssessTopicRecordRecord values(UInteger value1, Integer value2, Integer value3, String value4, Integer value5, Integer value6, Timestamp value7, Timestamp value8) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public AssessTopicRecordRecord(UInteger id, Integer recordId, Integer topicId, String topicOption, Integer topicPoint, Integer resultId, Timestamp createTime, Timestamp updateTime) {
        super(AssessTopicRecord.ASSESS_TOPIC_RECORD);
