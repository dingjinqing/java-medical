...
public class AliMiniAgent extends TableImpl<AliMiniAgentRecord> {
    ...
    private static final long serialVersionUID = 2029942905;
     ...
     */
    public final TableField<AliMiniAgentRecord, UInteger> REC_ID = createField("rec_id", org.jooq.impl.SQLDataType.INTEGERUNSIGNED.nullable(false).identity(true), this, "");

    /**
     * The column <code>mini_main.b2c_ali_mini_agent.shop_id</code>. 店铺Id
     */
    public final TableField<AliMiniAgentRecord, UInteger> SHOP_ID = createField("shop_id", org.jooq.impl.SQLDataType.INTEGERUNSIGNED.nullable(false), this, "店铺Id");
     ...
     */
    @Override
    public Identity<AliMiniAgentRecord, UInteger> getIdentity() {
