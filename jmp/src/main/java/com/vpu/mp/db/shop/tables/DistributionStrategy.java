...
public class DistributionStrategy extends TableImpl<DistributionStrategyRecord> {
    ...
    private static final long serialVersionUID = -1162925822;

    /**
     * The reference instance of <code>mini_shop_1.b2c_distribution_strategy</code>
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_distribution_strategy.id</code>.
     */
    public final TableField<DistributionStrategyRecord, UInteger> ID = createField("id", org.jooq.impl.SQLDataType.INTEGERUNSIGNED.nullable(false).identity(true), this, "");

    /**
     * The column <code>mini_shop_1.b2c_distribution_strategy.strategy_name</code>. 策略名称
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_distribution_strategy.strategy_level</code>. 策略等级
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_distribution_strategy.start_time</code>. 开始时间
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_distribution_strategy.end_time</code>. 结束时间
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_distribution_strategy.self_purchase</code>. 自购返利
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_distribution_strategy.cost_protection</code>. 成本保护
     */
    public final TableField<DistributionStrategyRecord, Byte> COST_PROTECTION = createField("cost_protection", org.jooq.impl.SQLDataType.TINYINT.nullable(false).defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.TINYINT)), this, "成本保护");

    /**
     * The column <code>mini_shop_1.b2c_distribution_strategy.fanli_ratio</code>. 返利比例（%的系数）
     */
    public final TableField<DistributionStrategyRecord, Double> FANLI_RATIO = createField("fanli_ratio", org.jooq.impl.SQLDataType.FLOAT.nullable(false).defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.FLOAT)), this, "返利比例（%的系数）");

    /**
     * The column <code>mini_shop_1.b2c_distribution_strategy.rebate_ratio</code>. 间接
     */
    public final TableField<DistributionStrategyRecord, Double> REBATE_RATIO = createField("rebate_ratio", org.jooq.impl.SQLDataType.FLOAT.defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.FLOAT)), this, "间接");

    /**
     * The column <code>mini_shop_1.b2c_distribution_strategy.fanli_ratio_2</code>. 二级返利比例（%的系数）
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_distribution_strategy.rebate_ratio_2</code>. 间接
     */
    public final TableField<DistributionStrategyRecord, Double> REBATE_RATIO_2 = createField("rebate_ratio_2", org.jooq.impl.SQLDataType.FLOAT.defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.FLOAT)), this, "间接");

    /**
     * The column <code>mini_shop_1.b2c_distribution_strategy.fanli_ratio_3</code>. 三级返利比例（%的系数）
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_distribution_strategy.rebate_ratio_3</code>. 间接
     */
    public final TableField<DistributionStrategyRecord, Double> REBATE_RATIO_3 = createField("rebate_ratio_3", org.jooq.impl.SQLDataType.FLOAT.defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.FLOAT)), this, "间接");

    /**
     * The column <code>mini_shop_1.b2c_distribution_strategy.fanli_ratio_4</code>. 四级返利比例（%的系数）
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_distribution_strategy.rebate_ratio_4</code>. 间接
     */
    public final TableField<DistributionStrategyRecord, Double> REBATE_RATIO_4 = createField("rebate_ratio_4", org.jooq.impl.SQLDataType.FLOAT.defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.FLOAT)), this, "间接");

    /**
     * The column <code>mini_shop_1.b2c_distribution_strategy.fanli_ratio_5</code>. 五级返利比例（%的系数）
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_distribution_strategy.rebate_ratio_5</code>. 间接
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_distribution_strategy.recommend_type</code>. 0:全部商品1:部分商品
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_distribution_strategy.recommend_goods_id</code>. 返利商品ids
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_distribution_strategy.recommend_cat_id</code>. 返利分类ids
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_distribution_strategy.status</code>. 1停用
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_distribution_strategy.add_time</code>. 添加时间
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_distribution_strategy.del_flag</code>. 1删除
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_distribution_strategy.update_time</code>. 最后修改时间
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_distribution_strategy.recommend_sort_id</code>. 返利商家分类ids
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_distribution_strategy.send_coupon</code>. 赠送优惠券
     */
    ...
    /**
     * Create a <code>mini_shop_1.b2c_distribution_strategy</code> table reference
     */
    ...
    /**
     * Create an aliased <code>mini_shop_1.b2c_distribution_strategy</code> table reference
     */
     ...
     */
    @Override
    public Identity<DistributionStrategyRecord, UInteger> getIdentity() {
