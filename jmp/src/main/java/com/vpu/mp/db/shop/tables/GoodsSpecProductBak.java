...
public class GoodsSpecProductBak extends TableImpl<GoodsSpecProductBakRecord> {
     ...
     */
    public final TableField<GoodsSpecProductBakRecord, Timestamp> DEL_TIME = createField("del_time", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "");

    /**
     * The column <code>mini_shop_471752.b2c_goods_spec_product_bak.prd_id</code>.
     */
    public final TableField<GoodsSpecProductBakRecord, Integer> PRD_ID = createField("prd_id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(DSL.inline("0", org.jooq.impl.SQLDataType.INTEGER)), this, "");

    /**
     * The column <code>mini_shop_471752.b2c_goods_spec_product_bak.shop_id</code>.
     */
    public final TableField<GoodsSpecProductBakRecord, Integer> SHOP_ID = createField("shop_id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(DSL.inline("0", org.jooq.impl.SQLDataType.INTEGER)), this, "");

    /**
     * The column <code>mini_shop_471752.b2c_goods_spec_product_bak.goods_id</code>.
     */
    public final TableField<GoodsSpecProductBakRecord, Integer> GOODS_ID = createField("goods_id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(DSL.inline("0", org.jooq.impl.SQLDataType.INTEGER)), this, "");
     ...
     */
    public final TableField<GoodsSpecProductBakRecord, BigDecimal> PRD_COST_PRICE = createField("prd_cost_price", org.jooq.impl.SQLDataType.DECIMAL(10, 2).nullable(false).defaultValue(DSL.inline("0.00", org.jooq.impl.SQLDataType.DECIMAL)), this, "成本价");

    /**
     * The column <code>mini_shop_471752.b2c_goods_spec_product_bak.prd_number</code>. 当前规格组合产品库存
     */
    public final TableField<GoodsSpecProductBakRecord, Integer> PRD_NUMBER = createField("prd_number", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(DSL.inline("0", org.jooq.impl.SQLDataType.INTEGER)), this, "当前规格组合产品库存");

    /**
     * The column <code>mini_shop_471752.b2c_goods_spec_product_bak.prd_sn</code>. 商家编码
     */
    public final TableField<GoodsSpecProductBakRecord, String> PRD_SN = createField("prd_sn", org.jooq.impl.SQLDataType.VARCHAR(65).nullable(false).defaultValue(DSL.inline("", org.jooq.impl.SQLDataType.VARCHAR)), this, "商家编码");

    /**
     * The column <code>mini_shop_471752.b2c_goods_spec_product_bak.prd_codes</code>. 商品条码
     */
    public final TableField<GoodsSpecProductBakRecord, String> PRD_CODES = createField("prd_codes", org.jooq.impl.SQLDataType.VARCHAR(500).nullable(false).defaultValue(DSL.inline("", org.jooq.impl.SQLDataType.VARCHAR)), this, "商品条码");

    /**
     * The column <code>mini_shop_471752.b2c_goods_spec_product_bak.prd_specs</code>.
     */
    public final TableField<GoodsSpecProductBakRecord, String> PRD_SPECS = createField("prd_specs", org.jooq.impl.SQLDataType.VARCHAR(1024).nullable(false).defaultValue(DSL.inline("", org.jooq.impl.SQLDataType.VARCHAR)), this, "");
     ...
     */
    public final TableField<GoodsSpecProductBakRecord, String> LOW_SHOP_PRICE = createField("low_shop_price", org.jooq.impl.SQLDataType.VARCHAR(1024).nullable(false).defaultValue(DSL.inline("0.00", org.jooq.impl.SQLDataType.VARCHAR)), this, "最低售出价格");

    /**
     * The column <code>mini_shop_471752.b2c_goods_spec_product_bak.prd_img</code>. 图片地址
     */
    public final TableField<GoodsSpecProductBakRecord, String> PRD_IMG = createField("prd_img", org.jooq.impl.SQLDataType.VARCHAR(1024).nullable(false).defaultValue(DSL.inline("", org.jooq.impl.SQLDataType.VARCHAR)), this, "图片地址");

    /**
     * The column <code>mini_shop_471752.b2c_goods_spec_product_bak.price_flag</code>. 0:商家未改价，1：商家改价，2：批量改价，3：毛利改价
     */
    public final TableField<GoodsSpecProductBakRecord, Byte> PRICE_FLAG = createField("price_flag", org.jooq.impl.SQLDataType.TINYINT.nullable(false).defaultValue(DSL.inline("0", org.jooq.impl.SQLDataType.TINYINT)), this, "0:商家未改价，1：商家改价，2：批量改价，3：毛利改价");

    /**
     * The column <code>mini_shop_471752.b2c_goods_spec_product_bak.create_time</code>. 规格记录在原表内的添加时间
     */
    public final TableField<GoodsSpecProductBakRecord, Timestamp> CREATE_TIME = createField("create_time", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(DSL.inline("0000-00-00 00:00:00", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "规格记录在原表内的添加时间");

    /**
     * The column <code>mini_shop_471752.b2c_goods_spec_product_bak.update_time</code>. 规格记录在原表内的最后修改时间
     */
    public final TableField<GoodsSpecProductBakRecord, Timestamp> UPDATE_TIME = createField("update_time", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(DSL.inline("0000-00-00 00:00:00", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "规格记录在原表内的最后修改时间");
