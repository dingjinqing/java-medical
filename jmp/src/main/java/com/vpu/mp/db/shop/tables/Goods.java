...
public class Goods extends TableImpl<GoodsRecord> {
     ...
     */
    public final TableField<GoodsRecord, Integer> ADD_SALE_NUM = createField("add_sale_num", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(DSL.inline("0", org.jooq.impl.SQLDataType.INTEGER)), this, "虚假销量");
