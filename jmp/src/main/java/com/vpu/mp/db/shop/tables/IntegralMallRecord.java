...
public class IntegralMallRecord extends TableImpl<IntegralMallRecordRecord> {
    ...
    private static final long serialVersionUID = -981532312;

    /**
     * The reference instance of <code>mini_shop_1.b2c_integral_mall_record</code>
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_integral_mall_record.id</code>.
     */
    public final TableField<IntegralMallRecordRecord, UInteger> ID = createField("id", org.jooq.impl.SQLDataType.INTEGERUNSIGNED.nullable(false).identity(true), this, "");

    /**
     * The column <code>mini_shop_1.b2c_integral_mall_record.integral_mall_define_id</code>. 积分商城活动定义表ID
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_integral_mall_record.order_sn</code>. 订单编号
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_integral_mall_record.user_id</code>. 用户ID
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_integral_mall_record.goods_id</code>. 商品ID
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_integral_mall_record.product_id</code>. 产品规格ID
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_integral_mall_record.score</code>. 消费积分
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_integral_mall_record.number</code>. 兑换数量
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_integral_mall_record.add_time</code>. 兑换时间
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_integral_mall_record.money</code>. 消耗现金
     */
    ...
    /**
     * Create a <code>mini_shop_1.b2c_integral_mall_record</code> table reference
     */
    ...
    /**
     * Create an aliased <code>mini_shop_1.b2c_integral_mall_record</code> table reference
     */
     ...
     */
    @Override
    public Identity<IntegralMallRecordRecord, UInteger> getIdentity() {
