...
public class CustomerAvailCoupons extends TableImpl<CustomerAvailCouponsRecord> {
    ...
    private static final long serialVersionUID = -1959965422;
     ...
     */
    public final TableField<CustomerAvailCouponsRecord, Integer> ACT_TYPE = createField("act_type", org.jooq.impl.SQLDataType.INTEGER.defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.INTEGER)), this, "user_id不为空时1:经销商等级打折,为空时1:首次下单优惠，2减价，3打折");
     ...
     */
    public final TableField<CustomerAvailCouponsRecord, Byte> TYPE = createField("type", org.jooq.impl.SQLDataType.TINYINT.defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.TINYINT)), this, "1为减价，2为打折");
     ...
     */
    public final TableField<CustomerAvailCouponsRecord, Integer> LIMIT_ORDER_AMOUNT = createField("limit_order_amount", org.jooq.impl.SQLDataType.INTEGER.defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.INTEGER)), this, "");
     ...
     */
    public final TableField<CustomerAvailCouponsRecord, Byte> IS_USED = createField("is_used", org.jooq.impl.SQLDataType.TINYINT.defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.TINYINT)), this, "");
