...
public class GoodsDeliverTemplateLink extends TableImpl<GoodsDeliverTemplateLinkRecord> {
    ...
    private static final long serialVersionUID = 1842504294;
     ...
     */
    public final TableField<GoodsDeliverTemplateLinkRecord, Integer> REC_ID = createField("rec_id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).identity(true), this, "");

    /**
     * The column <code>mini_shop_471752.b2c_goods_deliver_template_link.goods_id</code>.
     */
    public final TableField<GoodsDeliverTemplateLinkRecord, Integer> GOODS_ID = createField("goods_id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.INTEGER)), this, "");

    /**
     * The column <code>mini_shop_471752.b2c_goods_deliver_template_link.deliver_template_id</code>.
     */
    public final TableField<GoodsDeliverTemplateLinkRecord, Integer> DELIVER_TEMPLATE_ID = createField("deliver_template_id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.INTEGER)), this, "");

    /**
     * The column <code>mini_shop_471752.b2c_goods_deliver_template_link.created</code>.
     */
    public final TableField<GoodsDeliverTemplateLinkRecord, Timestamp> CREATED = createField("created", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "");
     ...
     */
    @Override
    public Identity<GoodsDeliverTemplateLinkRecord, Integer> getIdentity() {
