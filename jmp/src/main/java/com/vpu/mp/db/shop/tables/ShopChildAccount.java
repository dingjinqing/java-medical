...
public class ShopChildAccount extends TableImpl<ShopChildAccountRecord> {
    ...
    private static final long serialVersionUID = 2133131417;

    /**
     * The reference instance of <code>mini_shop_1.b2c_shop_child_account</code>
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_shop_child_account.account_id</code>.
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_shop_child_account.shop_id</code>. 店铺ID
     */
    public final TableField<ShopChildAccountRecord, Integer> SHOP_ID = createField("shop_id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.INTEGER)), this, "店铺ID");

    /**
     * The column <code>mini_shop_1.b2c_shop_child_account.account_name</code>. 子账号用户名
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_shop_child_account.account_pwd</code>. 子账号密码
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_shop_child_account.role_id</code>. 角色ID
     */
    public final TableField<ShopChildAccountRecord, Integer> ROLE_ID = createField("role_id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.INTEGER)), this, "角色ID");

    /**
     * The column <code>mini_shop_1.b2c_shop_child_account.create_time</code>.
     */
    public final TableField<ShopChildAccountRecord, Timestamp> CREATE_TIME = createField("create_time", org.jooq.impl.SQLDataType.TIMESTAMP.defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "");

    /**
     * The column <code>mini_shop_1.b2c_shop_child_account.mobile</code>. 手机号
     */
    ...
    /**
     * Create a <code>mini_shop_1.b2c_shop_child_account</code> table reference
     */
    ...
    /**
     * Create an aliased <code>mini_shop_1.b2c_shop_child_account</code> table reference
     */
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.SHOP_CHILD_ACCOUNT_ACCOUNT_NAME, Indexes.SHOP_CHILD_ACCOUNT_PRIMARY, Indexes.SHOP_CHILD_ACCOUNT_SHOP_ID);
    }
    ...
    public List<UniqueKey<ShopChildAccountRecord>> getKeys() {
        return Arrays.<UniqueKey<ShopChildAccountRecord>>asList(Keys.KEY_B2C_SHOP_CHILD_ACCOUNT_PRIMARY, Keys.KEY_B2C_SHOP_CHILD_ACCOUNT_ACCOUNT_NAME);
    }
