...
public class CategoryRecord extends UpdatableRecordImpl<CategoryRecord> implements Record10<UShort, String, String, String, UShort, Short, Byte, Timestamp, String, Short> {

    private static final long serialVersionUID = -505821098;
     ...
     */
    @Override
    public CategoryRecord values(UShort value1, String value2, String value3, String value4, UShort value5, Short value6, Byte value7, Timestamp value8, String value9, Short value10) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public CategoryRecord(UShort catId, String catName, String keywords, String catDesc, UShort parentId, Short level, Byte hasChild, Timestamp createTime, String catImg, Short first) {
        super(Category.CATEGORY);
