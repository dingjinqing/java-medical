...
public class SystemCfgRecord extends UpdatableRecordImpl<SystemCfgRecord> implements Record4<UShort, UInteger, String, String> {

    private static final long serialVersionUID = 132761987;
     ...
     */
    @Override
    public SystemCfgRecord value1(UShort value) {
        setRecId(value);
        return this;
    }
     ...
     */
    @Override
    public SystemCfgRecord value2(UInteger value) {
        setSysId(value);
        return this;
    }
     ...
     */
    @Override
    public SystemCfgRecord values(UShort value1, UInteger value2, String value3, String value4) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public SystemCfgRecord(UShort recId, UInteger sysId, String k, String v) {
        super(SystemCfg.SYSTEM_CFG);
