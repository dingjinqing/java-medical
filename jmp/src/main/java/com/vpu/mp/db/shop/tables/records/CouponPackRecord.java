...
public class CouponPackRecord extends UpdatableRecordImpl<CouponPackRecord> implements Record16<Integer, String, Timestamp, Timestamp, String, UByte, UInteger, UInteger, Byte, BigDecimal, String, Byte, Timestamp, Timestamp, Byte, Timestamp> {

    private static final long serialVersionUID = 1972804278;
     ...
     */
    public void setLimitGetTimes(UByte value) {
        set(5, value);
    }
     ...
     */
    public void setIssuedAmount(UInteger value) {
        set(7, value);
    }
     ...
     */
    public UInteger getIssuedAmount() {
    ...
    /**
     * Setter for <code>mini_shop_471752.b2c_coupon_pack.state</code>. 开启状态1:开启，0:停用
     */
    ...
    /**
     * Getter for <code>mini_shop_471752.b2c_coupon_pack.state</code>. 开启状态1:开启，0:停用
     */
     ...
     */
    @Override
    public Row16<Integer, String, Timestamp, Timestamp, String, UByte, UInteger, UInteger, Byte, BigDecimal, String, Byte, Timestamp, Timestamp, Byte, Timestamp> fieldsRow() {
     ...
     */
    @Override
    public Row16<Integer, String, Timestamp, Timestamp, String, UByte, UInteger, UInteger, Byte, BigDecimal, String, Byte, Timestamp, Timestamp, Byte, Timestamp> valuesRow() {
    ...
    public Field<Byte> field12() {
        return CouponPack.COUPON_PACK.STATE;
    }
     ...
     */
    @Override
    public CouponPackRecord value6(UByte value) {
     ...
     */
    @Override
    public CouponPackRecord value7(UInteger value) {
     ...
     */
    @Override
    public CouponPackRecord value8(UInteger value) {
     ...
     */
    @Override
    public CouponPackRecord values(Integer value1, String value2, Timestamp value3, Timestamp value4, String value5, UByte value6, UInteger value7, UInteger value8, Byte value9, BigDecimal value10, String value11, Byte value12, Timestamp value13, Timestamp value14, Byte value15, Timestamp value16) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public CouponPackRecord(Integer id, String actName, Timestamp startTime, Timestamp endTime, String packName, UByte limitGetTimes, UInteger totalAmount, UInteger issuedAmount, Byte accessMode, BigDecimal accessCost, String actRule, Byte state, Timestamp createTime, Timestamp updateTime, Byte delFlag, Timestamp delTime) {
        super(CouponPack.COUPON_PACK);
