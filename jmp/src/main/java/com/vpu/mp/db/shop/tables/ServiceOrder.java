...
public class ServiceOrder extends TableImpl<ServiceOrderRecord> {
    ...
    private static final long serialVersionUID = -157089692;

    /**
     * The reference instance of <code>mini_shop_1.b2c_service_order</code>
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_service_order.order_id</code>. 订单ID
     */
    public final TableField<ServiceOrderRecord, UInteger> ORDER_ID = createField("order_id", org.jooq.impl.SQLDataType.INTEGERUNSIGNED.nullable(false).identity(true), this, "订单ID");

    /**
     * The column <code>mini_shop_1.b2c_service_order.store_id</code>. 门店ID
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_service_order.order_sn</code>. 订单编号
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_service_order.user_id</code>. 用户ID
     */
    public final TableField<ServiceOrderRecord, UInteger> USER_ID = createField("user_id", org.jooq.impl.SQLDataType.INTEGERUNSIGNED.nullable(false).defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.INTEGERUNSIGNED)), this, "用户ID");

    /**
     * The column <code>mini_shop_1.b2c_service_order.order_status</code>. 订单状态 0：待服务，1：已取消，2：已完成
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_service_order.order_status_name</code>. 订单状态名称
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_service_order.subscriber</code>. 预约人姓名
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_service_order.mobile</code>. 手机号
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_service_order.service_id</code>. 服务ID
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_service_order.technician_id</code>. 预约技师ID
     */
    public final TableField<ServiceOrderRecord, Integer> TECHNICIAN_ID = createField("technician_id", org.jooq.impl.SQLDataType.INTEGER.defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.INTEGER)), this, "预约技师ID");

    /**
     * The column <code>mini_shop_1.b2c_service_order.technician_name</code>. 技师名称
     */
    public final TableField<ServiceOrderRecord, String> TECHNICIAN_NAME = createField("technician_name", org.jooq.impl.SQLDataType.VARCHAR(20).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.VARCHAR)), this, "技师名称");

    /**
     * The column <code>mini_shop_1.b2c_service_order.service_date</code>. 预约日期
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_service_order.service_period</code>. 预约时段
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_service_order.add_message</code>. 客户留言
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_service_order.admin_message</code>. 商家备注
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_service_order.verify_code</code>. 核销自提码
     */
    public final TableField<ServiceOrderRecord, String> VERIFY_CODE = createField("verify_code", org.jooq.impl.SQLDataType.VARCHAR(191).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.VARCHAR)), this, "核销自提码");

    /**
     * The column <code>mini_shop_1.b2c_service_order.verify_admin</code>. 核销人
     */
    public final TableField<ServiceOrderRecord, String> VERIFY_ADMIN = createField("verify_admin", org.jooq.impl.SQLDataType.VARCHAR(30).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.VARCHAR)), this, "核销人");

    /**
     * The column <code>mini_shop_1.b2c_service_order.pay_code</code>. 支付代号
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_service_order.pay_name</code>. 支付名称
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_service_order.pay_sn</code>. 支付流水号
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_service_order.money_paid</code>. 订单应付金额
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_service_order.discount</code>. 券抵扣金额
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_service_order.coupon_id</code>. 优惠券ID
     */
    public final TableField<ServiceOrderRecord, UInteger> COUPON_ID = createField("coupon_id", org.jooq.impl.SQLDataType.INTEGERUNSIGNED.nullable(false).defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.INTEGERUNSIGNED)), this, "优惠券ID");

    /**
     * The column <code>mini_shop_1.b2c_service_order.order_amount</code>. 订单总金额
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_service_order.add_time</code>. 订单提交时间
     */
    public final TableField<ServiceOrderRecord, Timestamp> ADD_TIME = createField("add_time", org.jooq.impl.SQLDataType.TIMESTAMP, this, "订单提交时间");

    /**
     * The column <code>mini_shop_1.b2c_service_order.pay_time</code>. 支付时间
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_service_order.cancelled_time</code>. 取消时间
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_service_order.finished_time</code>. 订单完成时间
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_service_order.prepay_id</code>. 微信支付Id，用于发送模板消息
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_service_order.del_flag</code>. 删除
     */
    public final TableField<ServiceOrderRecord, Byte> DEL_FLAG = createField("del_flag", org.jooq.impl.SQLDataType.TINYINT.defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.TINYINT)), this, "删除");

    /**
     * The column <code>mini_shop_1.b2c_service_order.verify_type</code>. 核销方式 0是店家核销 1是用户
     */
    public final TableField<ServiceOrderRecord, Byte> VERIFY_TYPE = createField("verify_type", org.jooq.impl.SQLDataType.TINYINT.defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.TINYINT)), this, "核销方式 0是店家核销 1是用户");

    /**
     * The column <code>mini_shop_1.b2c_service_order.cancel_reason</code>. 取消原因
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_service_order.type</code>. 创建类型 0用户创建 1后台
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_service_order.verify_pay</code>. 核销支付方式 0门店买单 1会员卡 2余额
     */
    public final TableField<ServiceOrderRecord, Byte> VERIFY_PAY = createField("verify_pay", org.jooq.impl.SQLDataType.TINYINT.defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.TINYINT)), this, "核销支付方式 0门店买单 1会员卡 2余额");

    /**
     * The column <code>mini_shop_1.b2c_service_order.ali_trade_no</code>. 支付宝交易单号
     */
    public final TableField<ServiceOrderRecord, String> ALI_TRADE_NO = createField("ali_trade_no", org.jooq.impl.SQLDataType.VARCHAR(60).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.VARCHAR)), this, "支付宝交易单号");

    /**
     * Create a <code>mini_shop_1.b2c_service_order</code> table reference
     */
    public ServiceOrder() {
    ...
    /**
     * Create an aliased <code>mini_shop_1.b2c_service_order</code> table reference
     */
     ...
     */
    @Override
    public Identity<ServiceOrderRecord, UInteger> getIdentity() {
