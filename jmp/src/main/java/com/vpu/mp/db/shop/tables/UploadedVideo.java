...
public class UploadedVideo extends TableImpl<UploadedVideoRecord> {
    ...
    private static final long serialVersionUID = 1797952263;

    /**
     * The reference instance of <code>mini_shop_1.b2c_uploaded_video</code>
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_uploaded_video.video_id</code>.
     */
    public final TableField<UploadedVideoRecord, UInteger> VIDEO_ID = createField("video_id", org.jooq.impl.SQLDataType.INTEGERUNSIGNED.nullable(false).identity(true), this, "");

    /**
     * The column <code>mini_shop_1.b2c_uploaded_video.video_type</code>.
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_uploaded_video.video_size</code>.
     */
    public final TableField<UploadedVideoRecord, UInteger> VIDEO_SIZE = createField("video_size", org.jooq.impl.SQLDataType.INTEGERUNSIGNED.nullable(false).defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.INTEGERUNSIGNED)), this, "");

    /**
     * The column <code>mini_shop_1.b2c_uploaded_video.video_name</code>. 视频名称，用于前端显示
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_uploaded_video.video_orig_fname</code>.
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_uploaded_video.video_path</code>.
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_uploaded_video.video_snap_path</code>. 视频截图
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_uploaded_video.video_url</code>.
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_uploaded_video.video_cat_id</code>. 视频分类
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_uploaded_video.video_width</code>.
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_uploaded_video.video_height</code>.
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_uploaded_video.video_meta</code>. 视频信息,json
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_uploaded_video.is_refer</code>. 是否引用
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_uploaded_video.upload_time</code>.
     */
    public final TableField<UploadedVideoRecord, Timestamp> UPLOAD_TIME = createField("upload_time", org.jooq.impl.SQLDataType.TIMESTAMP.defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "");

    /**
     * The column <code>mini_shop_1.b2c_uploaded_video.shop_id</code>. 店铺ID
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_uploaded_video.del_flag</code>.
     */
    ...
    /**
     * Create a <code>mini_shop_1.b2c_uploaded_video</code> table reference
     */
    ...
    /**
     * Create an aliased <code>mini_shop_1.b2c_uploaded_video</code> table reference
     */
     ...
     */
    @Override
    public Identity<UploadedVideoRecord, UInteger> getIdentity() {
