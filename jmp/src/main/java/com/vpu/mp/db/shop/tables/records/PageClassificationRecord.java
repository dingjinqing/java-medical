...
public class PageClassificationRecord extends UpdatableRecordImpl<PageClassificationRecord> implements Record4<Integer, Integer, String, Timestamp> {

    private static final long serialVersionUID = 595926607;
     ...
     */
    @Override
    public PageClassificationRecord values(Integer value1, Integer value2, String value3, Timestamp value4) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public PageClassificationRecord(Integer id, Integer shopId, String name, Timestamp createTime) {
        super(PageClassification.PAGE_CLASSIFICATION);
