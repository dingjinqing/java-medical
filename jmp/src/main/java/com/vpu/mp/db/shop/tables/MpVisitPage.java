...
public class MpVisitPage extends TableImpl<MpVisitPageRecord> {
    ...
    private static final long serialVersionUID = -447082474;
    ...
    /**
     * The column <code>mini_shop_471752.b2c_mp_visit_page.create_time</code>.
     */
    public final TableField<MpVisitPageRecord, Timestamp> CREATE_TIME = createField("create_time", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "");

    /**
     * The column <code>mini_shop_471752.b2c_mp_visit_page.update_time</code>. 最后修改时间
     */
    public final TableField<MpVisitPageRecord, Timestamp> UPDATE_TIME = createField("update_time", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "最后修改时间");
