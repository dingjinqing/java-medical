...
public class WxpResponseCfg extends TableImpl<WxpResponseCfgRecord> {
    ...
    private static final long serialVersionUID = -60580834;
     ...
     */
    public final TableField<WxpResponseCfgRecord, Integer> REC_ID = createField("rec_id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).identity(true), this, "");
     ...
     */
    public final TableField<WxpResponseCfgRecord, Timestamp> CREATE_TIME = createField("create_time", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "");
     ...
     */
    @Override
    public Identity<WxpResponseCfgRecord, Integer> getIdentity() {
