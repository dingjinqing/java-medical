...
public class Attribute extends TableImpl<AttributeRecord> {
    ...
    private static final long serialVersionUID = 834708688;
     ...
     */
    public final TableField<AttributeRecord, Timestamp> CREATE_TIME = createField("create_time", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "");
