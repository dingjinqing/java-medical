...
public class RebatePriceRecordRecord extends UpdatableRecordImpl<RebatePriceRecordRecord> implements Record5<Integer, Integer, String, String, Timestamp> {

    private static final long serialVersionUID = 253720965;
     ...
     */
    @Override
    public RebatePriceRecordRecord values(Integer value1, Integer value2, String value3, String value4, Timestamp value5) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public RebatePriceRecordRecord(Integer id, Integer userId, String dataSign, String rebateData, Timestamp addTime) {
        super(RebatePriceRecord.REBATE_PRICE_RECORD);
