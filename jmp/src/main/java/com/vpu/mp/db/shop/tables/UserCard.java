...
public class UserCard extends TableImpl<UserCardRecord> {
    ...
    private static final long serialVersionUID = -584905114;

    /**
     * The reference instance of <code>mini_shop_1.b2c_user_card</code>
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_user_card.user_id</code>. 会员ID
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_user_card.card_id</code>. 会员卡ID
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_user_card.add_time</code>.
     */
    public final TableField<UserCardRecord, Timestamp> ADD_TIME = createField("add_time", org.jooq.impl.SQLDataType.TIMESTAMP, this, "");

    /**
     * The column <code>mini_shop_1.b2c_user_card.flag</code>. 0:正常，1:删除
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_user_card.card_no</code>. 会员卡号
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_user_card.expire_time</code>.
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_user_card.update_time</code>. 更新时间
     */
    public final TableField<UserCardRecord, Timestamp> UPDATE_TIME = createField("update_time", org.jooq.impl.SQLDataType.TIMESTAMP, this, "更新时间");

    /**
     * The column <code>mini_shop_1.b2c_user_card.is_default</code>. 1:默认会员卡
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_user_card.money</code>. 卡余额
     */
    public final TableField<UserCardRecord, BigDecimal> MONEY = createField("money", org.jooq.impl.SQLDataType.DECIMAL(10, 2).defaultValue(org.jooq.impl.DSL.inline("0.00", org.jooq.impl.SQLDataType.DECIMAL)), this, "卡余额");

    /**
     * The column <code>mini_shop_1.b2c_user_card.surplus</code>. 卡剩余次数
     */
    public final TableField<UserCardRecord, Integer> SURPLUS = createField("surplus", org.jooq.impl.SQLDataType.INTEGER, this, "卡剩余次数");

    /**
     * The column <code>mini_shop_1.b2c_user_card.activation_time</code>. 激活时间
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_user_card.exchang_surplus</code>. 卡剩余兑换次数
     */
    public final TableField<UserCardRecord, Integer> EXCHANG_SURPLUS = createField("exchang_surplus", org.jooq.impl.SQLDataType.INTEGER.defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.INTEGER)), this, "卡剩余兑换次数");

    /**
     * Create a <code>mini_shop_1.b2c_user_card</code> table reference
     */
    public UserCard() {
    ...
    /**
     * Create an aliased <code>mini_shop_1.b2c_user_card</code> table reference
     */
