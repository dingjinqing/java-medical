...
public class LotteryRecord extends TableImpl<LotteryRecordRecord> {
    ...
    private static final long serialVersionUID = -1692154174;

    /**
     * The reference instance of <code>mini_shop_1.b2c_lottery_record</code>
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_lottery_record.id</code>.
     */
    public final TableField<LotteryRecordRecord, UInteger> ID = createField("id", org.jooq.impl.SQLDataType.INTEGERUNSIGNED.nullable(false).identity(true), this, "");

    /**
     * The column <code>mini_shop_1.b2c_lottery_record.user_id</code>. 用户编号
     */
    public final TableField<LotteryRecordRecord, UInteger> USER_ID = createField("user_id", org.jooq.impl.SQLDataType.INTEGERUNSIGNED.nullable(false), this, "用户编号");

    /**
     * The column <code>mini_shop_1.b2c_lottery_record.lottery_id</code>. 抽奖编号
     */
    public final TableField<LotteryRecordRecord, UInteger> LOTTERY_ID = createField("lottery_id", org.jooq.impl.SQLDataType.INTEGERUNSIGNED.nullable(false), this, "抽奖编号");

    /**
     * The column <code>mini_shop_1.b2c_lottery_record.lottery_source</code>. 抽奖来源:1.登录2.支付
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_lottery_record.lottery_act_id</code>. 抽奖来源id
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_lottery_record.chance_source</code>. 抽奖机会来源
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_lottery_record.lottery_cost</code>. 抽奖花费积分
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_lottery_record.lottery_grade</code>. 中奖等级：0未中奖，1一等奖，2二等奖，3三等奖，4四等奖
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_lottery_record.lottery_type</code>. 奖励类型
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_lottery_record.lottery_award</code>. 获得奖励
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_lottery_record.award_info</code>. 中奖信息
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_lottery_record.add_time</code>. 抽奖时间
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_lottery_record.prd_id</code>. 商品（规格）编号
     */
    public final TableField<LotteryRecordRecord, UInteger> PRD_ID = createField("prd_id", org.jooq.impl.SQLDataType.INTEGERUNSIGNED.nullable(false), this, "商品（规格）编号");

    /**
     * The column <code>mini_shop_1.b2c_lottery_record.present_status</code>. 赠品状态:0.待领取，1：已领取，2.已过期
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_lottery_record.order_sn</code>. 关联订单
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_lottery_record.lottery_expired_time</code>. 赠品过期时间
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_lottery_record.source_type</code>. 奖品来源:0幸运大抽奖，1好友助力，2测评
     */
    public final TableField<LotteryRecordRecord, Byte> SOURCE_TYPE = createField("source_type", org.jooq.impl.SQLDataType.TINYINT.defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.TINYINT)), this, "奖品来源:0幸运大抽奖，1好友助力，2测评");

    /**
     * Create a <code>mini_shop_1.b2c_lottery_record</code> table reference
     */
    ...
    /**
     * Create an aliased <code>mini_shop_1.b2c_lottery_record</code> table reference
     */
     ...
     */
    @Override
    public Identity<LotteryRecordRecord, UInteger> getIdentity() {
