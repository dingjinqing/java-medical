...
public class Shipping extends TableImpl<ShippingRecord> {
    ...
    private static final long serialVersionUID = -477395877;

    /**
     * The reference instance of <code>mini_shop_1.b2c_shipping</code>
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_shipping.shipping_id</code>.
     */
    public final TableField<ShippingRecord, UByte> SHIPPING_ID = createField("shipping_id", org.jooq.impl.SQLDataType.TINYINTUNSIGNED.nullable(false).identity(true), this, "");

    /**
     * The column <code>mini_shop_1.b2c_shipping.shipping_code</code>.
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_shipping.shipping_name</code>.
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_shipping.shipping_desc</code>.
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_shipping.insure</code>.
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_shipping.support_cod</code>.
     */
    public final TableField<ShippingRecord, UByte> SUPPORT_COD = createField("support_cod", org.jooq.impl.SQLDataType.TINYINTUNSIGNED.nullable(false).defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.TINYINTUNSIGNED)), this, "");

    /**
     * The column <code>mini_shop_1.b2c_shipping.enabled</code>.
     */
    public final TableField<ShippingRecord, UByte> ENABLED = createField("enabled", org.jooq.impl.SQLDataType.TINYINTUNSIGNED.nullable(false).defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.TINYINTUNSIGNED)), this, "");

    /**
     * The column <code>mini_shop_1.b2c_shipping.shipping_print</code>.
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_shipping.print_model</code>.
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_shipping.shipping_order</code>.
     */
    public final TableField<ShippingRecord, UByte> SHIPPING_ORDER = createField("shipping_order", org.jooq.impl.SQLDataType.TINYINTUNSIGNED.nullable(false).defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.TINYINTUNSIGNED)), this, "");

    /**
     * Create a <code>mini_shop_1.b2c_shipping</code> table reference
     */
    public Shipping() {
    ...
    /**
     * Create an aliased <code>mini_shop_1.b2c_shipping</code> table reference
     */
     ...
     */
    @Override
    public Identity<ShippingRecord, UByte> getIdentity() {
