...
public class RefundAmountRecordRecord extends UpdatableRecordImpl<RefundAmountRecordRecord> implements Record7<Integer, String, Integer, String, BigDecimal, Timestamp, Integer> {

    private static final long serialVersionUID = 902407611;
     ...
     */
    @Override
    public Row7<Integer, String, Integer, String, BigDecimal, Timestamp, Integer> fieldsRow() {
     ...
     */
    @Override
    public Row7<Integer, String, Integer, String, BigDecimal, Timestamp, Integer> valuesRow() {
     ...
     */
    @Override
    public RefundAmountRecordRecord values(Integer value1, String value2, Integer value3, String value4, BigDecimal value5, Timestamp value6, Integer value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public RefundAmountRecordRecord(Integer recId, String orderSn, Integer userId, String refundField, BigDecimal refundMoney, Timestamp refundTime, Integer retId) {
        super(RefundAmountRecord.REFUND_AMOUNT_RECORD);
