...
public class RecordAdminAction extends TableImpl<RecordAdminActionRecord> {
    ...
    private static final long serialVersionUID = 908923545;

    /**
     * The reference instance of <code>mini_shop12.b2c_record_admin_action</code>
     */
    ...
    /**
     * The column <code>mini_shop12.b2c_record_admin_action.id</code>. id
     */
    ...
    /**
     * The column <code>mini_shop12.b2c_record_admin_action.sys_id</code>. 操作员id
     */
    ...
    /**
     * The column <code>mini_shop12.b2c_record_admin_action.account_id</code>. sub操作员id
     */
    ...
    /**
     * The column <code>mini_shop12.b2c_record_admin_action.action_type</code>. 操作类型
     */
    ...
    /**
     * The column <code>mini_shop12.b2c_record_admin_action.template_id</code>. 模版id
     */
    public final TableField<RecordAdminActionRecord, String> TEMPLATE_ID = createField("template_id", org.jooq.impl.SQLDataType.VARCHAR(200).nullable(false), this, "模版id");

    /**
     * The column <code>mini_shop12.b2c_record_admin_action.create_time</code>. 助力时间
     */
    public final TableField<RecordAdminActionRecord, Timestamp> CREATE_TIME = createField("create_time", org.jooq.impl.SQLDataType.TIMESTAMP.defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "助力时间");

    /**
     * The column <code>mini_shop12.b2c_record_admin_action.update_time</code>. 更新时间
     */
    public final TableField<RecordAdminActionRecord, Timestamp> UPDATE_TIME = createField("update_time", org.jooq.impl.SQLDataType.TIMESTAMP.defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "更新时间");

    /**
     * The column <code>mini_shop12.b2c_record_admin_action.template_data</code>.
     */
    public final TableField<RecordAdminActionRecord, String> TEMPLATE_DATA = createField("template_data", org.jooq.impl.SQLDataType.VARCHAR(100).nullable(false), this, "");

    /**
     * The column <code>mini_shop12.b2c_record_admin_action.mobile</code>. 操作员手机号
     */
    ...
    /**
     * The column <code>mini_shop12.b2c_record_admin_action.user_name</code>. 操作员名称
     */
    ...
    /**
     * Create a <code>mini_shop12.b2c_record_admin_action</code> table reference
     */
    ...
    /**
     * Create an aliased <code>mini_shop12.b2c_record_admin_action</code> table reference
     */
