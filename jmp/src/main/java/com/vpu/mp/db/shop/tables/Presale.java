...
public class Presale extends TableImpl<PresaleRecord> {
    ...
    private static final long serialVersionUID = -324986989;

    /**
     * The reference instance of <code>mini_shop_1.b2c_presale</code>
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_presale.id</code>. 活动ID
     */
    public final TableField<PresaleRecord, UInteger> ID = createField("id", org.jooq.impl.SQLDataType.INTEGERUNSIGNED.nullable(false).identity(true), this, "活动ID");

    /**
     * The column <code>mini_shop_1.b2c_presale.presale_type</code>. 预售类型1：全款
     */
    public final TableField<PresaleRecord, Byte> PRESALE_TYPE = createField("presale_type", org.jooq.impl.SQLDataType.TINYINT.nullable(false).defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.TINYINT)), this, "预售类型1：全款");

    /**
     * The column <code>mini_shop_1.b2c_presale.presale_name</code>. 预售活动名称
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_presale.pre_pay_step</code>. 定金期数1|2
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_presale.pre_start_time</code>. 定金一期支付开始时间
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_presale.pre_end_time</code>. 定金一期支付结束时间
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_presale.pre_start_time_2</code>. 定金二期支付开始时间
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_presale.pre_end_time_2</code>. 定金二期支付结束时间
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_presale.start_time</code>. 尾款支付开始时间
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_presale.end_time</code>. 尾款支付结束时间
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_presale.goods_id</code>. 商品ID
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_presale.deliver_type</code>. 发货时间模式1:deliver_time;2:deliver_days
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_presale.deliver_time</code>. 发货日期
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_presale.deliver_days</code>. 下单后几日发货
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_presale.discount_type</code>. 优惠策略1:可叠加0:不可叠加
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_presale.return_type</code>. 退定金模式1:自动退定金0:不退定金
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_presale.show_sale_number</code>. 是否显示销量1:显示
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_presale.buy_type</code>. 是否支持原价1:支持
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_presale.buy_number</code>. 单用户最多可购买数量
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_presale.status</code>. 状态1:启用0:停用
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_presale.del_flag</code>. 删除状态1:删除
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_presale.add_time</code>.
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_presale.update_time</code>.
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_presale.share_config</code>. 分享设置
     */
    public final TableField<PresaleRecord, String> SHARE_CONFIG = createField("share_config", org.jooq.impl.SQLDataType.CLOB, this, "分享设置");

    /**
     * Create a <code>mini_shop_1.b2c_presale</code> table reference
     */
    public Presale() {
    ...
    /**
     * Create an aliased <code>mini_shop_1.b2c_presale</code> table reference
     */
     ...
     */
    @Override
    public Identity<PresaleRecord, UInteger> getIdentity() {
