...
public class UserAccount extends TableImpl<UserAccountRecord> {
    ...
    private static final long serialVersionUID = -961609438;

    /**
     * The reference instance of <code>mini_shop_1.b2c_user_account</code>
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_user_account.id</code>.
     */
    public final TableField<UserAccountRecord, UInteger> ID = createField("id", org.jooq.impl.SQLDataType.INTEGERUNSIGNED.nullable(false).identity(true), this, "");

    /**
     * The column <code>mini_shop_1.b2c_user_account.user_id</code>.
     */
    public final TableField<UserAccountRecord, UInteger> USER_ID = createField("user_id", org.jooq.impl.SQLDataType.INTEGERUNSIGNED.nullable(false).defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.INTEGERUNSIGNED)), this, "");

    /**
     * The column <code>mini_shop_1.b2c_user_account.admin_user</code>. 操作员
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_user_account.order_sn</code>. 分销订单结算产生返利
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_user_account.amount</code>. 金额
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_user_account.add_time</code>. 创建时间
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_user_account.admin_note</code>. 操作员备注
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_user_account.payment</code>. 支付方式
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_user_account.is_paid</code>. 支付类型，0：充值，1：消费
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_user_account.remark</code>. 备注
     */
    ...
    /**
     * The column <code>mini_shop_1.b2c_user_account.source</code>. 1:分销来源，0:充值
     */
    ...
    /**
     * Create a <code>mini_shop_1.b2c_user_account</code> table reference
     */
    public UserAccount() {
    ...
    /**
     * Create an aliased <code>mini_shop_1.b2c_user_account</code> table reference
     */
