...
public class UploadedImagePojo implements Serializable {
    ...
    public UploadedImagePojo() {}

    public UploadedImagePojo(UploadedImagePojo value) {
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("UploadedImagePojo (");
