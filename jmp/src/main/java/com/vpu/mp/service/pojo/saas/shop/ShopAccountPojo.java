...
public class ShopAccountPojo implements Serializable {
    ...
    public ShopAccountPojo() {}

    public ShopAccountPojo(ShopAccountPojo value) {
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("ShopAccountPojo (");
