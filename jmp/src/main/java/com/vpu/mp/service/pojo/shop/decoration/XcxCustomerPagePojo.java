...
public class XcxCustomerPagePojo implements Serializable {
    ...
    public XcxCustomerPagePojo() {}

    public XcxCustomerPagePojo(XcxCustomerPagePojo value) {
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("XcxCustomerPagePojo (");
