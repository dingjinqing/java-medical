...
public class PageService extends BaseVisitService {
    ...
    public PageVisitVo getPageVisit(VisitPageParam param) {
        ...
        Field<? extends Number> orderByField = param.getField();
        Result<MpVisitPageRecord> result = getPageVisitResult(startDate, endDate, sortField, orderByField);
    ...
    private Result<MpVisitPageRecord> getPageVisitResult(
            String startDate, String endDate, SortField<?> orderBy, GroupField orderByField) {
        return db().select(
