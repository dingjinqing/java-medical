...
create table `b2c_user` (
  ...
  `look_collect_time`   timestamp               default '0000-00-00 00:00:00' 	comment '最近看见收藏有礼图标时间',
...
create table `b2c_user_address` (
  ...
  `last_used_time`   timestamp				default '0000-00-00 00:00:00',
...
create table `b2c_order_info` (
  ...
  `create_time`      	 timestamp    	default current_timestamp,
  `update_time`      	 timestamp     	default current_timestamp on update current_timestamp comment '最后修改时间',
  `confirm_time`         timestamp          	default '0000-00-00 00:00:00' comment '订单确收收货时间',
  `pay_time`             timestamp            	default '0000-00-00 00:00:00' comment '支付时间',
  `shipping_time`        timestamp             	default '0000-00-00 00:00:00' comment '发货时间',
  `closed_time`          timestamp             	default '0000-00-00 00:00:00' comment '关闭时间',
  `cancelled_time`       timestamp            	default '0000-00-00 00:00:00' comment '取消时间',
  `finished_time`        timestamp            	default '0000-00-00 00:00:00' comment '订单完成时间',
  `return_time`          timestamp             	default '0000-00-00 00:00:00' comment '订单申请退货时间',
  `return_finish_time`   timestamp             	default '0000-00-00 00:00:00' comment '订单退货完成时间',
  `refund_time`          timestamp             	default '0000-00-00 00:00:00' comment '订单申请退款时间',
  `refund_finish_time`   timestamp            	default '0000-00-00 00:00:00' comment '订单退款完成时间',
  ...
  `expire_time`          timestamp             	default '0000-00-00 00:00:00' comment '订单支付过期时间',
  `del_time`		     timestamp      		default '0000-00-00 00:00:00' comment '删除时间',
  ...
  `grouper_cheap_reduce` decimal(10, 2)        	not null default 0 comment '团长优惠金额',
  `bk_shipping_time`     timestamp            	default '0000-00-00 00:00:00' comment '定金预计发货时间',
...
create table `b2c_customer_avail_coupons` (
  ...
  `notify_time`        timestamp       	default '0000-00-00 00:00:00' comment '通知时间',
...
create table `b2c_mrking_voucher` (
  ...
  `use_consume_restrict` tinyint(1)            	not null default '0',
  `least_consume`        mediumint(5)  			not null default '0',
  `use_explain`          varchar(256)          	not null default '',
  `enabled`              tinyint(1)    			not null default '1',
  `is_random`            tinyint(1)            	not null default '0',
  `most_denomination`    mediumint(5)  			not null default '0',
  `receive_per_person`   smallint(3)          	not null default '0',
  ...
  `recommend_cat_id`     text                  	comment '指定品牌可用',
  `validity`             mediumint(11) 			not null default 0   	comment '优惠券有效天数',
  `activity_names`       varchar(50)          	not null default '' comment '分裂优惠卷活动名称',
  `act_start_time`       timestamp             	default '0000-00-00 00:00:00' comment '分裂优惠卷活动起始时间',
  `act_end_time`         timestamp            	default '0000-00-00 00:00:00' comment '分裂优惠卷活动结束时间',
  ...
  `coupon_ids`           varchar(50)            default null comment '支付送券的优惠券id',
  ...
  `pay_reward_img_path`  varchar(500)  			not null default '' 	comment '支付有礼跳转活动图片路径',
  `pay_reward_url`       varchar(500)  			not null default '' 	comment '支付有礼跳转活动链接',
...
create table `b2c_payment_record` (
  ...
  `gmt_create`          timestamp              	default '0000-00-00 00:00:00' comment '支付交易创建时间',
  `notify_time`         timestamp            	default '0000-00-00 00:00:00' comment '通知时间',
  `gmt_pay_time`        timestamp              	default '0000-00-00 00:00:00' comment '交易付款时间',
  `gmt_close_time`      timestamp              	default '0000-00-00 00:00:00' comment '交易关闭时间',
  `created`             timestamp             	default '0000-00-00 00:00:00' comment '插入时间',
...
create table `b2c_income_outcome_detail` (
  ...
  `pay_act_time`             timestamp             	default '0000-00-00 00:00:00' comment '交易付款时间',
  ...
  `update_order_status_time` timestamp             	default '0000-00-00 00:00:00' comment '更新订单状态时间',
...
create table `b2c_return_order` (
  ...
  `apply_time`              timestamp               default '0000-00-00 00:00:00' comment '退货且退货提交审核时间，对应refund_status=1',
  `apply_pass_time`         timestamp              	default '0000-00-00 00:00:00' comment '审核通过时间，对应refund_status=2',
  `apply_not_pass_time`     timestamp              	default '0000-00-00 00:00:00' comment '审核未通过时间，对应refund_status=3',
  `shipping_or_refund_time` timestamp              	default '0000-00-00 00:00:00' comment '只退款时为退款申请时间，退货又退款时为提交物流信息时间，对应refund_status=4',
  `refund_success_time`     timestamp              	default '0000-00-00 00:00:00' comment '退款成功时间，对应refund_status=5',
  `refund_refuse_time`      timestamp              	default '0000-00-00 00:00:00' comment '退款拒绝时间，对应refund_status=6',
  `refund_cancel_time`      timestamp              	default '0000-00-00 00:00:00' comment '退款撤销时间，对应refund_status=7',
...
create table `b2c_part_order_goods_ship` (
  ...
  `shipping_name`  varchar(120)    		not null default '' comment '快递名称',
  `shipping_id`    tinyint(3)      		not null default '0' comment '快递id',
  `shipping_time`  timestamp       	default current_timestamp comment '部分发货时间',
  `confirm_time`   timestamp       	default '0000-00-00 00:00:00' comment '订单确收收货时间',
  `create_time`    timestamp    	default current_timestamp,
  `update_time`    timestamp     	default current_timestamp on update current_timestamp comment '最后修改时间',
  primary key (`rec_id`),
...
create table `b2c_user_card` (
  ...
  `activation_time` timestamp            		default '0000-00-00 00:00:00' comment '激活时间',
...
create table `b2c_member_card` (
  ...
  `start_time`        timestamp    							              default '0000-00-00 00:00:00' comment '开始日期',
  `end_time`          timestamp                               default '0000-00-00 00:00:00' comment '结束日期',
...
create table `b2c_give_voucher` (
  ...
  `start_time` 		timestamp 		default '0000-00-00 00:00:00' comment '发放开始时间',
  `create_time`		timestamp       default current_timestamp,
  `update_time` 	timestamp     	default current_timestamp on update current_timestamp comment '最后修改时间',
  primary key (`id`)
);
...
create table `b2c_mp_template_form_id` (
  ...
  `user_visit_time`     timestamp             default '0000-00-00 00:00:00' comment '用户点击访问时间',
  `use_time`            timestamp             default '0000-00-00 00:00:00' comment '使用时间',
  `create_time`			timestamp      default current_timestamp,
  `update_time` 		timestamp      default current_timestamp on update current_timestamp comment '最后修改时间',
  primary key (`rec_id`),
  key (`form_id`),
...
create table `b2c_pin_group_list` (
  ...
  `start_time`      timestamp    default '0000-00-00 00:00:00' comment '开团时间',
  `end_time`        timestamp    default '0000-00-00 00:00:00' comment '成团时间',
  `create_time`			timestamp      default current_timestamp,
  `update_time` 		timestamp      default current_timestamp on update current_timestamp comment '最后修改时间',
  primary key (`id`)
);
...
create table `b2c_template_config` (
  ...
  `start_time`     timestamp        default '0000-00-00 00:00:00' comment '发送起始时间',
  `end_time`       timestamp        default '0000-00-00 00:00:00' comment '发送终止时间',
  `del_flag`       tinyint(1)       not null default 0 comment '删除标识',
  `del_time`       timestamp        default '0000-00-00 00:00:00',
  `create_time`		timestamp      default current_timestamp,
  `update_time` 	timestamp      default current_timestamp on update current_timestamp comment '最后修改时间',
  primary key (`id`)
);
...
create table `b2c_service_request` (
  ...
  `request_time`     timestamp          default '0000-00-00 00:00:00' comment '请求时间',
  `response_time`    timestamp          default '0000-00-00 00:00:00' comment '响应时间',
...
create table `b2c_join_group_list` (
  ...
  `open_time`       timestamp               default '0000-00-00 00:00:00' comment '开团时间',
  `end_time`        timestamp               default '0000-00-00 00:00:00' comment '成团时间(达到最小成团数量就记录)',
  `draw_time`       timestamp               default '0000-00-00 00:00:00' comment '开奖时间',
...
create table `b2c_trades_record` (
  ...
  `trade_time`    timestamp                      default '0000-00-00 00:00:00' comment '交易时间',
...
create table `b2c_distribution_withdraw` (
  ...
  `check_time`        timestamp                                        default '0000-00-00 00:00:00'  comment '审核时间',
  `refuse_time`       timestamp                                        default '0000-00-00 00:00:00'  comment '驳回时间',
  `billing_time`      timestamp                                        default '0000-00-00 00:00:00'  comment '出账时间',
  `fail_time`         timestamp                                        default '0000-00-00 00:00:00'  comment '失败时间',
  `desc_time`         timestamp                                        default '0000-00-00 00:00:00'  comment '备注时间',
  `del_flag`          tinyint(1)                             not null default '0',
  `del_time`		  timestamp      	default '0000-00-00 00:00:00' comment '删除时间',
...
create table `b2c_card_order` (
  ...
  `return_time`       timestamp                  default '0000-00-00 00:00:00' comment '退款时间',
  `del_time`       	timestamp                    default '0000-00-00 00:00:00' comment '退款时间',
  `create_time`		timestamp      	default current_timestamp,
  `update_time` 	timestamp      	default current_timestamp on update current_timestamp comment '最后修改时间',
  primary key (`order_id`)
);
...
create table `b2c_card_examine` (
  ...
  `pass_time`      timestamp                    default '0000-00-00 00:00:00' comment '通过时间',
  `refuse_time`    timestamp                    default '0000-00-00 00:00:00' comment '拒绝时间',
  `refuse_desc`    varchar(512)                 null comment '拒绝理由',
  `del_flag`       tinyint(1)                   not null default '0' comment '删除',
  `def_time`       timestamp                    default '0000-00-00 00:00:00' comment '删除时间',
  `create_time`		timestamp      	default current_timestamp,
  `update_time` 	timestamp      	default current_timestamp on update current_timestamp comment '最后修改时间',
  primary key (`id`)
);
...
create table `b2c_sub_order_info` (
  ...
  `pay_time`      timestamp default '0000-00-00 00:00:00' comment '支付时间',
  `refund_time`   timestamp default '0000-00-00 00:00:00' comment '最近一次退款时间',
  `del_flag`      tinyint(1)              default 0,
  `del_time`	  timestamp      	default '0000-00-00 00:00:00' comment '删除时间',
  `create_time`		timestamp      	default current_timestamp,
  `update_time` 	timestamp      	default current_timestamp on update current_timestamp comment '最后修改时间',
...
create table `b2c_card_receive_code`(
  ...
  `receive_time` 	timestamp 		default '0000-00-00 00:00:00'   comment '领取时间',
...
create table `b2c_user_rebate_price` (
  ...
  `expire_time` 	timestamp 		default '0000-00-00 00:00:00' comment '过期时间',
  `create_time`		timestamp      	default current_timestamp,
  `update_time` 	timestamp      	default current_timestamp on update current_timestamp comment '最后修改时间',
  primary key (`id`)
);
...
create table `b2c_search_history`(
  ...
  `del_flag` 		tinyint(1) 		not null default 0,
  `del_time` 		timestamp 		default '0000-00-00 00:00:00' comment '过期时间',
  `create_time`		timestamp      	default current_timestamp,
  `update_time` 	timestamp      	default current_timestamp on update current_timestamp comment '最后修改时间',
  index `user_id` (`user_id`),
