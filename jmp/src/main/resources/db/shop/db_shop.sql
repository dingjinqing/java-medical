...
create table `b2c_user` (
  ...
  `look_collect_time`   timestamp               default null 	comment '最近看见收藏有礼图标时间',
...
create table `b2c_order_info` (
  ...
  `create_time`      	 timestamp    	default current_timestamp,
  `update_time`      	 timestamp     	default current_timestamp on update current_timestamp comment '最后修改时间',
  `confirm_time`         timestamp          	default null comment '订单确收收货时间',
  `pay_time`             timestamp            	default null comment '支付时间',
  `shipping_time`        timestamp             	default null comment '发货时间',
  `closed_time`          timestamp             	default null comment '关闭时间',
  `cancelled_time`       timestamp            	default null comment '取消时间',
  `finished_time`        timestamp            	default null comment '订单完成时间',
  `return_time`          timestamp             	default null comment '订单申请退货时间',
  `return_finish_time`   timestamp             	default null comment '订单退货完成时间',
  `refund_time`          timestamp             	default null comment '订单申请退款时间',
  `refund_finish_time`   timestamp            	default null comment '订单退款完成时间',
  ...
  `expire_time`          timestamp             	default null comment '订单支付过期时间',
  ...
  `bk_shipping_time`     timestamp            	default null comment '定金预计发货时间',
...
create table `b2c_customer_avail_coupons` (
  ...
  `notify_time`        timestamp       	default null comment '通知时间',
...
create table `b2c_mrking_voucher` (
  ...
  `act_start_time`       timestamp             	default null comment '分裂优惠卷活动起始时间',
  `act_end_time`         timestamp            	default null comment '分裂优惠卷活动结束时间',
...
create table `b2c_payment_record` (
  ...
  `gmt_create`          timestamp              	default null comment '支付交易创建时间',
  `notify_time`         timestamp            	default null comment '通知时间',
  `gmt_pay_time`        timestamp              	default null comment '交易付款时间',
  `gmt_close_time`      timestamp              	default null comment '交易关闭时间',
  `created`             timestamp             	default null comment '插入时间',
...
create table `b2c_income_outcome_detail` (
  ...
  `pay_act_time`             timestamp             	default null comment '交易付款时间',
  ...
  `update_order_status_time` timestamp             	default null comment '更新订单状态时间',
...
create table `b2c_return_order` (
  ...
  `apply_time`              timestamp               default null comment '退货且退货提交审核时间，对应refund_status=1',
  `apply_pass_time`         timestamp              	default null comment '审核通过时间，对应refund_status=2',
  `apply_not_pass_time`     timestamp              	default null comment '审核未通过时间，对应refund_status=3',
  `shipping_or_refund_time` timestamp              	default null comment '只退款时为退款申请时间，退货又退款时为提交物流信息时间，对应refund_status=4',
  `refund_success_time`     timestamp              	default null comment '退款成功时间，对应refund_status=5',
  `refund_refuse_time`      timestamp              	default null comment '退款拒绝时间，对应refund_status=6',
  `refund_cancel_time`      timestamp              	default null comment '退款撤销时间，对应refund_status=7',
...
create table `b2c_member_card` (
  ...
  `start_time`        timestamp    							  default null comment '开始日期',
  `end_time`          timestamp                               default null comment '结束日期',
...
create table `b2c_give_voucher` (
  ...
  `start_time` 		timestamp 		not null comment '发放开始时间',
  `create_time`		timestamp       default current_timestamp,
  `update_time` 	timestamp     	default current_timestamp on update current_timestamp comment '最后修改时间',
  primary key (`id`)
);
...
create table `b2c_service_order` (
  ...
  `order_amount`      decimal(10, 2)          not null default '0.00' comment '订单总金额',
  `create_time`       timestamp                    default null comment '订单提交时间',
  `pay_time`          timestamp                    default null comment '支付时间',
  `cancelled_time`    timestamp                    default null comment '取消时间',
  `finished_time`     timestamp                    default null comment '订单完成时间',
...
create table `b2c_code` (
  ...
  `create_time`   	timestamp           default null comment '添加时间',
...
create table `b2c_mp_template_form_id` (
  ...
  `user_visit_time`     timestamp             default null comment '用户点击访问时间',
...
create table `b2c_pin_group_list` (
  ...
  `start_time`      timestamp    not null comment '开团时间',
  `end_time`        timestamp    not null comment '成团时间',
  `create_time`			timestamp      default current_timestamp,
  `update_time` 		timestamp      default current_timestamp on update current_timestamp comment '最后修改时间',
  primary key (`id`)
);
...
create table `b2c_template_config` (
  ...
  `start_time`     timestamp        not null default null comment '发送起始时间',
  `end_time`       timestamp        not null default null comment '发送终止时间',
  `del_flag`       tinyint(1)       not null default 0 comment '删除标识',
  `del_time`       timestamp        not null default 0,
  `create_time`		timestamp      default current_timestamp,
  `update_time` 	timestamp      default current_timestamp on update current_timestamp comment '最后修改时间',
  primary key (`id`)
);
...
create table `b2c_coupon_activity` (
  ...
  `start_date`        timestamp             not null comment '有效期-起始',
  `end_date`          timestamp             not null comment '有效期-结束',
...
create table `b2c_integral_mall_define` (
  ...
  `end_time`         timestamp      not null comment '活动终止时间',
...
create table `b2c_lottery_record` (
  ...
  `lottery_expired_time` timestamp  not null  comment '赠品过期时间',
  `create_time`		timestamp      	default current_timestamp,
  `update_time` 	timestamp      	default current_timestamp on update current_timestamp comment '最后修改时间',
  primary key (`id`),
  key `user_lottery` (`user_id`, `lottery_id`),
...
create table `b2c_join_group_list` (
  ...
  `open_time`       timestamp               default null comment '开团时间',
  `end_time`        timestamp               default null comment '成团时间(达到最小成团数量就记录)',
...
create table `b2c_pin_integration_list` (
  ...
  `is_grouper`       tinyint(1)                             not null default '0' comment '是否为团长 1：是 0：否',
  `status`           tinyint(1)                             not null default '0' comment '0: 拼团中 1:拼团成功 2:拼团失败',
  `start_time`       timestamp                               not null comment '参团时间',
  `end_time`         timestamp                               not null comment '成团时间',
...
create table `b2c_trades_record` (
  ...
  `trade_time`    timestamp                      default null comment '交易时间',
...
create table `b2c_distribution_withdraw` (
  ...
  `check_time`        timestamp                                        default null  comment '审核时间',
  `refuse_time`       timestamp                                        default null  comment '驳回时间',
  `billing_time`      timestamp                                        default null  comment '出账时间',
  `fail_time`         timestamp                                        default null  comment '失败时间',
  `desc_time`         timestamp                                        default null  comment '备注时间',
  `del_flag`          tinyint(1)                             not null default '0',
  `del_time`		  timestamp      	default '0000-00-00 00:00:00' comment '删除时间',
...
create table `b2c_card_order` (
  ...
  `del_time`       	timestamp                    null comment '退款时间',
  `create_time`		timestamp      	default current_timestamp,
  `update_time` 	timestamp      	default current_timestamp on update current_timestamp comment '最后修改时间',
  primary key (`order_id`)
);
...
create table `b2c_sub_order_info` (
  ...
  `refund_time`   timestamp comment '最近一次退款时间',
  `del_flag`      tinyint(1)              default 0,
  `del_time`	  timestamp      	default '0000-00-00 00:00:00' comment '删除时间',
  `create_time`		timestamp      	default current_timestamp,
  `update_time` 	timestamp      	default current_timestamp on update current_timestamp comment '最后修改时间',
...
create table `b2c_friend_promote_launch` (
  ...
  `success_time`         timestamp             not null default null comment '助力成功时间',
  `del_flag`             tinyint(1)            not null default 0 comment '删除标识：0未删除，1已删除',
  `del_time` 			timestamp 		default '0000-00-00 00:00:00' comment '过期时间',
  `create_time`			timestamp      	default current_timestamp,
  `update_time` 		timestamp      	default current_timestamp on update current_timestamp comment '最后修改时间',
