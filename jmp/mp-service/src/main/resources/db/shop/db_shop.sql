...
CREATE TABLE `b2c_goods` (
    ...
    `reason` text COLLATE utf8mb4_unicode_ci COMMENT '违规下架原因',
    ...
    `unit` varchar(60) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '商品单位',
    ...
    `goods_video` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '视频',
    `goods_video_img` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '视频首图',
...
-- 医师问诊订单返利表
CREATE TABLE `b2c_inquiry_order_rebate` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
