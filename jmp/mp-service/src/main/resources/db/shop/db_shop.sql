...
create table `b2c_goods` (
  ...
  `promotion_language` varchar(400) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '推广语',
  `deliver_place` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '发货地址',
  `share_config` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '分享配置',
...
`main_order_sn` VARCHAR ( 20 ) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '主订单编号(拆单时用)',
`user_id` MEDIUMINT ( 8 ) NOT NULL DEFAULT '0' COMMENT '用户id',
`user_openid` VARCHAR ( 191 ) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '用户openid',
`order_status` TINYINT ( 1 ) NOT NULL DEFAULT '0' COMMENT '订单状态',
`order_status_name` VARCHAR ( 32 ) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '订单状态名称',
`consignee` VARCHAR ( 60 ) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '收件人姓名',
`address_id` INT ( 11 ) NOT NULL DEFAULT '0' COMMENT '地址id',
`country_code` MEDIUMINT ( 10 ) NOT NULL DEFAULT '0' COMMENT '国家编号',
`country_name` VARCHAR ( 50 ) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '国家名称',
`province_code` MEDIUMINT ( 10 ) NOT NULL DEFAULT '0' COMMENT '省份编号',
`province_name` VARCHAR ( 50 ) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '省份名称',
`city_code` MEDIUMINT ( 10 ) NOT NULL DEFAULT '0' COMMENT '城市编号',
`city_name` VARCHAR ( 120 ) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '城市名称',
`district_code` MEDIUMINT ( 10 ) NOT NULL DEFAULT '0' COMMENT '区县编号',
`district_name` VARCHAR ( 120 ) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '区县名称',
`address` VARCHAR ( 191 ) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '更多详细地址',
`complete_address` VARCHAR ( 512 ) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '完整收件地址',
`zipcode` VARCHAR ( 60 ) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '邮编',
`mobile` VARCHAR ( 60 ) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '手机号',
`add_message` VARCHAR ( 191 ) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '客户留言',
`shipping_id` TINYINT ( 3 ) NOT NULL DEFAULT '0' COMMENT '快递id',
`shipping_name` VARCHAR ( 120 ) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '快递名称',
`pay_code` VARCHAR ( 30 ) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '支付代号',
`pay_name` VARCHAR ( 120 ) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '支付名称',
...
`shipping_no` VARCHAR ( 191 ) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '快递单号',
`shipping_type` VARCHAR ( 60 ) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '快递类型',
...
`seller_remark` VARCHAR ( 512 ) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '卖家备注',
`erpordercode` VARCHAR ( 32 ) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT 'erp中订单代码',
...
`fanli_grade` VARCHAR ( 64 ) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '返利等级',
...
`invoice_title` text COLLATE utf8mb4_unicode_ci COMMENT '发票内容：json存储',
`refund_status` TINYINT ( 1 ) NOT NULL DEFAULT '0' COMMENT '1是审核中，2是通过审核，3退货没通过审核，4买家再次提交申请，5：退款退货成功，6是拒绝退款退货',
`pay_order_sn` VARCHAR ( 30 ) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '对账单号',
`goods_type` VARCHAR ( 50 ) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0' COMMENT '商品类型，0普通商品，1拼团商品，2分销，3砍价商品 4积分商品 5秒杀商品 6限时降价 7加价购',
...
`order_pay_way` TINYINT ( 2 ) NOT NULL DEFAULT '0' COMMENT '订单付款方式，0全款 1含定金尾款的支付',
`bk_order_sn` VARCHAR ( 32 ) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '补款订单号 order_pay_way=1时有效',
`bk_order_money` DECIMAL ( 10, 2 ) NOT NULL DEFAULT '0.00' COMMENT '补款金额 order_pay_way=1时有效',
`bk_order_paid` TINYINT ( 1 ) NOT NULL DEFAULT '0' COMMENT '定金尾款支付状态，先定金后尾款。order_pay_way=1时有效，0未支付，1定金已支付，2尾款已支付',
...
`source` VARCHAR ( 30 ) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '订单来源，记录app，wap，pc来源',
...
`push_desc` VARCHAR ( 100 ) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT 'yadu推送失败原因',
`pos_flag` TINYINT ( 1 ) NOT NULL DEFAULT '0' COMMENT '门店订单标志：0：商城，1：门店同步订单',
`pos_shop_name` VARCHAR ( 191 ) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT 'pos店铺名称',
`store_id` INT ( 11 ) DEFAULT '0' COMMENT '门店id',
`store_name` VARCHAR ( 191 ) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '门店名称',
...
`del_time` TIMESTAMP NULL DEFAULT NULL COMMENT '删除时间',
`prepay_id` VARCHAR ( 191 ) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '微信支付id，用于发送模板消息',
`deliver_type` TINYINT ( 1 ) NOT NULL DEFAULT '0' COMMENT '配送类型：0 快递 1 自提',
`deliver_type_name` VARCHAR ( 191 ) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '配送类型名称',
`pickupdate_time` VARCHAR ( 30 ) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '自提时间',
`star_flag` TINYINT ( 1 ) NOT NULL DEFAULT '0' COMMENT '标星订单：0 未标星 1 标星',
`verify_code` VARCHAR ( 191 ) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '核销自提码',
`split` INT ( 11 ) NOT NULL DEFAULT '0' COMMENT '分裂优惠券id',
`card_no` VARCHAR ( 32 ) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '会员卡号',
`fanli_money` DECIMAL ( 10, 2 ) NOT NULL DEFAULT '0.00' COMMENT '单品返利金额',
`true_name` VARCHAR ( 32 ) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '真实姓名',
`id_card` VARCHAR ( 32 ) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '身份证号',
`ali_trade_no` VARCHAR ( 60 ) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '支付宝交易单号',
...
`instead_pay` text COLLATE utf8mb4_unicode_ci COMMENT '好友代付规则',
...
`product_sn` VARCHAR ( 65 ) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
`goods_number` SMALLINT ( 5 ) NOT NULL DEFAULT '1',
`market_price` DECIMAL ( 10, 2 ) NOT NULL DEFAULT '0.00',
`goods_price` DECIMAL ( 10, 2 ) NOT NULL DEFAULT '0.00',
`goods_attr` text COLLATE utf8mb4_unicode_ci NOT NULL,
...
`goods_attr_id` VARCHAR ( 191 ) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
`goods_img` VARCHAR ( 191 ) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
`refund_status` TINYINT ( 1 ) NOT NULL DEFAULT '0' COMMENT '1是审核中，2是通过审核，3退货没通过审核，4买家再次提交申请，5：退款退货成功，6是拒绝退款退货',
`comment_flag` TINYINT ( 1 ) NOT NULL DEFAULT '0' COMMENT '0:未评论，1:已评论，2：已晒单',
...
`r_goods` VARCHAR ( 191 ) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '赠品的关联商品',
...
`discount_detail` text COLLATE utf8mb4_unicode_ci COMMENT '打折详情，json存储',
...
`fanli_strategy` VARCHAR ( 666 ) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '返利比例',
`fanli_percent` DECIMAL ( 10, 2 ) DEFAULT '0.00' COMMENT '返利比例',
`cost_price` DECIMAL ( 10, 2 ) DEFAULT NULL COMMENT '成本价',
`is_card_exclusive` TINYINT ( 1 ) DEFAULT '0' COMMENT '是否会员卡专属',
`promote_info` VARCHAR ( 500 ) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '推广信息',
...
create table `b2c_template_config` (
  ...
  `start_time`     timestamp null default "1970-01-01 08:01:00" comment '发送起始时间',
  `end_time`       timestamp null default "1970-01-01 08:01:00" comment '发送终止时间',
...
create table `b2c_goods_bak` (
  ...
  `shop_id`      int(11)                not null default '0' comment '店铺id',
  `cat_id`       int(5)                 not null default '0' comment '平台分类',
  `sort_id`      int(11)                not null default '0' comment '商家分类',
  `brand_id`     int(11)                not null default 0 		comment '品牌id',
  `market_price` decimal(10, 2)         not null default '0.00',
  `shop_price`   decimal(10, 2)         not null default '0.00',
  `goods_number` int(11)                not null default '0' comment '库存',
