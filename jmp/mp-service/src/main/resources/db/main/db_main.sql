...
create table `b2c_article` (
  ...
  `head_pic` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '头图',
...
create table `b2c_mp_auth_shop` (
  ...
  `audit_id`              int(11)               default 0 comment '最新的审核ID',
...
create table `b2c_user` (
  ...
  `invite_source`      varchar(32)          null comment '邀请来源',
...
create table `b2c_shop_uploaded_image` (
  ...
  `img_size`       int(10)                                 not null default '0',
  `img_name`       varchar(191) collate utf8mb4_unicode_ci not null default '' comment '图片名称，用于前端显示',
  `img_orig_fname` varchar(191) collate utf8mb4_unicode_ci not null default '',
  `img_path`       varchar(191) collate utf8mb4_unicode_ci not null default '',
  `img_url`        varchar(191) collate utf8mb4_unicode_ci not null default '',
  `img_cat_id`     int(10)                                          default '0' comment '图片分类',
  `img_width`      int(10)                                 not null default '0',
  `img_height`     int(10)                                 not null default '0',
  `is_refer`       tinyint(4)                                       default '0' comment '是否引用',
...
create table `b2c_shop_uploaded_image_category` (
  `img_cat_id`        int(10)                                 not null auto_increment,
  `shop_id`           int(11)                                 not null default '0' comment '店铺ID',
  `img_cat_name`      varchar(60) collate utf8mb4_unicode_ci  not null default '',
  `img_cat_parent_id` int(10)                                 not null default '0',
  `create_time`       timestamp                               null     default CURRENT_TIMESTAMP,
  `cat_ids`           varchar(191) collate utf8mb4_unicode_ci not null default '0' comment '层级ID串,逗号分隔',
  `level`             tinyint(4)                                       default '0' comment '层级，0开始',
  `sort`              int(11)                                          default '1' comment '排序优先级',
  `sys_id`            int(11)                                 not null default '0' comment '账户ID',
  primary key (`img_cat_id`),
...
create table `b2c_shop_question_feedback` (
  ...
  `mobile`               varchar(32) collate utf8mb4_unicode_ci                                 default '' comment '填写的手机号',
  `content`              text collate utf8mb4_unicode_ci,
  `is_look`              tinyint(1)                                                             default '0' comment '1:已查看',
  `create_time`          timestamp                               null                           default CURRENT_TIMESTAMP comment '反馈时间',
  `qf_img`               varchar(191) collate utf8mb4_unicode_ci not null                       default '' comment '图片',
...
create table `b2c_qf_img` (
  ...
  `img_url`              varchar(191) collate utf8mb4_unicode_ci not null default '',
  `img_desc`             varchar(191) collate utf8mb4_unicode_ci not null default '',
  primary key (`img_id`),
...
create table `b2c_shop_free_experience` (
  ...
  `company`     varchar(191) collate utf8mb4_unicode_ci  not null default '' comment '公司',
  `contact`     varchar(191) collate utf8mb4_unicode_ci  not null default '' comment '联系人',
  `mobile`      varchar(32)  collate utf8mb4_unicode_ci           default '' comment '电话',
  `province_id` int(11)                                  not null,
  `content`     text collate utf8mb4_unicode_ci comment '留言',
  ...
  `desc`        text collate utf8mb4_unicode_ci comment '备注',
  `source`      varchar(191)  collate utf8mb4_unicode_ci not null default '' comment '来源shop_id',
...
create table `b2c_mp_jump_version` (
  `id`          int(11)                                not null auto_increment,
  `shop_id`     varchar(64) collate utf8mb4_unicode_ci not null,
...
create table `b2c_grasp_goods` (
  ...
  `goods_img`           varchar(191)                   null     default '' collate 'utf8mb4_unicode_ci',
...
create table `b2c_log_manage` (
  ...
  `error_content`    text collate utf8mb4_unicode_ci comment '错误内容',
  ...
  `request_content`  text collate utf8mb4_unicode_ci comment '请求内容 json串',
  `response_content` text collate utf8mb4_unicode_ci comment '响应内容 json串',
  `ip`               varchar(100) collate utf8mb4_unicode_ci   default null comment '请求ip',
...
create table `b2c_db_option_record` (
  ...
  `version`     varchar(10) collate utf8mb4_unicode_ci    default '' comment '版本号',
...
CREATE TABLE `b2c_task_jobs_main` (
	...
	`STATUS` TINYINT(1) DEFAULT '0' COMMENT '任务状态：0待执行,1执行中,2已完成',
	`SCHEDULE` TINYINT(3) DEFAULT '0' COMMENT '任务进度：0-100',
	`EXECUTION_TYPE` TINYINT(1) DEFAULT '0' COMMENT '执行类型：0单次(不保证全部执行成功)1周期内循环执行2定时执行',
	`CYCLE` INT(11) DEFAULT '0' COMMENT '轮循间隔(单位:秒)',
	`TYPE` TINYINT(1) DEFAULT '0' COMMENT 'task任务类型(任务标识)',
	`CREATE_TIME` TIMESTAMP NULL DEFAULT CURRENT_TIMESTAMP,
	`UPDATE_TIME` TIMESTAMP NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后修改时间',
...
CREATE TABLE `b2c_task_jobs_content` (
    `ID` INT(11) NOT NULL AUTO_INCREMENT,
    `TASK_ID` INT(11) DEFAULT '0' COMMENT 'taskID',
