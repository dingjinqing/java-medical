...
CREATE TABLE `b2c_task_job_main` (
	...
	`NEXT_EXECUTE_TIME` TIMESTAMP	NULL DEFAULT "1970-01-01 08:01:00" COMMENT "下次执行开始日期",
	`START_TIME` TIMESTAMP NULL DEFAULT "1970-01-01 08:01:00" COMMENT '周期开始时间',
	`END_TIME` TIMESTAMP NULL DEFAULT "1970-01-01 08:01:00" COMMENT '周期结束时间',
	`CREATE_TIME` TIMESTAMP NULL DEFAULT CURRENT_TIMESTAMP,
	`UPDATE_TIME` TIMESTAMP NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后修改时间',
