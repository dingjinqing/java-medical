...
--   `order_sn` varchar(20) COLLATE  NOT NULL DEFAULT '' COMMENT '订单编号',
--   `main_order_sn` varchar(20) COLLATE  NOT NULL DEFAULT '' COMMENT '主订单编号(拆单时用)',
--   `user_id` mediumint(8) NOT NULL DEFAULT '0' COMMENT '用户id',
--   `user_openid` varchar(191) COLLATE  NOT NULL DEFAULT '' COMMENT '用户openid',
--   `order_status` tinyint(1) NOT NULL DEFAULT '0' COMMENT '订单状态',
--   `order_status_name` varchar(32) COLLATE  NOT NULL DEFAULT '' COMMENT '订单状态名称',
--   `consignee` varchar(60) COLLATE  NOT NULL DEFAULT '' COMMENT '收件人姓名',
--   `address_id` int(11) NOT NULL DEFAULT '0' COMMENT '地址id',
--   `country_code` mediumint(10) NOT NULL DEFAULT '0' COMMENT '国家编号',
--   `country_name` varchar(50) COLLATE  NOT NULL DEFAULT '' COMMENT '国家名称',
--   `province_code` mediumint(10) NOT NULL DEFAULT '0' COMMENT '省份编号',
--   `province_name` varchar(50) COLLATE  NOT NULL DEFAULT '' COMMENT '省份名称',
--   `city_code` mediumint(10) NOT NULL DEFAULT '0' COMMENT '城市编号',
--   `city_name` varchar(120) COLLATE  NOT NULL DEFAULT '' COMMENT '城市名称',
--   `district_code` mediumint(10) NOT NULL DEFAULT '0' COMMENT '区县编号',
--   `district_name` varchar(120) COLLATE  NOT NULL DEFAULT '' COMMENT '区县名称',
--   `address` varchar(191) COLLATE  NOT NULL DEFAULT '' COMMENT '更多详细地址',
--   `complete_address` varchar(512) COLLATE  NOT NULL DEFAULT '' COMMENT '完整收件地址',
--   `zipcode` varchar(60) COLLATE  NOT NULL DEFAULT '' COMMENT '邮编',
--   `mobile` varchar(60) COLLATE  NOT NULL DEFAULT '' COMMENT '手机号',
--   `add_message` varchar(191) COLLATE  NOT NULL DEFAULT '' COMMENT '客户留言',
--   `shipping_id` tinyint(3) NOT NULL DEFAULT '0' COMMENT '快递id',
--   `shipping_name` varchar(120) COLLATE  NOT NULL DEFAULT '' COMMENT '快递名称',
--   `pay_code` varchar(30) COLLATE  NOT NULL DEFAULT '' COMMENT '支付代号',
--   `pay_name` varchar(120) COLLATE  NOT NULL DEFAULT '' COMMENT '支付名称',
--   `pay_sn` varchar(32) COLLATE  NOT NULL DEFAULT '' COMMENT '支付流水号',
...
--   `shipping_no` varchar(191) COLLATE  NOT NULL DEFAULT '' COMMENT '快递单号',
--   `shipping_type` varchar(60) COLLATE  NOT NULL DEFAULT '' COMMENT '快递类型',
...
--   `seller_remark` varchar(512) COLLATE  NOT NULL DEFAULT '' COMMENT '卖家备注',
--   `erpordercode` varchar(32) COLLATE  NOT NULL DEFAULT '' COMMENT 'erp中订单代码',
...
--   `fanli_grade` varchar(64) COLLATE  NOT NULL DEFAULT '' COMMENT '返利等级',
...
--   `invoice_title` text COLLATE  COMMENT '发票内容：json存储',
--   `refund_status` tinyint(1) NOT NULL DEFAULT '0' COMMENT '1是审核中，2是通过审核，3退货没通过审核，4买家再次提交申请，5：退款退货成功，6是拒绝退款退货',
--   `pay_order_sn` varchar(30) COLLATE  NOT NULL DEFAULT '' COMMENT '对账单号',
--   `goods_type` varchar(50) COLLATE  NOT NULL DEFAULT '0' COMMENT '商品类型，0普通商品，1拼团商品，2分销，3砍价商品 4积分商品 5秒杀商品 6限时降价 7加价购',
...
--   `bk_order_sn` varchar(32) COLLATE  NOT NULL DEFAULT '' COMMENT '补款订单号 order_pay_way=1时有效',
...
--   `source` varchar(30) COLLATE  NOT NULL DEFAULT '' COMMENT '订单来源，记录app，wap，pc来源',
...
--   `push_desc` varchar(100) COLLATE  NOT NULL DEFAULT '' COMMENT 'yadu推送失败原因',
--   `pos_flag` tinyint(1) NOT NULL DEFAULT '0' COMMENT '门店订单标志：0：商城，1：门店同步订单',
--   `pos_shop_name` varchar(191) COLLATE  NOT NULL DEFAULT '' COMMENT 'pos店铺名称',
--   `store_id` int(11) DEFAULT '0' COMMENT '门店id',
--   `store_name` varchar(191) COLLATE  NOT NULL DEFAULT '' COMMENT '门店名称',
...
--   `prepay_id` varchar(191) COLLATE  DEFAULT NULL COMMENT '微信支付id，用于发送模板消息',
--   `deliver_type` tinyint(1) NOT NULL DEFAULT '0' COMMENT '配送类型：0 快递 1 自提',
--   `deliver_type_name` varchar(191) COLLATE  DEFAULT NULL COMMENT '配送类型名称',
--   `pickupdate_time` varchar(30) COLLATE  DEFAULT NULL COMMENT '自提时间',
--   `star_flag` tinyint(1) NOT NULL DEFAULT '0' COMMENT '标星订单：0 未标星 1 标星',
--   `verify_code` varchar(191) COLLATE  NOT NULL DEFAULT '' COMMENT '核销自提码',
--   `split` int(11) NOT NULL DEFAULT '0' COMMENT '分裂优惠券id',
--   `card_no` varchar(32) COLLATE  NOT NULL DEFAULT '' COMMENT '会员卡号',
--   `fanli_money` decimal(10,2) NOT NULL DEFAULT '0.00' COMMENT '单品返利金额',
--   `true_name` varchar(32) COLLATE  NOT NULL DEFAULT '' COMMENT '真实姓名',
--   `id_card` varchar(32) COLLATE  NOT NULL DEFAULT '' COMMENT '身份证号',
--   `ali_trade_no` varchar(60) COLLATE  NOT NULL DEFAULT '' COMMENT '支付宝交易单号',
...
--   `bk_prepay_id` varchar(191) COLLATE  DEFAULT NULL COMMENT '微信支付id，用于发送模板消息',
...
--   `order_user_message` varchar(50) COLLATE  DEFAULT NULL COMMENT '发起人留言',
--   `instead_pay` text COLLATE  COMMENT '好友代付规则',
...
--   `currency` varchar(10) COLLATE  NOT NULL DEFAULT 'CNY' COMMENT '币种',
--   `free_ship` decimal(10,2) DEFAULT '0.00' COMMENT '运费抵扣',
--   `free_detail` text COLLATE  COMMENT '运费抵扣规则',
