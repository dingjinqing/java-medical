...
public class MrkingStrategyGoodsListVo {
    ...
    public static class FullPriceDoc{
        /**
         * 类型，0“快选择商品参加满折满减活动吧”，购物车里没有东西；1"下单立减reduceMoney元"；2"再选diffPrice元，即可减reduceMoney元"；2"再选diffPrice元，即可打discount折"；3"再选diffNumber件，即可减reduceMoney元"；4"再选diffNumber件，即可打discount折"
         */
