...
public class GoodsPrdProcessorDao extends ShopBaseService {
     ...
     * @return key: 商品id，value:{@link com.vpu.mp.service.pojo.wxapp.activity.info.list.GoodsPrdForListInfo}
     */
    public Map<Integer, GoodsPrdForListInfo> getGoodsPrdInfo(List<Integer> goodsIds) {
        ...
        Map<Integer,GoodsPrdForListInfo> returnMap = new HashMap<>();

        goodsPrdMap.forEach((key,value)->{
            GoodsPrdForListInfo info = new GoodsPrdForListInfo();
