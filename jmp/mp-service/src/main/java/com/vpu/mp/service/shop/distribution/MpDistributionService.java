...
import com.vpu.mp.db.shop.tables.records.DistributorCollectionRecord;
...
import com.vpu.mp.db.shop.tables.records.UserPromotionLanguageRecord;
...
import com.vpu.mp.service.pojo.shop.distribution.DistributorCollectionParam;
import com.vpu.mp.service.pojo.shop.distribution.DistributorGroupListVo;
import com.vpu.mp.service.pojo.shop.distribution.DistributorImageParam;
import com.vpu.mp.service.pojo.shop.distribution.DistributorLevelInfoVo;
import com.vpu.mp.service.pojo.shop.distribution.DistributorLevelParam;
import com.vpu.mp.service.pojo.shop.distribution.InviteUserListParam;
import com.vpu.mp.service.pojo.shop.distribution.InviteUserVo;
import com.vpu.mp.service.pojo.shop.distribution.PromoteGoodsParam;
...
import com.vpu.mp.service.pojo.wxapp.distribution.RebateRankingListVo;
import com.vpu.mp.service.pojo.wxapp.distribution.RebateRankingParam;
import com.vpu.mp.service.pojo.wxapp.distribution.RebateRankingTopVo;
import com.vpu.mp.service.pojo.wxapp.distribution.SetDefaulttParam;
...
import com.vpu.mp.service.pojo.wxapp.distribution.withdraw.SingleWithdrawRecordVo;
...
import com.vpu.mp.service.pojo.wxapp.distribution.withdraw.WithdrawStatusEnum;
...
import static com.vpu.mp.common.foundation.data.DistributionConstant.ALL_EXPIRE_PROTECT;
import static com.vpu.mp.common.foundation.data.DistributionConstant.EXPIRE_LEFT_TEN;
import static com.vpu.mp.common.foundation.data.DistributionConstant.INVITE_RELATION_ALL;
import static com.vpu.mp.common.foundation.data.DistributionConstant.INVITE_RELATION_DIRECTLY;
import static com.vpu.mp.common.foundation.data.DistributionConstant.INVITE_RELATION_INDIRECT;
import static com.vpu.mp.common.foundation.data.DistributionConstant.INVITE_TIME;
import static com.vpu.mp.common.foundation.data.DistributionConstant.ORDER_NUMBER;
import static com.vpu.mp.common.foundation.data.DistributionConstant.PROTECT_LEFT_TEN;
import static com.vpu.mp.common.foundation.data.DistributionConstant.SORT_TYPE;
import static com.vpu.mp.common.foundation.data.DistributionConstant.TOTAL_FANLI_MONEY;
import static com.vpu.mp.common.foundation.data.DistributionConstant.USER_EFFECTIVE;
import static com.vpu.mp.common.foundation.data.DistributionConstant.USER_HAS_EXPIRE;
import static com.vpu.mp.common.foundation.data.DistributionConstant.USER_WILL_EXPIRE;
...
import static com.vpu.mp.db.shop.Tables.USER_PROMOTION_LANGUAGE;
