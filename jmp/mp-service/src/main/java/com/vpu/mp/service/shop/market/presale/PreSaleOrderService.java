...
public class PreSaleOrderService extends ShopBaseService {
    ...
    public PageResult<DetailListVo> getPreSaleDetail(OrderListParam param) {
        SelectConditionStep<Record11<String, String, String, Integer, Integer, Timestamp, String, String, Short,
            String, BigDecimal>> query = orderQuery(param);
     ...
     * 查询订单
     */
    private SelectConditionStep<Record11<String, String, String, Integer, Integer, Timestamp, String, String, Short,
        String, BigDecimal>> orderQuery(OrderListParam param) {
        SelectConditionStep<Record11<String, String, String, Integer, Integer, Timestamp, String, String, Short,
            String, BigDecimal>> query = db().select(ORDER_INFO.ORDER_SN, ORDER_GOODS.GOODS_NAME, ORDER_GOODS.GOODS_IMG,
            ORDER_INFO.USER_ID, ORDER_GOODS.ORDER_ID, ORDER_INFO.CREATE_TIME, ORDER_INFO.MOBILE,
            ORDER_MUST.CONSIGNEE_REAL_NAME, ORDER_INFO.GOODS_AMOUNT, ORDER_INFO.ORDER_STATUS_NAME,
            ...
            .where(ORDER_INFO.GOODS_TYPE.eq(String.valueOf(OrderConstant.GOODS_TYPE_PRE_SALE))
    ...
    private void buildOptions(SelectConditionStep<Record11<String, String, String, Integer, Integer, Timestamp,
        String, String, Short, String, BigDecimal>> select, OrderListParam param) {
