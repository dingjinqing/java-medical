...
public class StateDeSerialize extends JsonDeserializer<Byte> {
    ...
    public Byte deserialize(JsonParser jsonParser, DeserializationContext deserializationContext) throws IOException, JsonProcessingException {
        if (jsonParser != null && (BaseConstant.EXTERNAL_ITEM_STATE_DELETE.equals(Integer.parseInt(jsonParser.getText()))||BaseConstant.EXTERNAL_ITEM_STATE_DISABLE.equals(Integer.parseInt(jsonParser.getText())))) {
            return (byte) 1;
