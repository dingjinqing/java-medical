...
public class InquiryOrderStatisticsVo {
    ...
    @ExcelColumn(columnName = "科室", columnIndex = 0)
    private String departmentName;
    /**
     * 咨询单数
     */
    @ExcelColumn(columnName = "咨询单数", columnIndex = 0)
    private String amount;
    /**
     * 咨询单次价格
     */
    @ExcelColumn(columnName = "咨询单次价格", columnIndex = 0)
    private BigDecimal oncePrice;
    /**
     * 咨询总金额
     */
    @ExcelColumn(columnName = "咨询总金额", columnIndex = 0)
