...
public class GoodsBakRecord extends UpdatableRecordImpl<GoodsBakRecord> implements Record13<Integer, Date, Integer, Integer, Integer, Integer, BigDecimal, BigDecimal, Integer, Byte, Byte, Timestamp, Timestamp> {

    private static final long serialVersionUID = -162589234;
     ...
     */
    @Override
    public Row13<Integer, Date, Integer, Integer, Integer, Integer, BigDecimal, BigDecimal, Integer, Byte, Byte, Timestamp, Timestamp> fieldsRow() {
     ...
     */
    @Override
    public Row13<Integer, Date, Integer, Integer, Integer, Integer, BigDecimal, BigDecimal, Integer, Byte, Byte, Timestamp, Timestamp> valuesRow() {
     ...
     */
    @Override
    public GoodsBakRecord values(Integer value1, Date value2, Integer value3, Integer value4, Integer value5, Integer value6, BigDecimal value7, BigDecimal value8, Integer value9, Byte value10, Byte value11, Timestamp value12, Timestamp value13) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public GoodsBakRecord(Integer id, Date bakDate, Integer goodsId, Integer shopId, Integer catId, Integer sortId, BigDecimal marketPrice, BigDecimal shopPrice, Integer goodsNumber, Byte isOnSale, Byte goodsType, Timestamp createTime, Timestamp updateTime) {
        super(GoodsBak.GOODS_BAK);
