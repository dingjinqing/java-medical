...
public class MpMonthlyVisitRecord extends TableRecordImpl<MpMonthlyVisitRecord> implements Record10<String, Integer, Integer, Integer, Integer, Double, Double, Double, Timestamp, Timestamp> {

    private static final long serialVersionUID = -1857666532;
    ...
    /**
     * Setter for <code>mini_shop_471752.b2c_mp_monthly_visit.create_time</code>.
     */
    ...
    /**
     * Getter for <code>mini_shop_471752.b2c_mp_monthly_visit.create_time</code>.
     */
    ...
    /**
     * Setter for <code>mini_shop_471752.b2c_mp_monthly_visit.update_time</code>. 最后修改时间
     */
    ...
    /**
     * Getter for <code>mini_shop_471752.b2c_mp_monthly_visit.update_time</code>. 最后修改时间
     */
     ...
     */
    @Override
    public MpMonthlyVisitRecord values(String value1, Integer value2, Integer value3, Integer value4, Integer value5, Double value6, Double value7, Double value8, Timestamp value9, Timestamp value10) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public MpMonthlyVisitRecord(String refDate, Integer sessionCnt, Integer visitPv, Integer visitUv, Integer visitUvNew, Double stayTimeUv, Double stayTimeSession, Double visitDepth, Timestamp createTime, Timestamp updateTime) {
        super(MpMonthlyVisit.MP_MONTHLY_VISIT);
