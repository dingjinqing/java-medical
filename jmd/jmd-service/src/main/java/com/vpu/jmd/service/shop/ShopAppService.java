...
import com.vpu.jmd.common.BaseConstant;
import com.vpu.jmd.table.main.Tables;
import com.vpu.jmd.table.main.tables.records.AppAuthRecord;
import com.vpu.jmd.table.main.tables.records.AppRecord;
import com.vpu.jmd.service.base.MainBaseService;
import org.apache.commons.lang3.RandomStringUtils;
import org.jooq.Record1;
import org.springframework.stereotype.Service;

import static com.vpu.jmd.table.main.Tables.APP_AUTH;
...
public class ShopAppService extends MainBaseService {
    ...
    public Byte getShopAppByPos(Integer shopId){
        Byte status = db().select(APP_AUTH.STATUS)
            .from(APP_AUTH)
            .where(APP_AUTH.SHOP_ID.eq(shopId))
            .and(APP_AUTH.ACTION.eq(ACTION_POS))
