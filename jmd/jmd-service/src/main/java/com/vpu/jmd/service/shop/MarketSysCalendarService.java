...
import com.vpu.jmd.table.main.tables.records.MarketCalendarRecord;
import com.vpu.jmd.service.base.MainBaseService;
import com.vpu.jmd.service.base.bo.DelFlag;
import com.vpu.jmd.service.shop.bo.marketcalendar.MarketCalendarVo;
import com.vpu.jmd.service.shop.bo.marketcalendar.MarketListData;
import com.vpu.jmd.service.shop.bo.marketcalendar.MarketListDataVo;
import com.vpu.jmd.service.shop.config.CalendarAction;
...
import static com.vpu.jmd.table.main.tables.MarketCalendar.MARKET_CALENDAR;
...
public class MarketSysCalendarService extends MainBaseService {
	...
	public MarketListDataVo getListByYear(String year) {
		...
		Date nowDate = DateUtil.parse(DatePattern.NORM_DATE_PATTERN).toSqlDate();
		for (int i = 1; i < 13; i++) {
