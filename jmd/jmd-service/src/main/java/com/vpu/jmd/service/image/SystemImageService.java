...
import com.vpu.jmd.config.DomainConfig;
import com.vpu.jmd.config.UpYunConfig;
import com.vpu.jmd.database.JsonResultCode;
import com.vpu.jmd.table.main.tables.records.UploadedImageRecord;
...
import static com.vpu.jmd.table.main.Tables.UPLOADED_IMAGE;
...
public class SystemImageService extends MainBaseService implements ImageDefault {
	...
	@Autowired
    public SystemImageCategoryService category;
