package com.vpu.jmd.service.schedule.cron;


import com.vpu.jmd.database.FieldsUtil;
import com.vpu.jmd.table.main.tables.records.CronDefineRecord;
import com.vpu.jmd.service.base.MainBaseService;
import com.vpu.jmd.service.schedule.bo.cron.CronDefineParam;
...
import static com.vpu.jmd.table.main.Tables.CRON_DEFINE;
import static com.vpu.jmd.table.main.Tables.CRON_RECORD;
...
public class MpCronRegistration extends MainBaseService {
    ...
    public void failedRecord(int cronId, byte executeNum, String failedReason) {
        ...
        updateCronDefine(CronDefineParam.builder().id(cronId).status(BYTE_ZERO).result((byte)3).build());
    }
