...
import com.vpu.mp.service.pojo.shop.config.trade.h5.ReturnOrderConfigParam;
...
public class ShopReturnConfigService extends BaseShopConfigService {
     ...
     * {@value com.vpu.mp.service.pojo.shop.config.trade.TradeConstant#FIELD_CLAZZ}
     */
    public ReturnOrderConfigParam getReturnConfigForH5() {
        ReturnOrderConfigParam param = new ReturnOrderConfigParam();
        try {
            BeanInfo beanInfo = Introspector.getBeanInfo(param.getClass());
            PropertyDescriptor[] descriptors = beanInfo.getPropertyDescriptors();
            Arrays.stream(descriptors)
     ...
     * {@value com.vpu.mp.service.pojo.shop.config.trade.TradeConstant#FIELD_CLAZZ}
     */
    public void updateReturnConfig(ReturnOrderConfigParam param) {
