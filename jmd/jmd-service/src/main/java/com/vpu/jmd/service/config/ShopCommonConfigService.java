...
import com.vpu.mp.service.pojo.shop.config.trade.h5.GoodsInfoConfigParam;
import com.vpu.mp.service.pojo.shop.config.trade.h5.GoodsSortConfigParam;
import com.vpu.mp.service.pojo.shop.config.trade.h5.UserAuthConfigParam;
...
public class ShopCommonConfigService extends BaseShopConfigService{
     ...
     * @return
     */
    public GoodsInfoConfigParam getGoodsInfoConfig(){
        GoodsInfoConfigParam configParam =new GoodsInfoConfigParam();
        this.transaction(() ->{
            configParam.setSalesNumber(this.getSalesNumber());
            configParam.setDelMarket(this.getDelMarket());
            configParam.setSoldOutGoods(this.getSoldOutGoods());
            configParam.setGoodsRecord(this.getGoodsRecord());
     ...
     * @return
     */
    public GoodsSortConfigParam getGoodsSortConfig(){
        GoodsSortConfigParam commonCfg =new GoodsSortConfigParam();
        this.transaction(() ->{
     ...
     * @return
     */
    public UserAuthConfigParam getUserAuthConfig(){
        UserAuthConfigParam commonCfg =new UserAuthConfigParam();
        this.transaction(() ->{
     ...
     *
     */
	public Boolean updateGoodsInfoConfig(GoodsInfoConfigParam commonCfg) {
		this.transaction(()->{
		    this.setSalesNumber(commonCfg.getSalesNumber());
			this.setDelMarket(commonCfg.getDelMarket());
			this.setSoldOutGoods(commonCfg.getSoldOutGoods());
     ...
     * 商品排序配置
     */
    public Boolean updateGoodsSortConfig(GoodsSortConfigParam commonCfg ){
        this.transaction(() ->{
            this.setGoodsSort(commonCfg.getGoodsSort());
            this.setSearchSort(commonCfg.getSearchSort());
            this.setRecommendSort(commonCfg.getRecommendSort());
     ...
     * 获取用户授权
     */
    public Boolean updateUserAuthConfig(UserAuthConfigParam commonCfg){
        this.transaction(() ->{
            this.setBindMobile(commonCfg.getBindMobile());
            this.setGeoLocation(commonCfg.getGeographicLocation());
        });
