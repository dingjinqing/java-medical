...
public class JsonResultMessage {
	...
	public static final String MSG_CODE_SOME_MUST = "code.some.must";
	public static final String GET_SHOPLIST_EXPORT_NAME = "get.shop.template.name";
    ...
    public static final String MSG_IMGAE_UPLOAD_ET_TOTAL_SIZE = "image.upload.gt.total.size";
    ...
    public static final String APPLETS_JUMP_LINK_REPETITION = "applets.jump.link.repetition";
    public static final String APPLETS_JUMP_LINK_APPLY_ALL_AVAILABLE = "applets.jump.link.apply.all.available";
    public static final String APPLETS_JUMP_LINK_APPLY_NO_REPETITION = "applets.jump.link.apply.no.repetition";
    public static final String APPLETS_JUMP_LINK_APPLY_SUCCESS = "applets.jump.link.apply.success";
	...
	public static final String WX_NO_LIVE_POWER = "wx.no.live.power";
	public static final String WX_NO_LIVE_PLUS = "wx.no.live.plus";
    ...
    public static final String MSG_CARD_NOT_EXCHANG_GOODS = "msg.card.not.exchang.goods";
    /**
     * 	用户卡包邮信息
     */
    ...
    public static final String CARD_EXAMINE_REFUND_TITLE = "card.examine.refund.title";
    ...
    public static final String ORDER_EXPORT_COLUMN_ORDER_INVOICE = "order.export.column.order_invoice";
    ...
    public static final String ORDER_EXPORT_INVOICE_NO_NEED = "order.export.invoice.no_need";
    public static final String ORDER_EXPORT_INVOICE_TYPE_GENERAL = "order.export.invoice.type.general";
    public static final String ORDER_EXPORT_INVOICE_TYPE_VAT_GENERAL = "order.export.invoice.type.vat_general";
    public static final String ORDER_EXPORT_INVOICE_TYPE_VAT = "order.export.invoice.type.vat";
    public static final String ORDER_EXPORT_INVOICE_PERSONAL = "order.export.invoice.personal";
    public static final String ORDER_EXPORT_INVOICE_UNIT = "order.export.invoice.unit";
    public static final String ORDER_EXPORT_INVOICE_TITLE = "order.export.invoice.title";
    public static final String ORDER_EXPORT_INVOICE_TAX_NUMBER = "order.export.invoice.taxnumber";
    public static final String ORDER_EXPORT_INVOICE_COMPANY_ADDRESS = "order.export.invoice.companyaddress";
    public static final String ORDER_EXPORT_INVOICE_TELPHONE = "order.export.invoice.telephone";
    public static final String ORDER_EXPORT_INVOICE_BANK_NAME = "order.export.invoice.bankname";
    public static final String ORDER_EXPORT_INVOICE_BANK_ACCOUNT = "order.export.invoice.bankaccount";
    ...
    public static final String CART_GOODS_LIMIT_NUM_MAXMIN_REGEXP ="cart.goods.limit.num.maxmin.regexp";
    public static final String CART_GOODS_LIMIT_NUM_MAX_REGEXP ="cart.goods.limit.num.max.regexp";
    public static final String CART_GOODS_LIMIT_NUM_MIN_REGEXP ="cart.goods.limit.num.min.regexp";
    ...
    public static final String USER_CARD_GIVING = "user.card.giving";
    public static final String USER_CARD_GIVED = "user.card.gived";
    // 商品效果导出
	...
	public static final String WX_NO_TEMPID = "wx.no.tempid";
	public static final String WX_HAVE_AUDIT_SLIP = "wx.have.audit.slip";
	public static final String WX_TEMPSAME = "wx.temp.same";
	public static final String WX_AUDIT_ING = "wx.audit.ing";

    /**
     * system升级续费申请导出
     */
    public static final String CHARGE_RENEW_LIST_EXPORT = "charge.renew.list.export";
    public static final String CHARGE_RENEW_SHOP_ID = "charge.renew.shop.id";
    public static final String CHARGE_RENEW_SHOP_NAME = "charge.renew.shop.name";
    public static final String CHARGE_RENEW_MOBILE = "charge.renew.mobile";
    public static final String CHARGE_RENEW_CREATED_TIME = "charge.renew.created.time";
    public static final String CHARGE_RENEW_SHOP_STATUS = "charge.renew.shop.status";
    public static final String CHARGE_RENEW_SHOP_TYPE = "charge.renew.shop.type";
    public static final String CHARGE_RENEW_PARENT_ACCOUNT = "charge.renew.parent.account";
    public static final String CHARGE_RENEW_ACCOUNT = "charge.renew.account";
    public static final String CHARGE_RENEW_ACCOUNT_TYPE = "charge.renew.account.type";
    public static final String CHARGE_RENEW_APPLY_TIME = "charge.renew.apply.time";
    public static final String CHARGE_RENEW_APPLY_TYPE = "charge.renew.apply.type";
    public static final String CHARGE_RENEW_MODULE = "charge.renew.module";
    public static final String CHARGE_RENEW_CONTACT = "charge.renew.contact";
    public static final String CHARGE_RENEW_USING = "charge.renew.using";
    public static final String CHARGE_RENEW_EXPIRED = "charge.renew.expired";
    public static final String CHARGE_RENEW_V1 = "charge.renew.v1";
    public static final String CHARGE_RENEW_V2 = "charge.renew.v2";
    public static final String CHARGE_RENEW_V3 = "charge.renew.v3";
    public static final String CHARGE_RENEW_V4 = "charge.renew.v3";
    public static final String CHARGE_RENEW_MAIN_ACCOUNT = "charge.renew.main.account";
    public static final String CHARGE_RENEW_SUB_ACCOUNT = "charge.renew.sub.account";
    public static final String CHARGE_RENEW_CHARGE = "charge.renew.charge";
    public static final String CHARGE_RENEW_RENEW = "charge.renew.renew";
    public static final String CHARGE_RENEW_HAS_NOT_CONTACT = "charge.renew.has.not.contact";
    public static final String CHARGE_RENEW_HAS_CONTACT = "charge.renew.has.contact";

    /**
     * 余额明细导出
     */
    public static final String BALANCE_DETAIL_EXPORT = "balance.detail.export";
    public static final String BALANCE_DETAIL_USER_NAME = "balance.detail.user.name";
    public static final String BALANCE_DETAIL_MOBILE = "balance.detail.mobile";
    public static final String BALANCE_DETAIL_ORDER_SN = "balance.detail.order.sn";
    public static final String BALANCE_DETAIL_BALANCE = "balance.detail.balance";
    public static final String BALANCE_DETAIL_DATE = "balance.detail.date";
    public static final String BALANCE_DETAIL_REMARK = "balance.detail.remark";
    /**
     * 积分明细导出
     */
    public static final String SCORE_DETAIL_EXPORT = "score.detail.export";
    public static final String SCORE_DETAIL_USER_NAME = "score.detail.user.name";
    public static final String SCORE_DETAIL_MOBILE = "score.detail.mobile";
    public static final String SCORE_DETAIL_ORDER_SN = "score.detail.order.sn";
    public static final String SCORE_DETAIL_SCORE = "score.detail.score";
    public static final String SCORE_DETAIL_DATE = "score.detail.date";
    public static final String SCORE_DETAIL_EXPIRED_DATE = "score.detail.expired.date";
    public static final String SCORE_DETAIL_REMARK = "score.detail.remark";

    /**
     * 社区团购
     */
    public static final String COMMUNITY_GROUP_HANDLER_APPLICATION_SUBMITTED = "community.group.handler.application.submitted";
    public static final String COMMUNITY_GROUP_GROUPER_LIST = "community.group.grouper.list";
    public static final String COMMUNITY_GROUP_GROUPER_ID = "community.group.grouper.id";
    public static final String COMMUNITY_GROUP_GROUPER_NAME = "community.group.grouper.name";
    public static final String COMMUNITY_GROUP_REAL_NAME = "community.group.real.name";
    public static final String COMMUNITY_GROUP_MOBILE = "community.group.mobile";
    public static final String COMMUNITY_GROUP_ADDRESS = "community.group.address";
    public static final String COMMUNITY_GROUP_TOTAL_SALE_NUM = "community.group.total.sale.num";
    public static final String COMMUNITY_GROUP_TOTAL_ORDER_NUM = "community.group.total.order.num";
    public static final String COMMUNITY_GROUP_TOTAL_REBATE_MONEY = "community.group.total.rebate.money";
    public static final String COMMUNITY_GROUP_TOTAL_USER_NUM = "community.group.total.user.num";
