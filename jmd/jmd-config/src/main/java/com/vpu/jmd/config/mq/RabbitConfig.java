...
public class RabbitConfig {
    ...
    /*************pos对接相关接口使用队列结束*************/
    /**批量审核 */
    public static final String QUEUE_BATCH_AUDIT="batch.upload.audit";
    ...
    /*************pos对接相关接口路由键结束*************/
    /** 批量审核*/
    public static final String BINDING_BATCH_AUDIT_KEY="bind.batch.audit";
     ...
     */
    @Bean
    public Queue batchAuditQueue() {
    	return new Queue(QUEUE_BATCH_AUDIT,true);
    }
    ...
    @Bean
    public Binding batchAudit() {
    	return BindingBuilder.bind(batchAuditQueue()).to(wxExchange()).with(BINDING_BATCH_AUDIT_KEY);
    }
