...
public class SystemChildAccount extends TableImpl<SystemChildAccountRecord> {
    ...
    private static final long serialVersionUID = -1198283770;
    ...
    /**
     * The column <code>mini_main.b2c_system_child_account.system_user_id</code>. 搴楅摵ID
     */
    public final TableField<SystemChildAccountRecord, Integer> SYSTEM_USER_ID = createField("system_user_id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.INTEGER)), this, "搴楅摵ID");

    /**
     * The column <code>mini_main.b2c_system_child_account.account_name</code>. 瀛愯处鍙风敤鎴峰悕
     */
    public final TableField<SystemChildAccountRecord, String> ACCOUNT_NAME = createField("account_name", org.jooq.impl.SQLDataType.VARCHAR(191).nullable(false).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.VARCHAR)), this, "瀛愯处鍙风敤鎴峰悕");

    /**
     * The column <code>mini_main.b2c_system_child_account.account_pwd</code>. 瀛愯处鍙峰瘑鐮
     */
    public final TableField<SystemChildAccountRecord, String> ACCOUNT_PWD = createField("account_pwd", org.jooq.impl.SQLDataType.VARCHAR(40).nullable(false).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.VARCHAR)), this, "瀛愯处鍙峰瘑鐮");

    /**
     * The column <code>mini_main.b2c_system_child_account.role_id</code>. 瑙掕壊ID
     */
    public final TableField<SystemChildAccountRecord, Integer> ROLE_ID = createField("role_id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.INTEGER)), this, "瑙掕壊ID");
    ...
    /**
     * The column <code>mini_main.b2c_system_child_account.mobile</code>. 鎵嬫満鍙
     */
    public final TableField<SystemChildAccountRecord, String> MOBILE = createField("mobile", org.jooq.impl.SQLDataType.VARCHAR(32).nullable(false).defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.VARCHAR)), this, "鎵嬫満鍙");

    /**
     * The column <code>mini_main.b2c_system_child_account.del_time</code>. 删除时间
     */
    public final TableField<SystemChildAccountRecord, Timestamp> DEL_TIME = createField("del_time", org.jooq.impl.SQLDataType.TIMESTAMP, this, "删除时间");

    /**
     * The column <code>mini_main.b2c_system_child_account.del_flag</code>. 0:未删除，1:已删除
     */
    public final TableField<SystemChildAccountRecord, Byte> DEL_FLAG = createField("del_flag", org.jooq.impl.SQLDataType.TINYINT.nullable(false).defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.TINYINT)), this, "0:未删除，1:已删除");
