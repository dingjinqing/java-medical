 ...
 */
package com.vpu.jmd.table.shop.tables;



import com.vpu.jmd.table.shop.Indexes;
import com.vpu.jmd.table.shop.Keys;
import com.vpu.jmd.table.shop.MiniShop_471752;
...
public class ShopCfg extends TableImpl<ShopCfgRecord> {
     ...
     */
    public final TableField<ShopCfgRecord, String> K = createField("k", org.jooq.impl.SQLDataType.VARCHAR(191).defaultValue(DSL.inline("", org.jooq.impl.SQLDataType.VARCHAR)), this, "");
     ...
     */
    public final TableField<ShopCfgRecord, Timestamp> CREATE_TIME = createField("create_time", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "");

    /**
     * The column <code>mini_shop_471752.b2c_shop_cfg.update_time</code>. 最后修改时间
     */
    public final TableField<ShopCfgRecord, Timestamp> UPDATE_TIME = createField("update_time", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "最后修改时间");
