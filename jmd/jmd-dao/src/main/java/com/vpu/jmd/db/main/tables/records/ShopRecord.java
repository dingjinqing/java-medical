...
public class ShopRecord extends UpdatableRecordImpl<ShopRecord> {
    ...
    private static final long serialVersionUID = -422231585;
    ...
    /**
     * Setter for <code>mini_main.b2c_shop.open_account_type</code>. 开户类型 1：直接购买；2：试用转付费；3：赠送；4：赠送转付费；5：试用；6：其他
     */
    public void setOpenAccountType(Byte value) {
        set(45, value);
    }

    /**
     * Getter for <code>mini_main.b2c_shop.open_account_type</code>. 开户类型 1：直接购买；2：试用转付费；3：赠送；4：赠送转付费；5：试用；6：其他
     */
    public Byte getOpenAccountType() {
        return (Byte) get(45);
    }

    /**
     * Setter for <code>mini_main.b2c_shop.auto_submit_audit</code>. 自动提交审核 1：自动；0：不自动
     */
    public void setAutoSubmitAudit(Byte value) {
        set(46, value);
    }

    /**
     * Getter for <code>mini_main.b2c_shop.auto_submit_audit</code>. 自动提交审核 1：自动；0：不自动
     */
    public Byte getAutoSubmitAudit() {
        return (Byte) get(46);
    }

    /**
     * Setter for <code>mini_main.b2c_shop.store_switch</code>. 门店后台使用权限开关：0关闭，1开启
     */
    public void setStoreSwitch(Byte value) {
        set(47, value);
    }

    /**
     * Getter for <code>mini_main.b2c_shop.store_switch</code>. 门店后台使用权限开关：0关闭，1开启
     */
    public Byte getStoreSwitch() {
        return (Byte) get(47);
    }

    /**
     * Setter for <code>mini_main.b2c_shop.ipuhuo_switch</code>. 爱铺货授权使用权限开关：0关闭，1开启
     */
    public void setIpuhuoSwitch(Byte value) {
        set(48, value);
    }

    /**
     * Getter for <code>mini_main.b2c_shop.ipuhuo_switch</code>. 爱铺货授权使用权限开关：0关闭，1开启
     */
    public Byte getIpuhuoSwitch() {
        return (Byte) get(48);
    }

    /**
     * Setter for <code>mini_main.b2c_shop.account_id</code>. 子账号ID
     */
    ...
    /**
     * Getter for <code>mini_main.b2c_shop.account_id</code>. 子账号ID
     */
    ...
    /**
     * Setter for <code>mini_main.b2c_shop.after_sale_id</code>. 售后负责人
     */
    public void setAfterSaleId(String value) {
        set(50, value);
    }

    /**
     * Getter for <code>mini_main.b2c_shop.after_sale_id</code>. 售后负责人
     */
    ...
    /**
     * Setter for <code>mini_main.b2c_shop.fun_expire_time</code>. 增值功能增加有效期，默认为店铺到期时间
     */
    public void setFunExpireTime(Timestamp value) {
        set(51, value);
    }

    /**
     * Getter for <code>mini_main.b2c_shop.fun_expire_time</code>. 增值功能增加有效期，默认为店铺到期时间
     */
    public Timestamp getFunExpireTime() {
    ...
    public ShopRecord(Integer shopId, Integer sysId, String mobile, String receiveMobile, String shopName, String shopAvatar, String shopBgPath, String shopPhone, String shopNotice, String shopWx, String shopEmail, Timestamp created, Byte isEnabled, Integer provinceCode, String provinceName, Integer cityCode, String cityName, Integer districtCode, String districtName, String address, String completeAddress, Integer shopSellType, String shopQq, String lastLoginIp, Byte state, Byte businessState, BigDecimal manageFee, BigDecimal surplus, String dbConfig, String shopType, String versionConfig, Byte shopFlag, String memberKey, String tenancyName, String userName, String password, String smsAccount, Byte kuajinggou, Byte orderRealName, Byte hidBottom, String logo, String currency, String shopLanguage, Timestamp expireTime, String storeClerkPrivilegeList, Byte openAccountType, Byte autoSubmitAudit, Byte storeSwitch, Byte ipuhuoSwitch, String accountId, String afterSaleId, Timestamp funExpireTime) {
        ...
        set(45, openAccountType);
        set(46, autoSubmitAudit);
        set(47, storeSwitch);
        set(48, ipuhuoSwitch);
        set(49, accountId);
        set(50, afterSaleId);
        set(51, funExpireTime);
    }
}
