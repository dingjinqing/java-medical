...
public class Shop extends TableImpl<ShopRecord> {
    ...
    private static final long serialVersionUID = -1990698182;
    ...
    /**
     * The column <code>mini_main.b2c_shop.open_account_type</code>. 开户类型 1：直接购买；2：试用转付费；3：赠送；4：赠送转付费；5：试用；6：其他
     */
    public final TableField<ShopRecord, Byte> OPEN_ACCOUNT_TYPE = createField("open_account_type", org.jooq.impl.SQLDataType.TINYINT.defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.TINYINT)), this, "开户类型 1：直接购买；2：试用转付费；3：赠送；4：赠送转付费；5：试用；6：其他 ");

    /**
     * The column <code>mini_main.b2c_shop.auto_submit_audit</code>. 自动提交审核 1：自动；0：不自动
     */
    public final TableField<ShopRecord, Byte> AUTO_SUBMIT_AUDIT = createField("auto_submit_audit", org.jooq.impl.SQLDataType.TINYINT.defaultValue(org.jooq.impl.DSL.inline("1", org.jooq.impl.SQLDataType.TINYINT)), this, "自动提交审核 1：自动；0：不自动 ");

    /**
     * The column <code>mini_main.b2c_shop.store_switch</code>. 门店后台使用权限开关：0关闭，1开启
     */
    public final TableField<ShopRecord, Byte> STORE_SWITCH = createField("store_switch", org.jooq.impl.SQLDataType.TINYINT.defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.TINYINT)), this, "门店后台使用权限开关：0关闭，1开启 ");

    /**
     * The column <code>mini_main.b2c_shop.ipuhuo_switch</code>. 爱铺货授权使用权限开关：0关闭，1开启
     */
    public final TableField<ShopRecord, Byte> IPUHUO_SWITCH = createField("ipuhuo_switch", org.jooq.impl.SQLDataType.TINYINT.defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.TINYINT)), this, "爱铺货授权使用权限开关：0关闭，1开启 ");

    /**
     * The column <code>mini_main.b2c_shop.account_id</code>. 子账号ID
     */
    public final TableField<ShopRecord, String> ACCOUNT_ID = createField("account_id", org.jooq.impl.SQLDataType.CLOB, this, "子账号ID");

    /**
     * The column <code>mini_main.b2c_shop.after_sale_id</code>. 售后负责人
     */
    public final TableField<ShopRecord, String> AFTER_SALE_ID = createField("after_sale_id", org.jooq.impl.SQLDataType.VARCHAR(200), this, "售后负责人");

    /**
     * The column <code>mini_main.b2c_shop.fun_expire_time</code>. 增值功能增加有效期，默认为店铺到期时间
     */
    public final TableField<ShopRecord, Timestamp> FUN_EXPIRE_TIME = createField("fun_expire_time", org.jooq.impl.SQLDataType.TIMESTAMP, this, "增值功能增加有效期，默认为店铺到期时间");
