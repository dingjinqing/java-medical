...
public class UserDetail extends TableImpl<UserDetailRecord> {
    ...
    private static final long serialVersionUID = 2095670870;
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.USER_DETAIL_PRIMARY);
    }
    ...
    public List<UniqueKey<UserDetailRecord>> getKeys() {
        return Arrays.<UniqueKey<UserDetailRecord>>asList(Keys.KEY_B2C_USER_DETAIL_PRIMARY);
    }
