...
public class OrderGoods extends TableImpl<OrderGoodsRecord> {
    ...
    private static final long serialVersionUID = 31729712;
     ...
     */
    public final TableField<OrderGoodsRecord, Integer> REC_ID = createField("rec_id", org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");
    ...
    /**
     * The column <code>mini_main.b2c_order_goods.is_can_return</code>. 是否可退款
     */
