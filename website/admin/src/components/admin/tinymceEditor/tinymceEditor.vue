...
export default {
  ...
  props: {
    ...
    toolbar: {
      ...
      default: ' forecolor | fontsizeselect |　undo redo　| bold italic | fontselect | alignleft aligncenter alignright alignjustify | \ bullist numlist outdent indent | lists image  | removeformat'
    },
    height: {
      type: Number,
      default: 450
  ...
  data () {
    return {
      ...
      cnInit: {
        selector: '#cnTinymce',
        base_url: '/admin/static/tinymce',
        language_url: `/admin/static/tinymce/tinymce_languages/langs/zh_CN.js`,
        language: 'zh_CN',
        height: 450,
  ...
  watch: {
    ...
    lang (type) {
      ...
      if (type === 'zh_CN') {
        ...
        this.cnInit.language_url = `/admin/static/tinymce/tinymce_languages/langs/zh_CN.js`
      } else {
