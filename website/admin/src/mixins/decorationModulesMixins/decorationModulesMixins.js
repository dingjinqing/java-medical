      ...
      switch (index) {
        ...
        case 8: // 商品模块
          obj = {
            ...
            title: '', // 标题  y
            title_link: '', // 标题链接 y
            tit_center: 0, // 标题位置 false不选中标题居中  true选中标题居中 y
        ...
        case 27: // 店招设置
          obj = {
            ...
            'shop_notice': '',
            'shop_bg_path': localStorage.getItem('V-AccountShopAvatar'),
