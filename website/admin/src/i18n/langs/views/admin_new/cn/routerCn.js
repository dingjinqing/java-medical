export const cn = {
  ...
  // 商品管理 商品标签 新增标签
  addGoodsLabel: ['商品管理', '商品标签', '新增标签'],
  // 商品管理 商品标签 修改标签
  updateGoodsLabel: ['商品管理', '商品标签', '修改标签'],
  // 商品管理 商品导入
  ...
  // 营销管理 砍价 - 获取新用户明细
  bargain_get_newuser_detail: ['营销管理', '砍价', '获取新用户明细'],
  // 营销管理 砍价 - 砍价用户
  ...
  distribution_indirectUser: ['营销管理', '分销', '分销员列表'],
  // 营销管理 分销 推广测试
  ...
  // 营销管理 首单特惠 首单特惠订单
  first_special_order: ['营销管理', '首单特惠', '首单特惠订单'],
  // 营销管理 首单特惠 首单特惠新增
  first_special_add: ['营销管理', '首单特惠'],
  // 营销管理 定金膨胀
  presale: ['营销管理', '定金膨胀'],
  // 营销管理 定金膨胀创建
  ...
  addSeckill: ['营销管理', '秒杀'],
  // 营销管理 秒杀-秒杀订单
  orderSeckill: ['营销管理', '秒杀', '秒杀订单'],
  // 营销管理 秒杀-用户明细
  detailSeckill: ['营销管理', '秒杀', '用户明细'],
  // 营销管理 秒杀-秒杀用户
  userSeckill: ['营销管理', '秒杀', '秒杀用户'],
  // 营销管理 秒杀-活动数据效果
  resultSeckill: ['营销管理', '秒杀', '活动数据效果'],
  // 营销管理 秒杀
  shipping: ['营销管理', '满包邮'],
  // 营销管理 加价购
  ...
  // 营销管理 我要送礼 收礼明细
  giveGift_receive: ['营销管理', '我要送礼', '收礼明细'],
  // 营销管理 消息推送
  ...
  // 营销管理 满折满减订单
  fullCutOrder: ['营销管理', '满折满减', '活动订单'],
  // 营销管理 满折满减统计
  fullCutStatistics: ['营销管理', '满折满减', '效果数据'],
  // 营销管理 表单统计
