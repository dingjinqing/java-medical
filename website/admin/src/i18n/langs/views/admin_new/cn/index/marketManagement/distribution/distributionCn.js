export const cn = {
  ...
  strategyType: '佣金计算方式',
  strategyTypeTip1: '商品实际支付金额 * 佣金比例',
  strategyTypeTip2: '商品实际利润（实际支付金额-成本价）* 佣金比例',
  strategyTypeTip3: '注：未设置成本价的商品，计算佣金时，将以成本价为0元处理',
  ratioRate: '返利比例',
  ...
  proportionTip5: '当前等级分销员可获返利金额为下单商品金额的',
  ...
  // 查看已邀请用户
  inviteTime: '邀请时间',
  inviteMoneyTip: '累计获得佣金数',
  userMobile: '用户手机号',
  orderNumber: '累计返利订单数',
  totalCanFanliMoney: '累计订单返利商品总金额',
  totalFanliMoney: '累计返利佣金金额',
  inviteExpiryDate: '返利有效日期',
  inviteProtectDate: '邀请保护日期',
  // 间接邀请用户
  indirectMoneyTip: '间接邀请累计获得佣金数',
  higherName: '上级用户昵称',
  higherMobile: '上级用户手机号',
  ...
  isDefaultTip: '用户成为分销员时，若未主动修改，将被默认添加到的分组',
  isDefaultGroup: '是否为默认分组',
  canSelectTip: '用户在提交成为分销员申请时，是否可选择加入该分组',
  canSelect: '可否选择',
  groupEdit: '编辑',
  groupDelete: '删除',
  addGrouper: '添加分销员',
  ...
  selectTip1: '支持',
  selectTip2: '不支持',
  selectTip3: '用户在申请成为分销员时，是否可以选择加入此分组',
