export const en = {
  ...
  reviewedInvitation: 'The system verifies the invitation code, and automatically passes the audit after verification',
  ...
  strategyType: 'Calculation method of commission',
  strategyTypeTip1: 'Actual payment amount of goods * Commission proportion',
  strategyTypeTip2: 'Actual profit of goods (actual paid amount - cost price) * Commission proportion',
  strategyTypeTip3: 'Note: for goods without cost price set, the cost price will be 0 yuan when calculating Commission',
  ...
  inviteMoneyTip: 'Accumulated commissions',
  userMobile: 'User mobile',
  orderNumber: 'Cumulative rebate orders',
  totalCanFanliMoney: 'Total amount of order rebate products',
  totalFanliMoney: 'Accumulated rebate commission amount',
  inviteExpiryDate: 'Rebate effective date',
  inviteProtectDate: 'Invitation protection date',
  // 间接邀请用户
  indirectMoneyTip: 'Accumulated commissions of indirect invitation',
  higherName: 'Parent user nickname',
  higherMobile: 'Parent user mobile',

  // -------------------分销员分组-----------------
  switchDesc: 'Whether the group is displayed on the applet side',
  show: 'show',
  notShow: 'No show',
  save: 'Save',
  addDistributorGroup: 'Add distributor group',
  groupName: 'Group name',
  includeDistributorNum: 'Including the number of distributors',
  isDefaultTip: 'When the user becomes a distributor, if it is not actively modified, the group will be added to by default',
  isDefaultGroup: 'Default grouping',
  canSelectTip: 'When submitting the application to become a distributor, users can choose whether to join the group or not',
  canSelect: 'can choose',
  groupEdit: 'Edit',
  groupDelete: 'Delete',
  ...
  selectTip1: 'support',
  selectTip2: 'not support',
  selectTip3: 'When applying to become a distributor, users can choose whether to join this group',
  ...
  reviewMobile: 'Mobile',
  reviewName: 'Name',
  reviewTime: 'Application Time',
  reviewSelect: 'Selection date',
  reviewTo: 'to',
  reviewSearch: 'Search',
  reviewBy: 'Distributor to be reviewed',
  reviewPass: 'Audit pass',
  reviewNoPass: 'Audit failed',
  reviewGroup: 'Distributor Group',
  reviewDate: 'Audit time',
  reviewStatus: 'Audit Status',
  reviewOption: 'Option',
  noPassReason: 'Failure Reason',
  reviewTip: 'No need to submit personal information',
  reviewRealName: 'RealName',
  reviewId: 'ID Number',
  reviewSet: 'Set',
  passBtn: 'Pass',
  noPassBtn: 'No Pass',
  reviewSex: 'Sex',
  reviewBirthday: 'Birthday',
  reviewMarital: 'Marital Status',
  reviewEducation: 'Education Level',
  reviewIndustry: 'Industry',
  reviewAddress: 'Address',
  reviewNote: 'Remarks',
  reviewImg: 'Image',
  reviewNo: 'No',
  reviewTitle1: 'Set up distributor group',
  selectGroup: 'Select Group',
  reviewTitle2: 'Reasons for failure of audit',
  reviewTitleTip: 'Reason cannot be modified after submission, please submit carefully'
}
