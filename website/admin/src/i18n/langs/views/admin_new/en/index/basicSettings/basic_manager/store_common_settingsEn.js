export const en = {
  ...
  effectivePage: 'Effective page',
  shopProductPage: 'Shop product page (product search page)',
  manually: 'Manually recommended product list',
  businessCategoryPage: 'Business category page (products belong to the first-level merchant category, and the product list is displayed directly)',
  collation: 'Collation',
  arranged: 'Arranged in reverse order of product listing time',
  latestProducts: 'The latest products will be listed at the top',
  ...
  returnService: 'Return/Replacement Center',
  orderDetail: 'Order Detail',
  customerServiceConfTip: 'After checking, the customer service entrance will be displayed at the corresponding location on the small program side',
  features: 'Features',
  ...
  defaultScheme: 'Default copy',
  customScheme: 'Custom copy',
  ...
  downNote: 'Note: When sharing friends with merchandise through a poster, no more than 23 Chinese characters can be displayed, and the excess will be omitted',
