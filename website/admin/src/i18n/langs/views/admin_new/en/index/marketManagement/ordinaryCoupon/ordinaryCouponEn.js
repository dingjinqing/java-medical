export const en = {
  ...
  couponOverlay: 'Discount stack',
  couponOverlayTip: 'Not shared with time limited price reduction, first special offer and member price activities',
  couponTag: 'Simultaneous tagging',
  couponTagTip1: 'Label the ticket users',
  couponTagTip2: 'Select label',
  couponTagTip3: 'Up to 3 labels can be set',
