export const en = {
  ...
  distribution_indirectUser: ['Marketing management', 'distribution', 'List of distributors'],
  // 营销管理 分销 推广测试
  ...
  // 营销管理 定向发券
  couponGive: ['Marketing management', 'Coupon Give'],
  // 营销管理 定向发券 领取明细
