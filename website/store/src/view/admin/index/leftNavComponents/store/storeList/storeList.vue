        ...
        <div class="list-filters">
            <el-form ref="listFiltersForm" :model="listFiltersForm" :inline="true">
                <el-form-item label="门店信息：" prop="keywords">
                    <el-input v-model="listFiltersForm.keywords" placeholder="门店名称/编码" size="small"></el-input>
                </el-form-item>
                <el-form-item label="营业状态：" prop="businessState">
                    <el-select v-model="listFiltersForm.businessState" size="small" :clearable="true">
                        <el-option :value="1" label="营业"/>
                        <el-option :value="0" label="未营业"/>
                    </el-select>
                </el-form-item>
                <el-form-item label="负责人：" prop="manager">
                    <el-input v-model="listFiltersForm.manager" placeholder="负责人名称" size="small"></el-input>
                </el-form-item>
                <el-form-item label="门店自提：" prop="autoPick">
                    <el-select v-model="listFiltersForm.autoPick" size="small" :clearable="true">
                        <el-option :value="1" label="已开启"/>
                        <el-option :value="0" label="未开启"/>
                    </el-select>
                </el-form-item>
                <el-form-item label="同城配送：" prop="cityService">
                    <el-select v-model="listFiltersForm.cityService" size="small" :clearable="true">
                        <el-option :value="1" label="已开启"/>
                        <el-option :value="0" label="未开启"/>
                    </el-select>
                </el-form-item>
            ...
            <div>
                <el-button size="small" type="primary" @click="listFilterConfirm">确认</el-button>
                <el-button size="small" @click="listFilterReset">重置</el-button>
            </div>
        </div>
        <div class="list-content">
            <div class="list-content-table">
                <el-table :data="storeList" style="width: 100%" border class="tableClass">
                    ...
                    <el-table-column  label="门店自提" align="center">
                        <template slot-scope="{row}">
                            <el-checkbox v-model="row.autoPick" :true-label="1" :false-label="0" @change="storeFunctionChange(row,'autoPick')"/>
                        </template>
                    </el-table-column>
                    <el-table-column label="同城配送" align="center">
                        <template slot-scope="{row}">
                            <el-checkbox v-model="row.cityService" :true-label="1" :false-label="0" @change="storeFunctionChange(row,'cityService')"/>
                        </template>
                    </el-table-column>
                    <el-table-column label="营业状态" align="center">
                        <template slot-scope="{row}">
                            <el-checkbox v-model="row.businessState" :true-label="1" :false-label="0" @change="storeFunctionChange(row,'businessState')"/>
                        </template>
                    </el-table-column>
...
.list-filters .el-select,.list-filters .el-input{
    width: 180px;
}
.list-content{
    padding: 15px;
