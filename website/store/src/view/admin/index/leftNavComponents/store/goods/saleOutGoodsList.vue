      ...
      <div class="goods-list-header">
        ...
        >
          ...
          <el-form-item label="所属门店：" prop="storeId">
            <el-select
              v-model="goodsFilterModel.storeId"
              size="small"
              :clearable="true"
            >
              <el-option
                v-for="(item, index) in storeInfos"
                :value="item.storeId"
          ...
          <el-form-item label="是否在售：" prop="isOnSale">
            <el-select
              v-model="goodsFilterModel.isOnSale"
              size="small"
              :clearable="true"
            >
        ...
        <div>
          <el-button size="small" type="primary" @click="confirmFilterGoods"
            >确认</el-button
          >
          <el-button size="small" @click="resetGoodsFilterModel"
            >重置</el-button
          >
        </div>
      </div>
