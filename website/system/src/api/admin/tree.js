...
export function getHeadTreeListRequest () {
  return service({
    url: '/api/admin/account/image/category/list',
    method: 'get'
  })
}
...
export function groupHeadAddRequest (riid) {
  return service({
    url: '/api/admin/account/image/category/add',
    method: 'post',
    data: riid
  })
}
...
export function groupHeadDelRequest (riid) {
  return service({
    url: '/api/admin/account/image/category/delete',
    method: 'post',
    data: riid
  })
}
...
export function renameHeadRequest (riid) {
  return service({
    url: '/api/admin/account/image/category/rename',
    method: 'post',
    data: riid
  })
}
...
export function imgsHeaddeleteRequest (riid) {
  return service({
    url: '/api/admin/account/image/batch/delete',
    method: 'post',
    data: riid
  })
}
...
export function queryHeadImgsRequest (riid) {
  ...
  return service({
    url: '/api/admin/account/image/list',
    method: 'post',
    data: riid
  })
}
...
export function moveHeadImgsRequest (riid) {
  return service({
    url: '/api/admin/account/image/batch/move',
    method: 'post',
    data: riid
  })
}
...
export function upmoreHeadImgsRequest (riid) {
  ...
  return service({
    url: '/api/admin/account/image/uploadOneImgae',
    method: 'post',
    data: riid
  })
}
...
export function imgsCropperRequest (riid) {
  localStorage.setItem('contentType', 'application/json;charset=UTF-8')
  return service({
    url: '/api/admin/account/image/makeCrop',
    method: 'post',
    data: riid
  })
}
